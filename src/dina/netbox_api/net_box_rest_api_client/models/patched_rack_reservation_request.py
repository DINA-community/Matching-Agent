...
if TYPE_CHECKING:
    ...
    from ..models.patched_rack_reservation_request_custom_fields import PatchedRackReservationRequestCustomFields


T = TypeVar("T", bound="PatchedRackReservationRequest")
...
class PatchedRackReservationRequest:
    ...
    Attributes:
        rack (Union['BriefRackRequest', Unset, int]):
        ...
        custom_fields (Union[Unset, PatchedRackReservationRequestCustomFields]):
    """

    rack: Union["BriefRackRequest", Unset, int] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedRackReservationRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        rack: Union[Unset, dict[str, Any], int]
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        units: Union[Unset, tuple[None, bytes, str]] = UNSET
        if not isinstance(self.units, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_rack(data: object) -> Union["BriefRackRequest", Unset, int]:
            ...
            try:
                ...
                pass
            return cast(Union["BriefRackRequest", Unset, int], data)

        rack = _parse_rack(d.pop("rack", UNSET))

        units = cast(list[int], d.pop("units", UNSET))
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedRackReservationRequestCustomFields.from_dict(_custom_fields)

        patched_rack_reservation_request = cls(
            rack=rack,
            units=units,
            user=user,
            tenant=tenant,
        ...
        patched_rack_reservation_request.additional_properties = d
        return patched_rack_reservation_request
