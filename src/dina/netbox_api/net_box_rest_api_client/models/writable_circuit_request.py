...
from ..models.writable_circuit_request_distance_unit_type_1 import WritableCircuitRequestDistanceUnitType1
from ..models.writable_circuit_request_distance_unit_type_2_type_1 import WritableCircuitRequestDistanceUnitType2Type1
from ..models.writable_circuit_request_distance_unit_type_3_type_1 import WritableCircuitRequestDistanceUnitType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_circuit_request_custom_fields import WritableCircuitRequestCustomFields
...
class WritableCircuitRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.distance_unit, WritableCircuitRequestDistanceUnitType2Type1):
            distance_unit = self.distance_unit.value
        elif isinstance(self.distance_unit, WritableCircuitRequestDistanceUnitType3Type1):
            distance_unit = self.distance_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_distance_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_2_type_1 = WritableCircuitRequestDistanceUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_3_type_1 = WritableCircuitRequestDistanceUnitType3Type1(data)
