...
from ..models.writable_virtual_device_context_request_status import WritableVirtualDeviceContextRequestStatus
...
class WritableVirtualDeviceContextRequest:
    ...
    custom_fields: Union[Unset, "WritableVirtualDeviceContextRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableVirtualDeviceContextRequestCustomFields.from_dict(_custom_fields)
