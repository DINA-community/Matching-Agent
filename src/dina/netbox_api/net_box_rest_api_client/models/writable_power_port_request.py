...
from ..models.writable_power_port_request_type_type_1 import WritablePowerPortRequestTypeType1
from ..models.writable_power_port_request_type_type_2_type_1 import WritablePowerPortRequestTypeType2Type1
from ..models.writable_power_port_request_type_type_3_type_1 import WritablePowerPortRequestTypeType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_power_port_request_custom_fields import WritablePowerPortRequestCustomFields


T = TypeVar("T", bound="WritablePowerPortRequest")
...
class WritablePowerPortRequest:
    ...
    Attributes:
        ...
        type_ (Union[None, Unset, WritablePowerPortRequestTypeType1, WritablePowerPortRequestTypeType2Type1,
            WritablePowerPortRequestTypeType3Type1]): Physical port type
        ...
        custom_fields (Union[Unset, WritablePowerPortRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "WritablePowerPortRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, WritablePowerPortRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritablePowerPortRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritablePowerPortRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = WritablePowerPortRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritablePowerPortRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritablePowerPortRequestTypeType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritablePowerPortRequestCustomFields.from_dict(_custom_fields)

        writable_power_port_request = cls(
            device=device,
            name=name,
            module=module,
            label=label,
        ...
        writable_power_port_request.additional_properties = d
        return writable_power_port_request
