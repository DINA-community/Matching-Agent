...
T = TypeVar("T", bound="PaginatedInterfaceTemplateList")
...
class PaginatedInterfaceTemplateList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = InterfaceTemplate.from_dict(results_item_data)
        ...
        paginated_interface_template_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_interface_template_list.additional_properties = d
        return paginated_interface_template_list
