...
if TYPE_CHECKING:
    ...
    from ..models.route_target_request_custom_fields import RouteTargetRequestCustomFields


T = TypeVar("T", bound="RouteTargetRequest")
...
class RouteTargetRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, RouteTargetRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "RouteTargetRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = RouteTargetRequestCustomFields.from_dict(_custom_fields)

        route_target_request = cls(
            name=name,
            tenant=tenant,
        ...
        route_target_request.additional_properties = d
        return route_target_request
