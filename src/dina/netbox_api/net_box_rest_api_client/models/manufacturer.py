...
if TYPE_CHECKING:
    from ..models.manufacturer_custom_fields import ManufacturerCustomFields
...
class Manufacturer:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, ManufacturerCustomFields]):
    ...
    custom_fields: Union[Unset, "ManufacturerCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        platform_count = d.pop("platform_count")
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = ManufacturerCustomFields.from_dict(_custom_fields)
