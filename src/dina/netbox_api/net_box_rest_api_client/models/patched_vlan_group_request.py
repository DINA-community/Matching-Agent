...
if TYPE_CHECKING:
    ...
    from ..models.patched_vlan_group_request_custom_fields import PatchedVLANGroupRequestCustomFields
...
class PatchedVLANGroupRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedVLANGroupRequestCustomFields.from_dict(_custom_fields)
