...
T = TypeVar("T", bound="PaginatedSiteList")
...
class PaginatedSiteList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Site.from_dict(results_item_data)
        ...
        paginated_site_list.additional_properties = d
        return paginated_site_list
