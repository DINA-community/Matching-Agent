...
from ..models.patched_writable_event_rule_request_action_type import PatchedWritableEventRuleRequestActionType
from ..models.patched_writable_event_rule_request_event_types_item import PatchedWritableEventRuleRequestEventTypesItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.patched_writable_event_rule_request_custom_fields import PatchedWritableEventRuleRequestCustomFields
...
class PatchedWritableEventRuleRequest:
    ...
    event_types: Union[Unset, list[PatchedWritableEventRuleRequestEventTypesItem]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for event_types_item_data in _event_types or []:
            event_types_item = PatchedWritableEventRuleRequestEventTypesItem(event_types_item_data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableEventRuleRequestCustomFields.from_dict(_custom_fields)
