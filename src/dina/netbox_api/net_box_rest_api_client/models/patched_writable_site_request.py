...
from ..models.patched_writable_site_request_status import PatchedWritableSiteRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_site_request_custom_fields import PatchedWritableSiteRequestCustomFields


T = TypeVar("T", bound="PatchedWritableSiteRequest")
...
class PatchedWritableSiteRequest:
    ...
    Attributes:
        name (Union[Unset, str]): Full name of the site
        slug (Union[Unset, str]):
        status (Union[Unset, PatchedWritableSiteRequestStatus]): * `planned` - Planned
            * `staging` - Staging
            * `active` - Active
        ...
        custom_fields (Union[Unset, PatchedWritableSiteRequestCustomFields]):
    """

    name: Union[Unset, str] = UNSET
    slug: Union[Unset, str] = UNSET
    status: Union[Unset, PatchedWritableSiteRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedWritableSiteRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.region, Unset):
            ...
            region = (None, json.dumps(self.region.to_dict()).encode(), "application/json")
        else:
            region = (None, str(self.region).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PatchedWritableSiteRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritableSiteRequestStatus(_status)

        def _parse_region(data: object) -> Union["BriefRegionRequest", None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_group(data: object) -> Union["BriefSiteGroupRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableSiteRequestCustomFields.from_dict(_custom_fields)

        patched_writable_site_request = cls(
            name=name,
            slug=slug,
            status=status,
            region=region,
        ...
        patched_writable_site_request.additional_properties = d
        return patched_writable_site_request
