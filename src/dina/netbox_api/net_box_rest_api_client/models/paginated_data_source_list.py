...
T = TypeVar("T", bound="PaginatedDataSourceList")
...
class PaginatedDataSourceList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DataSource.from_dict(results_item_data)
        ...
        paginated_data_source_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_data_source_list.additional_properties = d
        return paginated_data_source_list
