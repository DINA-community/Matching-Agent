...
from ..models.writable_inventory_item_request_status import WritableInventoryItemRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.writable_inventory_item_request_custom_fields import WritableInventoryItemRequestCustomFields
...
class WritableInventoryItemRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableInventoryItemRequestCustomFields.from_dict(_custom_fields)
