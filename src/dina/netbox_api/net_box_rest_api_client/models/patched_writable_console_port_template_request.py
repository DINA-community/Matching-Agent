...
from ..models.patched_writable_console_port_template_request_type_type_1 import (
    PatchedWritableConsolePortTemplateRequestTypeType1,
)
from ..models.patched_writable_console_port_template_request_type_type_2_type_1 import (
    PatchedWritableConsolePortTemplateRequestTypeType2Type1,
)
from ..models.patched_writable_console_port_template_request_type_type_3_type_1 import (
...
T = TypeVar("T", bound="PatchedWritableConsolePortTemplateRequest")
...
class PatchedWritableConsolePortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[None, PatchedWritableConsolePortTemplateRequestTypeType1,
                PatchedWritableConsolePortTemplateRequestTypeType2Type1,
                PatchedWritableConsolePortTemplateRequestTypeType3Type1, Unset]): * `de-9` - DE-9
                * `db-25` - DB-25
                * `rj-11` - RJ-11
                * `rj-12` - RJ-12
                * `rj-45` - RJ-45
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, PatchedWritableConsolePortTemplateRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, PatchedWritableConsolePortTemplateRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, PatchedWritableConsolePortTemplateRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = PatchedWritableConsolePortTemplateRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = PatchedWritableConsolePortTemplateRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = PatchedWritableConsolePortTemplateRequestTypeType3Type1(data)
        ...
        patched_writable_console_port_template_request = cls(
        ...
        patched_writable_console_port_template_request.additional_properties = d
        return patched_writable_console_port_template_request
