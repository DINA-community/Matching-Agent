...
if TYPE_CHECKING:
    ...
    from ..models.patched_virtual_disk_request_custom_fields import PatchedVirtualDiskRequestCustomFields
...
class PatchedVirtualDiskRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedVirtualDiskRequestCustomFields.from_dict(_custom_fields)
