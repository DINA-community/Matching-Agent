...
if TYPE_CHECKING:
    from ..models.mac_address_request_custom_fields import MACAddressRequestCustomFields
...
class MACAddressRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, MACAddressRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "MACAddressRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = MACAddressRequestCustomFields.from_dict(_custom_fields)
