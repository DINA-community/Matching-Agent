...
from ..models.writable_ip_sec_proposal_request_authentication import WritableIPSecProposalRequestAuthentication
from ..models.writable_ip_sec_proposal_request_encryption import WritableIPSecProposalRequestEncryption
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.writable_ip_sec_proposal_request_custom_fields import WritableIPSecProposalRequestCustomFields


T = TypeVar("T", bound="WritableIPSecProposalRequest")
...
class WritableIPSecProposalRequest:
    ...
    Attributes:
        ...
        encryption_algorithm (Union[None, Unset, WritableIPSecProposalRequestEncryption]): * `aes-128-cbc` - 128-bit AES
            (CBC)
            ...
            * `3des-cbc` - 3DES
            * `des-cbc` - DES
        authentication_algorithm (Union[None, Unset, WritableIPSecProposalRequestAuthentication]): * `hmac-sha1` - SHA-1
            HMAC
        ...
        custom_fields (Union[Unset, WritableIPSecProposalRequestCustomFields]):
    """

    name: str
    description: Union[Unset, str] = UNSET
    encryption_algorithm: Union[None, Unset, WritableIPSecProposalRequestEncryption] = UNSET
    authentication_algorithm: Union[None, Unset, WritableIPSecProposalRequestAuthentication] = UNSET
    sa_lifetime_seconds: Union[None, Unset, int] = UNSET
    sa_lifetime_data: Union[None, Unset, int] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "WritableIPSecProposalRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.encryption_algorithm, WritableIPSecProposalRequestEncryption):
        ...
        elif isinstance(self.authentication_algorithm, WritableIPSecProposalRequestAuthentication):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_encryption_algorithm(data: object) -> Union[None, Unset, WritableIPSecProposalRequestEncryption]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_1 = WritableIPSecProposalRequestEncryption(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_2_type_1 = WritableIPSecProposalRequestEncryption(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_3_type_1 = WritableIPSecProposalRequestEncryption(data)

                return encryption_algorithm_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, WritableIPSecProposalRequestEncryption], data)

        encryption_algorithm = _parse_encryption_algorithm(d.pop("encryption_algorithm", UNSET))

        def _parse_authentication_algorithm(
            data: object,
        ) -> Union[None, Unset, WritableIPSecProposalRequestAuthentication]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                authentication_algorithm_type_1 = WritableIPSecProposalRequestAuthentication(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                authentication_algorithm_type_2_type_1 = WritableIPSecProposalRequestAuthentication(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                authentication_algorithm_type_3_type_1 = WritableIPSecProposalRequestAuthentication(data)

                return authentication_algorithm_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, WritableIPSecProposalRequestAuthentication], data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIPSecProposalRequestCustomFields.from_dict(_custom_fields)

        writable_ip_sec_proposal_request = cls(
            name=name,
        ...
        writable_ip_sec_proposal_request.additional_properties = d
        return writable_ip_sec_proposal_request
