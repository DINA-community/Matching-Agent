...
class PatchedWritableCircuitGroupAssignmentRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.priority, Unset):
            priority = UNSET
        elif isinstance(self.priority, PatchedWritableCircuitGroupAssignmentRequestPriorityType1):
            priority = self.priority.value
        elif isinstance(self.priority, PatchedWritableCircuitGroupAssignmentRequestPriorityType2Type1):
            priority = self.priority.value
        elif isinstance(self.priority, PatchedWritableCircuitGroupAssignmentRequestPriorityType3Type1):
            priority = self.priority.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        member_id = (
            self.member_id if isinstance(self.member_id, Unset) else (None, str(self.member_id).encode(), "text/plain")
        )
        ...
        def _parse_priority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                priority_type_1 = PatchedWritableCircuitGroupAssignmentRequestPriorityType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                priority_type_2_type_1 = PatchedWritableCircuitGroupAssignmentRequestPriorityType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                priority_type_3_type_1 = PatchedWritableCircuitGroupAssignmentRequestPriorityType3Type1(data)
