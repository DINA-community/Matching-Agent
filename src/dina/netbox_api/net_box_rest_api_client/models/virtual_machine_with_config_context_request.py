...
from ..models.virtual_machine_with_config_context_request_status import VirtualMachineWithConfigContextRequestStatus
...
class VirtualMachineWithConfigContextRequest:
    ...
    custom_fields: Union[Unset, "VirtualMachineWithConfigContextRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VirtualMachineWithConfigContextRequestCustomFields.from_dict(_custom_fields)
