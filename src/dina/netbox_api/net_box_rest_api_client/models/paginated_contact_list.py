...
T = TypeVar("T", bound="PaginatedContactList")
...
class PaginatedContactList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Contact.from_dict(results_item_data)
        ...
        paginated_contact_list.additional_properties = d
