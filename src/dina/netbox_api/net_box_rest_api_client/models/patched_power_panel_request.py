...
if TYPE_CHECKING:
    ...
    from ..models.patched_power_panel_request_custom_fields import PatchedPowerPanelRequestCustomFields
...
class PatchedPowerPanelRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedPowerPanelRequestCustomFields.from_dict(_custom_fields)
