...
T = TypeVar("T", bound="PaginatedObjectChangeList")
...
class PaginatedObjectChangeList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ObjectChange.from_dict(results_item_data)
        ...
        paginated_object_change_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_object_change_list.additional_properties = d
        return paginated_object_change_list
