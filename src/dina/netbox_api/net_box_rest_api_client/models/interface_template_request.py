...
from ..models.interface_template_request_poe_mode_type_1 import InterfaceTemplateRequestPoeModeType1
from ..models.interface_template_request_poe_mode_type_2_type_1 import InterfaceTemplateRequestPoeModeType2Type1
from ..models.interface_template_request_poe_mode_type_3_type_1 import InterfaceTemplateRequestPoeModeType3Type1
from ..models.interface_template_request_poe_type_type_1 import InterfaceTemplateRequestPoeTypeType1
from ..models.interface_template_request_poe_type_type_2_type_1 import InterfaceTemplateRequestPoeTypeType2Type1
from ..models.interface_template_request_poe_type_type_3_type_1 import InterfaceTemplateRequestPoeTypeType3Type1
from ..models.interface_template_request_rf_role_type_1 import InterfaceTemplateRequestRfRoleType1
from ..models.interface_template_request_rf_role_type_2_type_1 import InterfaceTemplateRequestRfRoleType2Type1
from ..models.interface_template_request_rf_role_type_3_type_1 import InterfaceTemplateRequestRfRoleType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.nested_interface_template_request import NestedInterfaceTemplateRequest
...
class InterfaceTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_bridge(data: object) -> Union["NestedInterfaceTemplateRequest", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
