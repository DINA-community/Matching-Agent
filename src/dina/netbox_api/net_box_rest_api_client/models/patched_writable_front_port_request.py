...
from ..models.patched_writable_front_port_request_type import PatchedWritableFrontPortRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_front_port_request_custom_fields import PatchedWritableFrontPortRequestCustomFields


T = TypeVar("T", bound="PatchedWritableFrontPortRequest")
...
class PatchedWritableFrontPortRequest:
    ...
    Attributes:
        ...
        type_ (Union[Unset, PatchedWritableFrontPortRequestType]): * `8p8c` - 8P8C
            * `8p6c` - 8P6C
            * `8p4c` - 8P4C
            * `8p2c` - 8P2C
            * `6p6c` - 6P6C
        ...
        custom_fields (Union[Unset, PatchedWritableFrontPortRequestCustomFields]):
    """
    ...
    type_: Union[Unset, PatchedWritableFrontPortRequestType] = UNSET
    color: Union[Unset, str] = UNSET
    rear_port: Union[Unset, int] = UNSET
    rear_port_position: Union[Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    mark_connected: Union[Unset, bool] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "PatchedWritableFrontPortRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        rear_port = (
            self.rear_port if isinstance(self.rear_port, Unset) else (None, str(self.rear_port).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_module_request import BriefModuleRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.patched_writable_front_port_request_custom_fields import (
        ...
        type_: Union[Unset, PatchedWritableFrontPortRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PatchedWritableFrontPortRequestType(_type_)

        color = d.pop("color", UNSET)

        rear_port = d.pop("rear_port", UNSET)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableFrontPortRequestCustomFields.from_dict(_custom_fields)

        patched_writable_front_port_request = cls(
            device=device,
            module=module,
            name=name,
            label=label,
        ...
        patched_writable_front_port_request.additional_properties = d
        return patched_writable_front_port_request
