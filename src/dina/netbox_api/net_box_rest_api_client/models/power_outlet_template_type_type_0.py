...
from ..models.power_outlet_template_type_type_0_label import PowerOutletTemplateTypeType0Label
from ..models.power_outlet_template_type_type_0_value_type_1 import PowerOutletTemplateTypeType0ValueType1
from ..types import UNSET, Unset

T = TypeVar("T", bound="PowerOutletTemplateTypeType0")


@_attrs_define
class PowerOutletTemplateTypeType0:
    """
    Attributes:
        value (Union[None, PowerOutletTemplateTypeType0ValueType1, Unset]): * `iec-60320-c5` - C5
            * `iec-60320-c7` - C7
            * `iec-60320-c13` - C13
            * `iec-60320-c15` - C15
            * `iec-60320-c19` - C19
            ...
            * `hardwired` - Hardwired
            * `other` - Other
        label (Union[Unset, PowerOutletTemplateTypeType0Label]):
    """

    value: Union[None, PowerOutletTemplateTypeType0ValueType1, Unset] = UNSET
    label: Union[Unset, PowerOutletTemplateTypeType0Label] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, PowerOutletTemplateTypeType0ValueType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[None, PowerOutletTemplateTypeType0ValueType1, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                value_type_1 = PowerOutletTemplateTypeType0ValueType1(data)

                return value_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PowerOutletTemplateTypeType0ValueType1, Unset], data)
        ...
        if isinstance(_label, Unset):
            ...
            label = PowerOutletTemplateTypeType0Label(_label)

        power_outlet_template_type_type_0 = cls(
            value=value,
            label=label,
        )

        power_outlet_template_type_type_0.additional_properties = d
        return power_outlet_template_type_type_0
