...
from ..models.patched_writable_vm_interface_request_mode_type_1 import PatchedWritableVMInterfaceRequestModeType1
...
class PatchedWritableVMInterfaceRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_virtual_machine(data: object) -> Union["BriefVirtualMachineRequest", Unset, int]:
        ...
        def _parse_mode(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_2_type_1 = PatchedWritableVMInterfaceRequestModeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_3_type_1 = PatchedWritableVMInterfaceRequestModeType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVMInterfaceRequestCustomFields.from_dict(_custom_fields)
