...
if TYPE_CHECKING:
    ...
    from ..models.brief_power_port import BriefPowerPort
    ...
    from ..models.power_outlet_status import PowerOutletStatus
...
class PowerOutlet:
    ...
    Attributes:
        ...
        type_ (Union['PowerOutletTypeType0', None, Unset]):
        status (Union[Unset, PowerOutletStatus]):
        color (Union[Unset, str]):
        power_port (Union['BriefPowerPort', None, Unset]):
    ...
    type_: Union["PowerOutletTypeType0", None, Unset] = UNSET
    status: Union[Unset, "PowerOutletStatus"] = UNSET
    color: Union[Unset, str] = UNSET
    power_port: Union["BriefPowerPort", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, PowerOutletTypeType0):
        ...
        if isinstance(self.power_port, Unset):
            power_port = UNSET
        elif isinstance(self.power_port, BriefPowerPort):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(data: object) -> Union["PowerOutletTypeType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if isinstance(_status, Unset):
            ...
            status = PowerOutletStatus.from_dict(_status)

        color = d.pop("color", UNSET)

        def _parse_power_port(data: object) -> Union["BriefPowerPort", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                power_port_type_1 = BriefPowerPort.from_dict(data)

                return power_port_type_1
            except:  # noqa: E722
                pass
            return cast(Union["BriefPowerPort", None, Unset], data)

        power_port = _parse_power_port(d.pop("power_port", UNSET))

        def _parse_feed_leg(data: object) -> Union["PowerOutletFeedLegType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
