...
from ..models.patched_writable_power_feed_request_phase import PatchedWritablePowerFeedRequestPhase
from ..models.patched_writable_power_feed_request_status import PatchedWritablePowerFeedRequestStatus
from ..models.patched_writable_power_feed_request_supply import PatchedWritablePowerFeedRequestSupply
from ..models.patched_writable_power_feed_request_type import PatchedWritablePowerFeedRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_power_feed_request_custom_fields import PatchedWritablePowerFeedRequestCustomFields
...
class PatchedWritablePowerFeedRequest:
    ...
    Attributes:
        power_panel (Union['BriefPowerPanelRequest', Unset, int]):
        ...
        status (Union[Unset, PatchedWritablePowerFeedRequestStatus]): * `offline` - Offline
            ...
            * `planned` - Planned
            * `failed` - Failed
        type_ (Union[Unset, PatchedWritablePowerFeedRequestType]): * `primary` - Primary
            * `redundant` - Redundant
    ...
    power_panel: Union["BriefPowerPanelRequest", Unset, int] = UNSET
    rack: Union["BriefRackRequest", None, Unset, int] = UNSET
    name: Union[Unset, str] = UNSET
    status: Union[Unset, PatchedWritablePowerFeedRequestStatus] = UNSET
    type_: Union[Unset, PatchedWritablePowerFeedRequestType] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        power_panel: Union[Unset, dict[str, Any], int]
        if isinstance(self.power_panel, Unset):
            power_panel = UNSET
        elif isinstance(self.power_panel, BriefPowerPanelRequest):
    ...
    def to_multipart(self) -> dict[str, Any]:
        power_panel: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.power_panel, Unset):
            power_panel = UNSET
        elif isinstance(self.power_panel, int):
            power_panel = (None, str(self.power_panel).encode(), "text/plain")
        else:
            power_panel = (None, json.dumps(self.power_panel.to_dict()).encode(), "application/json")
        ...
        voltage = self.voltage if isinstance(self.voltage, Unset) else (None, str(self.voltage).encode(), "text/plain")

        amperage = (
            self.amperage if isinstance(self.amperage, Unset) else (None, str(self.amperage).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_power_panel(data: object) -> Union["BriefPowerPanelRequest", Unset, int]:
            ...
            try:
                ...
                pass
            return cast(Union["BriefPowerPanelRequest", Unset, int], data)

        power_panel = _parse_power_panel(d.pop("power_panel", UNSET))
        ...
        type_: Union[Unset, PatchedWritablePowerFeedRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PatchedWritablePowerFeedRequestType(_type_)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritablePowerFeedRequestCustomFields.from_dict(_custom_fields)
