...
from ..models.console_server_port_speed_type_0_label import ConsoleServerPortSpeedType0Label
from ..models.console_server_port_speed_type_0_value_type_1 import ConsoleServerPortSpeedType0ValueType1
...
class ConsoleServerPortSpeedType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[ConsoleServerPortSpeedType0ValueType1, None, Unset]:
            if data is None:
                return data
