...
T = TypeVar("T", bound="PatchedCommunicationRequest")


@_attrs_define
class PatchedCommunicationRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        destination_device: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.destination_device, Unset):
            destination_device = UNSET
        elif isinstance(self.destination_device, int):
            destination_device = (None, str(self.destination_device).encode(), "text/plain")
        else:
            destination_device = (None, str(self.destination_device).encode(), "text/plain")

        source_ip_addr: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.source_ip_addr, Unset):
            source_ip_addr = UNSET
        elif isinstance(self.source_ip_addr, int):
            source_ip_addr = (None, str(self.source_ip_addr).encode(), "text/plain")
        else:
            source_ip_addr = (None, str(self.source_ip_addr).encode(), "text/plain")

        destination_ip_addr: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.destination_ip_addr, Unset):
            destination_ip_addr = UNSET
        elif isinstance(self.destination_ip_addr, int):
            destination_ip_addr = (None, str(self.destination_ip_addr).encode(), "text/plain")
        else:
            destination_ip_addr = (None, str(self.destination_ip_addr).encode(), "text/plain")
        ...
        if isinstance(self.destination_port, Unset):
            destination_port = UNSET
        elif isinstance(self.destination_port, int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination_device = _parse_destination_device(d.pop("destination_device", UNSET))
        ...
        destination_ip_addr = _parse_destination_ip_addr(d.pop("destination_ip_addr", UNSET))
        ...
        patched_communication_request = cls(
        ...
        patched_communication_request.additional_properties = d
        return patched_communication_request
