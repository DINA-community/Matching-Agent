...
T = TypeVar("T", bound="PaginatedSoftwareList")


@_attrs_define
class PaginatedSoftwareList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['Software']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Software.from_dict(results_item_data)
        ...
        paginated_software_list.additional_properties = d
        return paginated_software_list
