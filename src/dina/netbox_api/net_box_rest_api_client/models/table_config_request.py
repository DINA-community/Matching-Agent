...
T = TypeVar("T", bound="TableConfigRequest")
...
class TableConfigRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        table = (None, str(self.table).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        table_config_request.additional_properties = d
        return table_config_request
