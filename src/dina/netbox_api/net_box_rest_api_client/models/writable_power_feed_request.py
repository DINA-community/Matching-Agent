...
if TYPE_CHECKING:
    ...
    from ..models.writable_power_feed_request_custom_fields import WritablePowerFeedRequestCustomFields
...
class WritablePowerFeedRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritablePowerFeedRequestCustomFields.from_dict(_custom_fields)
