...
from ..models.writable_tunnel_termination_request_role import WritableTunnelTerminationRequestRole
...
if TYPE_CHECKING:
    ...
    from ..models.writable_tunnel_termination_request_custom_fields import WritableTunnelTerminationRequestCustomFields


T = TypeVar("T", bound="WritableTunnelTerminationRequest")
...
class WritableTunnelTerminationRequest:
    ...
    Attributes:
        tunnel (Union['BriefTunnelRequest', int]):
        termination_type (str):
        role (Union[Unset, WritableTunnelTerminationRequestRole]): * `peer` - Peer
            * `hub` - Hub
            * `spoke` - Spoke
        termination_id (Union[None, Unset, int]):
        outside_ip (Union['BriefIPAddressRequest', None, Unset, int]):
        tags (Union[Unset, list['NestedTagRequest']]):
        custom_fields (Union[Unset, WritableTunnelTerminationRequestCustomFields]):
    """

    tunnel: Union["BriefTunnelRequest", int]
    termination_type: str
    role: Union[Unset, WritableTunnelTerminationRequestRole] = UNSET
    termination_id: Union[None, Unset, int] = UNSET
    outside_ip: Union["BriefIPAddressRequest", None, Unset, int] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "WritableTunnelTerminationRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tunnel: Union[dict[str, Any], int]
        if isinstance(self.tunnel, BriefTunnelRequest):
    ...
    def to_multipart(self) -> dict[str, Any]:
        tunnel: tuple[None, bytes, str]

        if isinstance(self.tunnel, int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_tunnel_request import BriefTunnelRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.writable_tunnel_termination_request_custom_fields import (
            WritableTunnelTerminationRequestCustomFields,
        )

        d = dict(src_dict)

        def _parse_tunnel(data: object) -> Union["BriefTunnelRequest", int]:
            try:
                ...
                pass
            return cast(Union["BriefTunnelRequest", int], data)

        tunnel = _parse_tunnel(d.pop("tunnel"))

        termination_type = d.pop("termination_type")

        _role = d.pop("role", UNSET)
        role: Union[Unset, WritableTunnelTerminationRequestRole]
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = WritableTunnelTerminationRequestRole(_role)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableTunnelTerminationRequestCustomFields.from_dict(_custom_fields)

        writable_tunnel_termination_request = cls(
            tunnel=tunnel,
            termination_type=termination_type,
            role=role,
        ...
        writable_tunnel_termination_request.additional_properties = d
        return writable_tunnel_termination_request
