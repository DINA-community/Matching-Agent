...
T = TypeVar("T", bound="PaginatedManufacturerList")
...
class PaginatedManufacturerList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Manufacturer.from_dict(results_item_data)
        ...
        paginated_manufacturer_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_manufacturer_list.additional_properties = d
        return paginated_manufacturer_list
