...
T = TypeVar("T", bound="PaginatedDeviceFindingList")


@_attrs_define
class PaginatedDeviceFindingList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['DeviceFinding']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DeviceFinding.from_dict(results_item_data)
        ...
        paginated_device_finding_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_device_finding_list.additional_properties = d
        return paginated_device_finding_list
