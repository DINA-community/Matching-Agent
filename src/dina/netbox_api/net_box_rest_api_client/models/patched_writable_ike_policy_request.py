...
from ..models.patched_writable_ike_policy_request_mode_type_1 import PatchedWritableIKEPolicyRequestModeType1
...
from ..models.patched_writable_ike_policy_request_version import PatchedWritableIKEPolicyRequestVersion
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.patched_writable_ike_policy_request_custom_fields import PatchedWritableIKEPolicyRequestCustomFields
...
class PatchedWritableIKEPolicyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIKEPolicyRequestCustomFields.from_dict(_custom_fields)
