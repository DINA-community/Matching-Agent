...
T = TypeVar("T", bound="PaginatedFHRPGroupList")
...
class PaginatedFHRPGroupList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = FHRPGroup.from_dict(results_item_data)
        ...
        paginated_fhrp_group_list.additional_properties = d
        return paginated_fhrp_group_list
