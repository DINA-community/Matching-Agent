...
if TYPE_CHECKING:
    ...
    from ..models.virtual_machine_with_config_context_custom_fields import VirtualMachineWithConfigContextCustomFields
    from ..models.virtual_machine_with_config_context_status import VirtualMachineWithConfigContextStatus
...
class VirtualMachineWithConfigContext:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VirtualMachineWithConfigContextCustomFields.from_dict(_custom_fields)
