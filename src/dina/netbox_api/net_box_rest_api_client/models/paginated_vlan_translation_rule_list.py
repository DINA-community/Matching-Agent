...
T = TypeVar("T", bound="PaginatedVLANTranslationRuleList")
...
class PaginatedVLANTranslationRuleList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VLANTranslationRule.from_dict(results_item_data)
        ...
        paginated_vlan_translation_rule_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vlan_translation_rule_list.additional_properties = d
        return paginated_vlan_translation_rule_list
