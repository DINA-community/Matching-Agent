...
T = TypeVar("T", bound="PaginatedTokenList")
...
class PaginatedTokenList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Token.from_dict(results_item_data)
        ...
        paginated_token_list.additional_properties = d
        return paginated_token_list
