...
if TYPE_CHECKING:
    ...
    from ..models.console_port_template_type import ConsolePortTemplateType


T = TypeVar("T", bound="ConsolePortTemplate")
...
class ConsolePortTemplate:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[Unset, ConsolePortTemplateType]):
    ...
    type_: Union[Unset, "ConsolePortTemplateType"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ConsolePortTemplateType.from_dict(_type_)

        description = d.pop("description", UNSET)

        console_port_template = cls(
            id=id,
            url=url,
            display=display,
            name=name,
        ...
        console_port_template.additional_properties = d
