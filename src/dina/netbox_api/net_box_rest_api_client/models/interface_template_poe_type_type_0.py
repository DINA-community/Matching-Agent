...
from ..models.interface_template_poe_type_type_0_label import InterfaceTemplatePoeTypeType0Label
from ..models.interface_template_poe_type_type_0_value_type_1 import InterfaceTemplatePoeTypeType0ValueType1
...
class InterfaceTemplatePoeTypeType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[InterfaceTemplatePoeTypeType0ValueType1, None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[InterfaceTemplatePoeTypeType0ValueType1, None, Unset], data)
