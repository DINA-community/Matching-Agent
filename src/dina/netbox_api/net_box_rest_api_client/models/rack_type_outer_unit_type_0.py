...
from ..models.rack_type_outer_unit_type_0_value_type_1 import RackTypeOuterUnitType0ValueType1
...
class RackTypeOuterUnitType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[None, RackTypeOuterUnitType0ValueType1, Unset]:
            if data is None:
                return data
