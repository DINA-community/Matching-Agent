...
from ..models.power_port_template_type_type_0_label import PowerPortTemplateTypeType0Label
from ..models.power_port_template_type_type_0_value_type_1 import PowerPortTemplateTypeType0ValueType1
...
class PowerPortTemplateTypeType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[None, PowerPortTemplateTypeType0ValueType1, Unset]:
            if data is None:
                return data
