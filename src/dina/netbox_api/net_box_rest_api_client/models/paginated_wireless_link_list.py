...
T = TypeVar("T", bound="PaginatedWirelessLinkList")
...
class PaginatedWirelessLinkList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = WirelessLink.from_dict(results_item_data)
        ...
        paginated_wireless_link_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_wireless_link_list.additional_properties = d
        return paginated_wireless_link_list
