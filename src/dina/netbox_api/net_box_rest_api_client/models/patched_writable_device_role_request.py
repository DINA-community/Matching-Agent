...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_device_role_request_custom_fields import PatchedWritableDeviceRoleRequestCustomFields


T = TypeVar("T", bound="PatchedWritableDeviceRoleRequest")
...
class PatchedWritableDeviceRoleRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PatchedWritableDeviceRoleRequestCustomFields]):
    ...
    custom_fields: Union[Unset, "PatchedWritableDeviceRoleRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        vm_role = self.vm_role if isinstance(self.vm_role, Unset) else (None, str(self.vm_role).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.brief_config_template_request import BriefConfigTemplateRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.patched_writable_device_role_request_custom_fields import (
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableDeviceRoleRequestCustomFields.from_dict(_custom_fields)

        comments = d.pop("comments", UNSET)

        patched_writable_device_role_request = cls(
            name=name,
            slug=slug,
            color=color,
            vm_role=vm_role,
        ...
        patched_writable_device_role_request.additional_properties = d
        return patched_writable_device_role_request
