...
class PatchedWritableVirtualMachineWithConfigContextRequest:
    ...
    status: Union[Unset, PatchedWritableVirtualMachineWithConfigContextRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedWritableVirtualMachineWithConfigContextRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PatchedWritableVirtualMachineWithConfigContextRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritableVirtualMachineWithConfigContextRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVirtualMachineWithConfigContextRequestCustomFields.from_dict(_custom_fields)
