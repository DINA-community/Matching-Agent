...
if TYPE_CHECKING:
    ...
    from ..models.patched_contact_request_custom_fields import PatchedContactRequestCustomFields
...
class PatchedContactRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PatchedContactRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PatchedContactRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedContactRequestCustomFields.from_dict(_custom_fields)
