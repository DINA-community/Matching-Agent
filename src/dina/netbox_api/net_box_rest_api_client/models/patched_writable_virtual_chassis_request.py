...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_virtual_chassis_request_custom_fields import (
        PatchedWritableVirtualChassisRequestCustomFields,
    )


T = TypeVar("T", bound="PatchedWritableVirtualChassisRequest")
...
class PatchedWritableVirtualChassisRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PatchedWritableVirtualChassisRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PatchedWritableVirtualChassisRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVirtualChassisRequestCustomFields.from_dict(_custom_fields)

        patched_writable_virtual_chassis_request = cls(
            name=name,
            domain=domain,
            master=master,
        ...
        patched_writable_virtual_chassis_request.additional_properties = d
        return patched_writable_virtual_chassis_request
