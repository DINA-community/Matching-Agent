...
from ..models.writable_data_source_request_sync_interval_type_1 import WritableDataSourceRequestSyncIntervalType1
...
if TYPE_CHECKING:
    from ..models.writable_data_source_request_custom_fields import WritableDataSourceRequestCustomFields
...
class WritableDataSourceRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.sync_interval, WritableDataSourceRequestSyncIntervalType2Type1):
            sync_interval = self.sync_interval.value
        elif isinstance(self.sync_interval, WritableDataSourceRequestSyncIntervalType3Type1):
            sync_interval = self.sync_interval.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_sync_interval(
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                sync_interval_type_2_type_1 = WritableDataSourceRequestSyncIntervalType2Type1(data)
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                sync_interval_type_3_type_1 = WritableDataSourceRequestSyncIntervalType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableDataSourceRequestCustomFields.from_dict(_custom_fields)
