...
if TYPE_CHECKING:
    ...
    from ..models.writable_rear_port_request_custom_fields import WritableRearPortRequestCustomFields
...
class WritableRearPortRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableRearPortRequestCustomFields.from_dict(_custom_fields)
