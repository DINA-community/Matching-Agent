...
T = TypeVar("T", bound="CommunicationFindingRequest")


@_attrs_define
class CommunicationFindingRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        communication_finding_request = cls(
            source=source,
            source_ip=source_ip,
        ...
        communication_finding_request.additional_properties = d
        return communication_finding_request
