...
from ..models.circuit_termination_termination_side import CircuitTerminationTerminationSide
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.brief_cable import BriefCable
    from ..models.brief_circuit import BriefCircuit
    from ..models.circuit_termination_custom_fields import CircuitTerminationCustomFields
