...
T = TypeVar("T", bound="PaginatedInterfaceList")
...
class PaginatedInterfaceList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Interface.from_dict(results_item_data)
        ...
        paginated_interface_list.additional_properties = d
        return paginated_interface_list
