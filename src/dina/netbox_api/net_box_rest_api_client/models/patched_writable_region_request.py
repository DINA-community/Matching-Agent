...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_region_request_custom_fields import PatchedWritableRegionRequestCustomFields


T = TypeVar("T", bound="PatchedWritableRegionRequest")
...
class PatchedWritableRegionRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PatchedWritableRegionRequestCustomFields]):
    ...
    custom_fields: Union[Unset, "PatchedWritableRegionRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableRegionRequestCustomFields.from_dict(_custom_fields)

        comments = d.pop("comments", UNSET)

        patched_writable_region_request = cls(
            name=name,
            slug=slug,
            parent=parent,
        ...
        patched_writable_region_request.additional_properties = d
        return patched_writable_region_request
