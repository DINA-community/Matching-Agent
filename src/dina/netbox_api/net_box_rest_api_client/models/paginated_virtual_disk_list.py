...
T = TypeVar("T", bound="PaginatedVirtualDiskList")
...
class PaginatedVirtualDiskList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VirtualDisk.from_dict(results_item_data)
        ...
        paginated_virtual_disk_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_virtual_disk_list.additional_properties = d
        return paginated_virtual_disk_list
