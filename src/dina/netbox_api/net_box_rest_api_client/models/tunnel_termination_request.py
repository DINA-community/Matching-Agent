...
if TYPE_CHECKING:
    ...
    from ..models.tunnel_termination_request_custom_fields import TunnelTerminationRequestCustomFields
...
class TunnelTerminationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = TunnelTerminationRequestCustomFields.from_dict(_custom_fields)
