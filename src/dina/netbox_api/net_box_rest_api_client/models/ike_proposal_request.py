...
from ..models.ike_proposal_request_authentication_algorithm import IKEProposalRequestAuthenticationAlgorithm
from ..models.ike_proposal_request_authentication_method import IKEProposalRequestAuthenticationMethod
from ..models.ike_proposal_request_encryption_algorithm import IKEProposalRequestEncryptionAlgorithm
from ..models.ike_proposal_request_group import IKEProposalRequestGroup
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ike_proposal_request_custom_fields import IKEProposalRequestCustomFields
...
class IKEProposalRequest:
    ...
    authentication_algorithm: Union[Unset, IKEProposalRequestAuthenticationAlgorithm] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication_method = IKEProposalRequestAuthenticationMethod(d.pop("authentication_method"))

        encryption_algorithm = IKEProposalRequestEncryptionAlgorithm(d.pop("encryption_algorithm"))
        ...
        authentication_algorithm: Union[Unset, IKEProposalRequestAuthenticationAlgorithm]
        if isinstance(_authentication_algorithm, Unset):
            authentication_algorithm = UNSET
        else:
            authentication_algorithm = IKEProposalRequestAuthenticationAlgorithm(_authentication_algorithm)
