...
T = TypeVar("T", bound="PaginatedEventRuleList")
...
class PaginatedEventRuleList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = EventRule.from_dict(results_item_data)
        ...
        paginated_event_rule_list.additional_properties = d
        return paginated_event_rule_list
