...
if TYPE_CHECKING:
    from ..models.mac_address_custom_fields import MACAddressCustomFields
...
class MACAddress:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, MACAddressCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "MACAddressCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = MACAddressCustomFields.from_dict(_custom_fields)
