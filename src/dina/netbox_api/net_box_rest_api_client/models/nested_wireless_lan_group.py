...
T = TypeVar("T", bound="NestedWirelessLANGroup")
...
class NestedWirelessLANGroup:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nested_wireless_lan_group.additional_properties = d
        return nested_wireless_lan_group
