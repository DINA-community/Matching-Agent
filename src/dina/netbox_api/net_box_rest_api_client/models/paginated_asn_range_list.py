...
T = TypeVar("T", bound="PaginatedASNRangeList")
...
class PaginatedASNRangeList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ASNRange.from_dict(results_item_data)
        ...
        paginated_asn_range_list.additional_properties = d
        return paginated_asn_range_list
