...
from ..models.patched_writable_ip_range_request_status import PatchedWritableIPRangeRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_ip_range_request_custom_fields import PatchedWritableIPRangeRequestCustomFields
...
class PatchedWritableIPRangeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIPRangeRequestCustomFields.from_dict(_custom_fields)
