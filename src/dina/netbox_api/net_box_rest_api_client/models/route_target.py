...
if TYPE_CHECKING:
    ...
    from ..models.route_target_custom_fields import RouteTargetCustomFields
...
class RouteTarget:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, RouteTargetCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "RouteTargetCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = RouteTargetCustomFields.from_dict(_custom_fields)
        ...
        route_target.additional_properties = d
        return route_target
