...
T = TypeVar("T", bound="DeviceFindingRequest")


@_attrs_define
class DeviceFindingRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        device_finding_request.additional_properties = d
        return device_finding_request
