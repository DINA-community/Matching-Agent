...
T = TypeVar("T", bound="PaginatedRearPortList")
...
class PaginatedRearPortList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RearPort.from_dict(results_item_data)
        ...
        paginated_rear_port_list.additional_properties = d
        return paginated_rear_port_list
