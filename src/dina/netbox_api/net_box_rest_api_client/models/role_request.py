...
if TYPE_CHECKING:
    ...
    from ..models.role_request_custom_fields import RoleRequestCustomFields
...
class RoleRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, RoleRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "RoleRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = RoleRequestCustomFields.from_dict(_custom_fields)
