...
if TYPE_CHECKING:
    ...
    from ..models.power_port_custom_fields import PowerPortCustomFields
    from ..models.power_port_type_type_0 import PowerPortTypeType0


T = TypeVar("T", bound="PowerPort")
...
class PowerPort:
    ...
    Attributes:
        ...
        type_ (Union['PowerPortTypeType0', None, Unset]):
        ...
        custom_fields (Union[Unset, PowerPortCustomFields]):
    """
    ...
    type_: Union["PowerPortTypeType0", None, Unset] = UNSET
    ...
    custom_fields: Union[Unset, "PowerPortCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, PowerPortTypeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(data: object) -> Union["PowerPortTypeType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                type_type_0 = PowerPortTypeType0.from_dict(data)

                return type_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PowerPortTypeType0", None, Unset], data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PowerPortCustomFields.from_dict(_custom_fields)
        ...
        power_port.additional_properties = d
        return power_port
