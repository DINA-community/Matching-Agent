...
if TYPE_CHECKING:
    ...
    from ..models.patched_provider_account_request_custom_fields import PatchedProviderAccountRequestCustomFields
...
class PatchedProviderAccountRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedProviderAccountRequestCustomFields.from_dict(_custom_fields)
