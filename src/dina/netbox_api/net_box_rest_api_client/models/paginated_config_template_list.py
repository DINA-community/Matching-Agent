...
T = TypeVar("T", bound="PaginatedConfigTemplateList")
...
class PaginatedConfigTemplateList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ConfigTemplate.from_dict(results_item_data)
        ...
        paginated_config_template_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_config_template_list.additional_properties = d
        return paginated_config_template_list
