...
from ..models.patched_writable_rear_port_request_type import PatchedWritableRearPortRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_rear_port_request_custom_fields import PatchedWritableRearPortRequestCustomFields


T = TypeVar("T", bound="PatchedWritableRearPortRequest")
...
class PatchedWritableRearPortRequest:
    ...
    Attributes:
        ...
        type_ (Union[Unset, PatchedWritableRearPortRequestType]): * `8p8c` - 8P8C
            * `8p6c` - 8P6C
            * `8p4c` - 8P4C
            * `8p2c` - 8P2C
            * `6p6c` - 6P6C
        ...
        positions (Union[Unset, int]): Number of front ports which may be mapped
        description (Union[Unset, str]):
        mark_connected (Union[Unset, bool]): Treat as if a cable is connected
        tags (Union[Unset, list['NestedTagRequest']]):
        custom_fields (Union[Unset, PatchedWritableRearPortRequestCustomFields]):
    """
    ...
    type_: Union[Unset, PatchedWritableRearPortRequestType] = UNSET
    color: Union[Unset, str] = UNSET
    positions: Union[Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    mark_connected: Union[Unset, bool] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "PatchedWritableRearPortRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, PatchedWritableRearPortRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PatchedWritableRearPortRequestType(_type_)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableRearPortRequestCustomFields.from_dict(_custom_fields)

        patched_writable_rear_port_request = cls(
            device=device,
            module=module,
            name=name,
            label=label,
        ...
        patched_writable_rear_port_request.additional_properties = d
        return patched_writable_rear_port_request
