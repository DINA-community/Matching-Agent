...
from ..models.patched_writable_power_outlet_request_feed_leg_type_1 import PatchedWritablePowerOutletRequestFeedLegType1
from ..models.patched_writable_power_outlet_request_feed_leg_type_2_type_1 import (
    PatchedWritablePowerOutletRequestFeedLegType2Type1,
)
from ..models.patched_writable_power_outlet_request_feed_leg_type_3_type_1 import (
    PatchedWritablePowerOutletRequestFeedLegType3Type1,
)
from ..models.patched_writable_power_outlet_request_status import PatchedWritablePowerOutletRequestStatus
from ..models.patched_writable_power_outlet_request_type_type_1 import PatchedWritablePowerOutletRequestTypeType1
from ..models.patched_writable_power_outlet_request_type_type_2_type_1 import (
    PatchedWritablePowerOutletRequestTypeType2Type1,
)
from ..models.patched_writable_power_outlet_request_type_type_3_type_1 import (
...
class PatchedWritablePowerOutletRequest:
    ...
    Attributes:
        ...
        type_ (Union[None, PatchedWritablePowerOutletRequestTypeType1, PatchedWritablePowerOutletRequestTypeType2Type1,
            PatchedWritablePowerOutletRequestTypeType3Type1, Unset]): Physical port type
            ...
            * `hardwired` - Hardwired
            * `other` - Other
        status (Union[Unset, PatchedWritablePowerOutletRequestStatus]): * `enabled` - Enabled
            * `disabled` - Disabled
            * `faulty` - Faulty
        color (Union[Unset, str]):
        power_port (Union['BriefPowerPortRequest', None, Unset, int]):
        feed_leg (Union[None, PatchedWritablePowerOutletRequestFeedLegType1,
            PatchedWritablePowerOutletRequestFeedLegType2Type1, PatchedWritablePowerOutletRequestFeedLegType3Type1, Unset]):
    ...
    status: Union[Unset, PatchedWritablePowerOutletRequestStatus] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, PatchedWritablePowerOutletRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, PatchedWritablePowerOutletRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, PatchedWritablePowerOutletRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
        ...
        if isinstance(self.feed_leg, Unset):
            feed_leg = UNSET
        elif isinstance(self.feed_leg, PatchedWritablePowerOutletRequestFeedLegType1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, PatchedWritablePowerOutletRequestFeedLegType2Type1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, PatchedWritablePowerOutletRequestFeedLegType3Type1):
            feed_leg = self.feed_leg.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = PatchedWritablePowerOutletRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = PatchedWritablePowerOutletRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = PatchedWritablePowerOutletRequestTypeType3Type1(data)
        ...
        status: Union[Unset, PatchedWritablePowerOutletRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritablePowerOutletRequestStatus(_status)
        ...
        def _parse_feed_leg(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_1 = PatchedWritablePowerOutletRequestFeedLegType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_2_type_1 = PatchedWritablePowerOutletRequestFeedLegType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_3_type_1 = PatchedWritablePowerOutletRequestFeedLegType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritablePowerOutletRequestCustomFields.from_dict(_custom_fields)
