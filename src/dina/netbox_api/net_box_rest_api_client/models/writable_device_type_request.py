...
from ..models.writable_device_type_request_airflow_type_1 import WritableDeviceTypeRequestAirflowType1
from ..models.writable_device_type_request_airflow_type_2_type_1 import WritableDeviceTypeRequestAirflowType2Type1
from ..models.writable_device_type_request_airflow_type_3_type_1 import WritableDeviceTypeRequestAirflowType3Type1
from ..models.writable_device_type_request_parentchild_status import WritableDeviceTypeRequestParentchildStatus
from ..models.writable_device_type_request_weight_unit_type_1 import WritableDeviceTypeRequestWeightUnitType1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_device_type_request_custom_fields import WritableDeviceTypeRequestCustomFields
...
class WritableDeviceTypeRequest:
    ...
    subdevice_role: Union[None, Unset, WritableDeviceTypeRequestParentchildStatus] = UNSET
    airflow: Union[
        None,
        Unset,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.subdevice_role, WritableDeviceTypeRequestParentchildStatus):
        ...
        elif isinstance(self.weight_unit, WritableDeviceTypeRequestWeightUnitType2Type1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, WritableDeviceTypeRequestWeightUnitType3Type1):
            weight_unit = self.weight_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subdevice_role(data: object) -> Union[None, Unset, WritableDeviceTypeRequestParentchildStatus]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subdevice_role_type_2_type_1 = WritableDeviceTypeRequestParentchildStatus(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subdevice_role_type_3_type_1 = WritableDeviceTypeRequestParentchildStatus(data)

                return subdevice_role_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, WritableDeviceTypeRequestParentchildStatus], data)
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = WritableDeviceTypeRequestWeightUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = WritableDeviceTypeRequestWeightUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableDeviceTypeRequestCustomFields.from_dict(_custom_fields)
