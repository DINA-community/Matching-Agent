...
class PatchedWritablePowerOutletTemplateRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.type_, PatchedWritablePowerOutletTemplateRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, PatchedWritablePowerOutletTemplateRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
        ...
        if isinstance(self.feed_leg, Unset):
            feed_leg = UNSET
        elif isinstance(self.feed_leg, PatchedWritablePowerOutletTemplateRequestFeedLegType1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, PatchedWritablePowerOutletTemplateRequestFeedLegType2Type1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, PatchedWritablePowerOutletTemplateRequestFeedLegType3Type1):
            feed_leg = self.feed_leg.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = PatchedWritablePowerOutletTemplateRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = PatchedWritablePowerOutletTemplateRequestTypeType3Type1(data)
        ...
        def _parse_feed_leg(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_1 = PatchedWritablePowerOutletTemplateRequestFeedLegType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_2_type_1 = PatchedWritablePowerOutletTemplateRequestFeedLegType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_3_type_1 = PatchedWritablePowerOutletTemplateRequestFeedLegType3Type1(data)
