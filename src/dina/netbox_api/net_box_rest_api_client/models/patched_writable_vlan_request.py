...
from ..models.patched_writable_vlan_request_q_in_q_role import PatchedWritableVLANRequestQInQRole
from ..models.patched_writable_vlan_request_status import PatchedWritableVLANRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_vlan_request_custom_fields import PatchedWritableVLANRequestCustomFields


T = TypeVar("T", bound="PatchedWritableVLANRequest")
...
class PatchedWritableVLANRequest:
    ...
    Attributes:
        ...
        vid (Union[Unset, int]): Numeric VLAN ID (1-4094)
        name (Union[Unset, str]):
        tenant (Union['BriefTenantRequest', None, Unset, int]):
        status (Union[Unset, PatchedWritableVLANRequestStatus]): Operational status of this VLAN
        ...
        qinq_role (Union[None, PatchedWritableVLANRequestQInQRole, Unset]): Customer/service VLAN designation (for
            Q-in-Q/IEEE 802.1ad)
        ...
        custom_fields (Union[Unset, PatchedWritableVLANRequestCustomFields]):
    """
    ...
    status: Union[Unset, PatchedWritableVLANRequestStatus] = UNSET
    role: Union["BriefRoleRequest", None, Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    qinq_role: Union[None, PatchedWritableVLANRequestQInQRole, Unset] = UNSET
    qinq_svlan: Union[None, Unset, int] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "PatchedWritableVLANRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.qinq_role, Unset):
            qinq_role = UNSET
        elif isinstance(self.qinq_role, PatchedWritableVLANRequestQInQRole):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        vid = self.vid if isinstance(self.vid, Unset) else (None, str(self.vid).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PatchedWritableVLANRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritableVLANRequestStatus(_status)
        ...
        def _parse_qinq_role(data: object) -> Union[None, PatchedWritableVLANRequestQInQRole, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                qinq_role_type_1 = PatchedWritableVLANRequestQInQRole(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                qinq_role_type_2_type_1 = PatchedWritableVLANRequestQInQRole(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                qinq_role_type_3_type_1 = PatchedWritableVLANRequestQInQRole(data)

                return qinq_role_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PatchedWritableVLANRequestQInQRole, Unset], data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVLANRequestCustomFields.from_dict(_custom_fields)

        patched_writable_vlan_request = cls(
            site=site,
            group=group,
            vid=vid,
            name=name,
        ...
        patched_writable_vlan_request.additional_properties = d
        return patched_writable_vlan_request
