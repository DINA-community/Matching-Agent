...
T = TypeVar("T", bound="PaginatedL2VPNTerminationList")
...
class PaginatedL2VPNTerminationList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = L2VPNTermination.from_dict(results_item_data)
        ...
        paginated_l2vpn_termination_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_l2vpn_termination_list.additional_properties = d
        return paginated_l2vpn_termination_list
