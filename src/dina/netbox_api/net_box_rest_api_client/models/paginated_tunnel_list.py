...
T = TypeVar("T", bound="PaginatedTunnelList")
...
class PaginatedTunnelList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Tunnel.from_dict(results_item_data)
        ...
        paginated_tunnel_list.additional_properties = d
        return paginated_tunnel_list
