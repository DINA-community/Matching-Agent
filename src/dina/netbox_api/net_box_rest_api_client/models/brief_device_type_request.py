...
T = TypeVar("T", bound="BriefDeviceTypeRequest")
...
class BriefDeviceTypeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        brief_device_type_request.additional_properties = d
        return brief_device_type_request
