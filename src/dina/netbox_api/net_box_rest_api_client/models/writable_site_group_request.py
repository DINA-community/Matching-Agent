...
if TYPE_CHECKING:
    ...
    from ..models.writable_site_group_request_custom_fields import WritableSiteGroupRequestCustomFields


T = TypeVar("T", bound="WritableSiteGroupRequest")
...
class WritableSiteGroupRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, WritableSiteGroupRequestCustomFields]):
    ...
    custom_fields: Union[Unset, "WritableSiteGroupRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableSiteGroupRequestCustomFields.from_dict(_custom_fields)

        comments = d.pop("comments", UNSET)

        writable_site_group_request = cls(
            name=name,
            slug=slug,
            parent=parent,
        ...
        writable_site_group_request.additional_properties = d
        return writable_site_group_request
