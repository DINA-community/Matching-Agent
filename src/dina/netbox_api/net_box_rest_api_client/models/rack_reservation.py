...
if TYPE_CHECKING:
    ...
    from ..models.rack_reservation_custom_fields import RackReservationCustomFields


T = TypeVar("T", bound="RackReservation")
...
class RackReservation:
    ...
    Attributes:
        ...
        display_url (str):
        display (str):
        rack (BriefRack): Adds support for custom fields and tags.
        units (list[int]):
        ...
        custom_fields (Union[Unset, RackReservationCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "RackReservationCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rack = BriefRack.from_dict(d.pop("rack"))
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = RackReservationCustomFields.from_dict(_custom_fields)

        rack_reservation = cls(
            id=id,
            url=url,
            display_url=display_url,
            display=display,
        ...
        rack_reservation.additional_properties = d
        return rack_reservation
