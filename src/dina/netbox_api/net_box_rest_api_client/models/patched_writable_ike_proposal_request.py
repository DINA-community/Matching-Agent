...
from ..models.patched_writable_ike_proposal_request_group import PatchedWritableIKEProposalRequestGroup
...
class PatchedWritableIKEProposalRequest:
    ...
    authentication_method: Union[Unset, PatchedWritableIKEProposalRequestAuthenticationMethod] = UNSET
    encryption_algorithm: Union[Unset, PatchedWritableIKEProposalRequestEncryptionAlgorithm] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.authentication_algorithm, PatchedWritableIKEProposalRequestAuthenticationAlgorithmType1):
            authentication_algorithm = self.authentication_algorithm.value
        elif isinstance(
            self.authentication_algorithm, PatchedWritableIKEProposalRequestAuthenticationAlgorithmType2Type1
        ):
            authentication_algorithm = self.authentication_algorithm.value
        elif isinstance(
            self.authentication_algorithm, PatchedWritableIKEProposalRequestAuthenticationAlgorithmType3Type1
        ):
            authentication_algorithm = self.authentication_algorithm.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication_method: Union[Unset, PatchedWritableIKEProposalRequestAuthenticationMethod]
        if isinstance(_authentication_method, Unset):
            authentication_method = UNSET
        else:
            authentication_method = PatchedWritableIKEProposalRequestAuthenticationMethod(_authentication_method)

        _encryption_algorithm = d.pop("encryption_algorithm", UNSET)
        encryption_algorithm: Union[Unset, PatchedWritableIKEProposalRequestEncryptionAlgorithm]
        if isinstance(_encryption_algorithm, Unset):
            encryption_algorithm = UNSET
        else:
            encryption_algorithm = PatchedWritableIKEProposalRequestEncryptionAlgorithm(_encryption_algorithm)
        ...
        def _parse_authentication_algorithm(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                authentication_algorithm_type_1 = PatchedWritableIKEProposalRequestAuthenticationAlgorithmType1(data)
            ...
            try:
                ...
                authentication_algorithm_type_2_type_1 = (
                    PatchedWritableIKEProposalRequestAuthenticationAlgorithmType2Type1(data)
                )
            ...
            try:
                ...
                authentication_algorithm_type_3_type_1 = (
                    PatchedWritableIKEProposalRequestAuthenticationAlgorithmType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIKEProposalRequestCustomFields.from_dict(_custom_fields)
