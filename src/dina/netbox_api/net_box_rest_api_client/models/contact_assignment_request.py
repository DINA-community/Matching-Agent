...
from ..models.contact_assignment_request_priority import ContactAssignmentRequestPriority
...
if TYPE_CHECKING:
    ...
    from ..models.contact_assignment_request_custom_fields import ContactAssignmentRequestCustomFields
...
class ContactAssignmentRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = ContactAssignmentRequestCustomFields.from_dict(_custom_fields)
