...
if TYPE_CHECKING:
    from ..models.rack_unit import RackUnit


T = TypeVar("T", bound="PaginatedRackUnitList")
...
class PaginatedRackUnitList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RackUnit.from_dict(results_item_data)
        ...
        paginated_rack_unit_list.additional_properties = d
        return paginated_rack_unit_list
