...
from ..models.patched_writable_power_port_request_type_type_1 import PatchedWritablePowerPortRequestTypeType1
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_power_port_request_custom_fields import PatchedWritablePowerPortRequestCustomFields
...
class PatchedWritablePowerPortRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritablePowerPortRequestCustomFields.from_dict(_custom_fields)
