...
from ..models.writable_tunnel_request_encapsulation import WritableTunnelRequestEncapsulation
from ..models.writable_tunnel_request_status import WritableTunnelRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.writable_tunnel_request_custom_fields import WritableTunnelRequestCustomFields


T = TypeVar("T", bound="WritableTunnelRequest")
...
class WritableTunnelRequest:
    ...
    Attributes:
        name (str):
        encapsulation (WritableTunnelRequestEncapsulation): * `ipsec-transport` - IPsec - Transport
            ...
            * `l2tp` - L2TP
            * `pptp` - PPTP
        status (Union[Unset, WritableTunnelRequestStatus]): * `planned` - Planned
            * `active` - Active
            * `disabled` - Disabled
        ...
        custom_fields (Union[Unset, WritableTunnelRequestCustomFields]):
    """

    name: str
    encapsulation: WritableTunnelRequestEncapsulation
    status: Union[Unset, WritableTunnelRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritableTunnelRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.ipsec_profile, Unset):
            ...
            ipsec_profile = (None, json.dumps(self.ipsec_profile.to_dict()).encode(), "application/json")
        else:
            ipsec_profile = (None, str(self.ipsec_profile).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encapsulation = WritableTunnelRequestEncapsulation(d.pop("encapsulation"))

        _status = d.pop("status", UNSET)
        status: Union[Unset, WritableTunnelRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableTunnelRequestStatus(_status)

        def _parse_group(data: object) -> Union["BriefTunnelGroupRequest", None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_ipsec_profile(data: object) -> Union["BriefIPSecProfileRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableTunnelRequestCustomFields.from_dict(_custom_fields)

        writable_tunnel_request = cls(
            name=name,
            encapsulation=encapsulation,
            status=status,
            group=group,
        ...
        writable_tunnel_request.additional_properties = d
        return writable_tunnel_request
