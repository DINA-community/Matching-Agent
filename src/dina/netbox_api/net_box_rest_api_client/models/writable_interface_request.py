...
from ..models.writable_interface_request_duplex_type_1 import WritableInterfaceRequestDuplexType1
from ..models.writable_interface_request_duplex_type_2_type_1 import WritableInterfaceRequestDuplexType2Type1
from ..models.writable_interface_request_duplex_type_3_type_1 import WritableInterfaceRequestDuplexType3Type1
from ..models.writable_interface_request_mode_type_1 import WritableInterfaceRequestModeType1
from ..models.writable_interface_request_mode_type_2_type_1 import WritableInterfaceRequestModeType2Type1
from ..models.writable_interface_request_mode_type_3_type_1 import WritableInterfaceRequestModeType3Type1
from ..models.writable_interface_request_poe_mode_type_1 import WritableInterfaceRequestPoeModeType1
from ..models.writable_interface_request_poe_mode_type_2_type_1 import WritableInterfaceRequestPoeModeType2Type1
from ..models.writable_interface_request_poe_mode_type_3_type_1 import WritableInterfaceRequestPoeModeType3Type1
from ..models.writable_interface_request_poe_type_type_1 import WritableInterfaceRequestPoeTypeType1
from ..models.writable_interface_request_poe_type_type_2_type_1 import WritableInterfaceRequestPoeTypeType2Type1
from ..models.writable_interface_request_poe_type_type_3_type_1 import WritableInterfaceRequestPoeTypeType3Type1
from ..models.writable_interface_request_type import WritableInterfaceRequestType
from ..models.writable_interface_request_wireless_channel import WritableInterfaceRequestWirelessChannel
from ..models.writable_interface_request_wireless_role import WritableInterfaceRequestWirelessRole
...
if TYPE_CHECKING:
    ...
    from ..models.writable_interface_request_custom_fields import WritableInterfaceRequestCustomFields
...
class WritableInterfaceRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_rf_role(data: object) -> Union[None, Unset, WritableInterfaceRequestWirelessRole]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_rf_channel(data: object) -> Union[None, Unset, WritableInterfaceRequestWirelessChannel]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, WritableInterfaceRequestWirelessChannel], data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableInterfaceRequestCustomFields.from_dict(_custom_fields)
