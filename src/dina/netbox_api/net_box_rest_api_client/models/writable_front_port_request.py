...
if TYPE_CHECKING:
    ...
    from ..models.writable_front_port_request_custom_fields import WritableFrontPortRequestCustomFields
...
class WritableFrontPortRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableFrontPortRequestCustomFields.from_dict(_custom_fields)
