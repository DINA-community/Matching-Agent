...
if TYPE_CHECKING:
    ...
    from ..models.patched_circuit_group_request_custom_fields import PatchedCircuitGroupRequestCustomFields
...
class PatchedCircuitGroupRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedCircuitGroupRequestCustomFields.from_dict(_custom_fields)
