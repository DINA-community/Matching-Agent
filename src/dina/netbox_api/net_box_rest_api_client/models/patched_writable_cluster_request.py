...
from ..models.patched_writable_cluster_request_status import PatchedWritableClusterRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_cluster_request_custom_fields import PatchedWritableClusterRequestCustomFields
...
class PatchedWritableClusterRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableClusterRequestCustomFields.from_dict(_custom_fields)
