...
from ..models.writable_module_type_request_airflow_type_1 import WritableModuleTypeRequestAirflowType1
from ..models.writable_module_type_request_airflow_type_2_type_1 import WritableModuleTypeRequestAirflowType2Type1
from ..models.writable_module_type_request_airflow_type_3_type_1 import WritableModuleTypeRequestAirflowType3Type1
from ..models.writable_module_type_request_weight_unit_type_1 import WritableModuleTypeRequestWeightUnitType1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_module_type_request_custom_fields import WritableModuleTypeRequestCustomFields
...
class WritableModuleTypeRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.weight_unit, WritableModuleTypeRequestWeightUnitType2Type1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, WritableModuleTypeRequestWeightUnitType3Type1):
            weight_unit = self.weight_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = WritableModuleTypeRequestWeightUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = WritableModuleTypeRequestWeightUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableModuleTypeRequestCustomFields.from_dict(_custom_fields)
