...
from ..models.writable_console_port_template_request_type_type_1 import WritableConsolePortTemplateRequestTypeType1
from ..models.writable_console_port_template_request_type_type_2_type_1 import (
    WritableConsolePortTemplateRequestTypeType2Type1,
)
from ..models.writable_console_port_template_request_type_type_3_type_1 import (
...
T = TypeVar("T", bound="WritableConsolePortTemplateRequest")
...
class WritableConsolePortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[None, Unset, WritableConsolePortTemplateRequestTypeType1,
                WritableConsolePortTemplateRequestTypeType2Type1, WritableConsolePortTemplateRequestTypeType3Type1]): * `de-9` -
                DE-9
                * `db-25` - DB-25
                * `rj-11` - RJ-11
                * `rj-12` - RJ-12
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, WritableConsolePortTemplateRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritableConsolePortTemplateRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritableConsolePortTemplateRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = WritableConsolePortTemplateRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritableConsolePortTemplateRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritableConsolePortTemplateRequestTypeType3Type1(data)
        ...
        writable_console_port_template_request = cls(
            name=name,
        ...
        writable_console_port_template_request.additional_properties = d
        return writable_console_port_template_request
