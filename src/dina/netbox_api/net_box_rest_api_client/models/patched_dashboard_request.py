...
T = TypeVar("T", bound="PatchedDashboardRequest")
...
class PatchedDashboardRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        layout = self.layout if isinstance(self.layout, Unset) else (None, str(self.layout).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_dashboard_request = cls(
            layout=layout,
            config=config,
        )

        patched_dashboard_request.additional_properties = d
        return patched_dashboard_request
