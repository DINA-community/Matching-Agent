...
from ..models.power_port_request_type_type_1 import PowerPortRequestTypeType1
from ..models.power_port_request_type_type_2_type_1 import PowerPortRequestTypeType2Type1
from ..models.power_port_request_type_type_3_type_1 import PowerPortRequestTypeType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.power_port_request_custom_fields import PowerPortRequestCustomFields


T = TypeVar("T", bound="PowerPortRequest")
...
class PowerPortRequest:
    ...
    Attributes:
        ...
        type_ (Union[None, PowerPortRequestTypeType1, PowerPortRequestTypeType2Type1, PowerPortRequestTypeType3Type1,
        ...
        custom_fields (Union[Unset, PowerPortRequestCustomFields]):
    """
    ...
    type_: Union[
        None, PowerPortRequestTypeType1, PowerPortRequestTypeType2Type1, PowerPortRequestTypeType3Type1, Unset
    ] = UNSET
    ...
    custom_fields: Union[Unset, "PowerPortRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, PowerPortRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, PowerPortRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, PowerPortRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = PowerPortRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = PowerPortRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = PowerPortRequestTypeType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PowerPortRequestCustomFields.from_dict(_custom_fields)

        power_port_request = cls(
            device=device,
            name=name,
            module=module,
            label=label,
        ...
        power_port_request.additional_properties = d
        return power_port_request
