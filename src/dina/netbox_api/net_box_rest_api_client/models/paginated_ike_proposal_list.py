...
T = TypeVar("T", bound="PaginatedIKEProposalList")
...
class PaginatedIKEProposalList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IKEProposal.from_dict(results_item_data)
        ...
        paginated_ike_proposal_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ike_proposal_list.additional_properties = d
        return paginated_ike_proposal_list
