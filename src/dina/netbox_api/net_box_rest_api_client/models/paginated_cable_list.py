...
T = TypeVar("T", bound="PaginatedCableList")
...
class PaginatedCableList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Cable.from_dict(results_item_data)
        ...
        paginated_cable_list.additional_properties = d
        return paginated_cable_list
