...
from ..models.virtual_circuit_termination_request_role import VirtualCircuitTerminationRequestRole
...
if TYPE_CHECKING:
    ...
    from ..models.virtual_circuit_termination_request_custom_fields import VirtualCircuitTerminationRequestCustomFields


T = TypeVar("T", bound="VirtualCircuitTerminationRequest")
...
class VirtualCircuitTerminationRequest:
    ...
    Attributes:
        ...
        role (Union[Unset, VirtualCircuitTerminationRequestRole]): * `peer` - Peer
            * `hub` - Hub
            * `spoke` - Spoke
        description (Union[Unset, str]):
        tags (Union[Unset, list['NestedTagRequest']]):
        custom_fields (Union[Unset, VirtualCircuitTerminationRequestCustomFields]):
    """

    virtual_circuit: Union["BriefVirtualCircuitRequest", int]
    interface: Union["BriefInterfaceRequest", int]
    role: Union[Unset, VirtualCircuitTerminationRequestRole] = UNSET
    description: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "VirtualCircuitTerminationRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_virtual_circuit_request import BriefVirtualCircuitRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.virtual_circuit_termination_request_custom_fields import (
        ...
        role: Union[Unset, VirtualCircuitTerminationRequestRole]
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = VirtualCircuitTerminationRequestRole(_role)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VirtualCircuitTerminationRequestCustomFields.from_dict(_custom_fields)

        virtual_circuit_termination_request = cls(
            virtual_circuit=virtual_circuit,
            interface=interface,
            role=role,
        ...
        virtual_circuit_termination_request.additional_properties = d
        return virtual_circuit_termination_request
