...
from ..models.data_source_request_sync_interval_type_1 import DataSourceRequestSyncIntervalType1
from ..models.data_source_request_sync_interval_type_2_type_1 import DataSourceRequestSyncIntervalType2Type1
from ..models.data_source_request_sync_interval_type_3_type_1 import DataSourceRequestSyncIntervalType3Type1
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_sync_interval(
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                sync_interval_type_2_type_1 = DataSourceRequestSyncIntervalType2Type1(data)
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                sync_interval_type_3_type_1 = DataSourceRequestSyncIntervalType3Type1(data)
