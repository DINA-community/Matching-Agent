...
from ..models.patched_writable_location_request_status import PatchedWritableLocationRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_location_request_custom_fields import PatchedWritableLocationRequestCustomFields


T = TypeVar("T", bound="PatchedWritableLocationRequest")
...
class PatchedWritableLocationRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, PatchedWritableLocationRequestStatus]): * `planned` - Planned
            * `staging` - Staging
            * `active` - Active
        ...
        custom_fields (Union[Unset, PatchedWritableLocationRequestCustomFields]):
    ...
    status: Union[Unset, PatchedWritableLocationRequestStatus] = UNSET
    tenant: Union["BriefTenantRequest", None, Unset, int] = UNSET
    facility: Union[Unset, str] = UNSET
    description: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "PatchedWritableLocationRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PatchedWritableLocationRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritableLocationRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableLocationRequestCustomFields.from_dict(_custom_fields)

        comments = d.pop("comments", UNSET)

        patched_writable_location_request = cls(
            name=name,
            slug=slug,
            site=site,
            parent=parent,
        ...
        patched_writable_location_request.additional_properties = d
        return patched_writable_location_request
