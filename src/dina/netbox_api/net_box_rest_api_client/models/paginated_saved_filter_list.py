...
T = TypeVar("T", bound="PaginatedSavedFilterList")
...
class PaginatedSavedFilterList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SavedFilter.from_dict(results_item_data)
        ...
        paginated_saved_filter_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_saved_filter_list.additional_properties = d
        return paginated_saved_filter_list
