...
from ..models.patched_writable_ip_address_request_role_type_1 import PatchedWritableIPAddressRequestRoleType1
from ..models.patched_writable_ip_address_request_role_type_2_type_1 import (
    PatchedWritableIPAddressRequestRoleType2Type1,
)
from ..models.patched_writable_ip_address_request_role_type_3_type_1 import (
    PatchedWritableIPAddressRequestRoleType3Type1,
)
from ..models.patched_writable_ip_address_request_status import PatchedWritableIPAddressRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_ip_address_request_custom_fields import PatchedWritableIPAddressRequestCustomFields
...
class PatchedWritableIPAddressRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, PatchedWritableIPAddressRequestStatus]): The operational status of this IP
            ...
            * `dhcp` - DHCP
            * `slaac` - SLAAC
        role (Union[None, PatchedWritableIPAddressRequestRoleType1, PatchedWritableIPAddressRequestRoleType2Type1,
            PatchedWritableIPAddressRequestRoleType3Type1, Unset]): The functional role of this IP
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.role, Unset):
            role = UNSET
        elif isinstance(self.role, PatchedWritableIPAddressRequestRoleType1):
            role = self.role.value
        elif isinstance(self.role, PatchedWritableIPAddressRequestRoleType2Type1):
            role = self.role.value
        elif isinstance(self.role, PatchedWritableIPAddressRequestRoleType3Type1):
            role = self.role.value
        else:
            role = self.role
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        dns_name = (
            self.dns_name if isinstance(self.dns_name, Unset) else (None, str(self.dns_name).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_role(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_1 = PatchedWritableIPAddressRequestRoleType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_2_type_1 = PatchedWritableIPAddressRequestRoleType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                role_type_3_type_1 = PatchedWritableIPAddressRequestRoleType3Type1(data)
        ...
        assigned_object_type = _parse_assigned_object_type(d.pop("assigned_object_type", UNSET))
        ...
        assigned_object_id = _parse_assigned_object_id(d.pop("assigned_object_id", UNSET))
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIPAddressRequestCustomFields.from_dict(_custom_fields)
