...
T = TypeVar("T", bound="PaginatedProductRelationshipList")


@_attrs_define
class PaginatedProductRelationshipList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['ProductRelationship']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductRelationship.from_dict(results_item_data)
        ...
        paginated_product_relationship_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_product_relationship_list.additional_properties = d
        return paginated_product_relationship_list
