...
T = TypeVar("T", bound="PaginatedServiceList")
...
class PaginatedServiceList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Service.from_dict(results_item_data)
        ...
        paginated_service_list.additional_properties = d
        return paginated_service_list
