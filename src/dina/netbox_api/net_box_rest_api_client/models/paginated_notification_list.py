...
T = TypeVar("T", bound="PaginatedNotificationList")
...
class PaginatedNotificationList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_notification_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_notification_list.additional_properties = d
        return paginated_notification_list
