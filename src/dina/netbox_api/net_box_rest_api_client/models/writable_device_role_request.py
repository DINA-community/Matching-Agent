...
if TYPE_CHECKING:
    ...
    from ..models.writable_device_role_request_custom_fields import WritableDeviceRoleRequestCustomFields
...
class WritableDeviceRoleRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableDeviceRoleRequestCustomFields.from_dict(_custom_fields)
