...
T = TypeVar("T", bound="PaginatedCircuitGroupList")
...
class PaginatedCircuitGroupList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CircuitGroup.from_dict(results_item_data)
        ...
        paginated_circuit_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_circuit_group_list.additional_properties = d
        return paginated_circuit_group_list
