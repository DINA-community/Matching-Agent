...
if TYPE_CHECKING:
    ...
    from ..models.patched_device_bay_request_custom_fields import PatchedDeviceBayRequestCustomFields
...
class PatchedDeviceBayRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedDeviceBayRequestCustomFields.from_dict(_custom_fields)
