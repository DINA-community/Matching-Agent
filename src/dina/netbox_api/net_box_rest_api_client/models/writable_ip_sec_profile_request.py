...
from ..models.writable_ip_sec_profile_request_mode import WritableIPSecProfileRequestMode
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ip_sec_profile_request_custom_fields import WritableIPSecProfileRequestCustomFields
...
class WritableIPSecProfileRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIPSecProfileRequestCustomFields.from_dict(_custom_fields)
