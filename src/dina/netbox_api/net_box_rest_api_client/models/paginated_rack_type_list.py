...
T = TypeVar("T", bound="PaginatedRackTypeList")
...
class PaginatedRackTypeList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RackType.from_dict(results_item_data)
        ...
        paginated_rack_type_list.additional_properties = d
        return paginated_rack_type_list
