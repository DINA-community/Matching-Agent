...
T = TypeVar("T", bound="PatchedDeviceFindingRequest")


@_attrs_define
class PatchedDeviceFindingRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        confidence: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.confidence, Unset):
            confidence = UNSET
        elif isinstance(self.confidence, float):
            confidence = (None, str(self.confidence).encode(), "text/plain")
        else:
            confidence = (None, str(self.confidence).encode(), "text/plain")
        ...
        device_role: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.device_role, Unset):
            device_role = UNSET
        elif isinstance(self.device_role, str):
            device_role = (None, str(self.device_role).encode(), "text/plain")
        else:
            device_role = (None, str(self.device_role).encode(), "text/plain")

        serial_number: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.serial_number, Unset):
            serial_number = UNSET
        elif isinstance(self.serial_number, str):
            serial_number = (None, str(self.serial_number).encode(), "text/plain")
        else:
            serial_number = (None, str(self.serial_number).encode(), "text/plain")

        device_name: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.device_name, Unset):
            device_name = UNSET
        elif isinstance(self.device_name, str):
            device_name = (None, str(self.device_name).encode(), "text/plain")
        else:
            device_name = (None, str(self.device_name).encode(), "text/plain")
        ...
        if isinstance(self.device_type, Unset):
            device_type = UNSET
        elif isinstance(self.device_type, str):
            device_type = (None, str(self.device_type).encode(), "text/plain")
        else:
            device_type = (None, str(self.device_type).encode(), "text/plain")

        is_safety_critical: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.is_safety_critical, Unset):
            is_safety_critical = UNSET
        elif isinstance(self.is_safety_critical, str):
            is_safety_critical = (None, str(self.is_safety_critical).encode(), "text/plain")
        else:
            is_safety_critical = (None, str(self.is_safety_critical).encode(), "text/plain")
        ...
        if isinstance(self.transport_protocol, Unset):
            ...
            transport_protocol = (None, str(self.transport_protocol).encode(), "text/plain")
        else:
            transport_protocol = (None, str(self.transport_protocol).encode(), "text/plain")
        ...
        if isinstance(self.application_protocol, Unset):
            ...
            application_protocol = (None, str(self.application_protocol).encode(), "text/plain")
        else:
            application_protocol = (None, str(self.application_protocol).encode(), "text/plain")

        port: Union[Unset, tuple[None, bytes, str]]
        ...
        is_router: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.is_router, Unset):
            is_router = UNSET
        elif isinstance(self.is_router, str):
            is_router = (None, str(self.is_router).encode(), "text/plain")
        else:
            is_router = (None, str(self.is_router).encode(), "text/plain")
        ...
        if isinstance(self.manufacturer, Unset):
            manufacturer = UNSET
        elif isinstance(self.manufacturer, str):
            manufacturer = (None, str(self.manufacturer).encode(), "text/plain")
        else:
            manufacturer = (None, str(self.manufacturer).encode(), "text/plain")

        oui: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.oui, Unset):
            oui = UNSET
        elif isinstance(self.oui, str):
            oui = (None, str(self.oui).encode(), "text/plain")
        else:
            oui = (None, str(self.oui).encode(), "text/plain")

        device_family: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.device_family, Unset):
            device_family = UNSET
        elif isinstance(self.device_family, str):
            device_family = (None, str(self.device_family).encode(), "text/plain")
        else:
            device_family = (None, str(self.device_family).encode(), "text/plain")

        part_number: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.part_number, Unset):
            part_number = UNSET
        elif isinstance(self.part_number, str):
            part_number = (None, str(self.part_number).encode(), "text/plain")
        else:
            part_number = (None, str(self.part_number).encode(), "text/plain")

        hardware_version: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.hardware_version, Unset):
            hardware_version = UNSET
        elif isinstance(self.hardware_version, str):
            hardware_version = (None, str(self.hardware_version).encode(), "text/plain")
        else:
            hardware_version = (None, str(self.hardware_version).encode(), "text/plain")

        hardware_cpe: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.hardware_cpe, Unset):
            hardware_cpe = UNSET
        elif isinstance(self.hardware_cpe, str):
            hardware_cpe = (None, str(self.hardware_cpe).encode(), "text/plain")
        else:
            hardware_cpe = (None, str(self.hardware_cpe).encode(), "text/plain")

        software_name: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.software_name, Unset):
            software_name = UNSET
        elif isinstance(self.software_name, str):
            software_name = (None, str(self.software_name).encode(), "text/plain")
        else:
            software_name = (None, str(self.software_name).encode(), "text/plain")
        ...
        if isinstance(self.is_firmware, Unset):
            is_firmware = UNSET
        elif isinstance(self.is_firmware, str):
        ...
        exposure: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.exposure, Unset):
            exposure = UNSET
        elif isinstance(self.exposure, str):
            exposure = (None, str(self.exposure).encode(), "text/plain")
        else:
            exposure = (None, str(self.exposure).encode(), "text/plain")

        has_predicted_device = (
            self.has_predicted_device
            if isinstance(self.has_predicted_device, Unset)
            else (None, str(self.has_predicted_device).encode(), "text/plain")
        )

        predicted_device: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.predicted_device, Unset):
            predicted_device = UNSET
        elif isinstance(self.predicted_device, int):
            predicted_device = (None, str(self.predicted_device).encode(), "text/plain")
        else:
            predicted_device = (None, str(self.predicted_device).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_device_finding_request = cls(
            device=device,
            source=source,
        ...
        patched_device_finding_request.additional_properties = d
        return patched_device_finding_request
