...
if TYPE_CHECKING:
    ...
    from ..models.writable_aggregate_request_custom_fields import WritableAggregateRequestCustomFields


T = TypeVar("T", bound="WritableAggregateRequest")
...
class WritableAggregateRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, WritableAggregateRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "WritableAggregateRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableAggregateRequestCustomFields.from_dict(_custom_fields)

        writable_aggregate_request = cls(
            prefix=prefix,
            rir=rir,
            tenant=tenant,
        ...
        writable_aggregate_request.additional_properties = d
        return writable_aggregate_request
