...
class DeviceType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_platform(data: object) -> Union["BriefPlatform", None, Unset]:
            if data is None:
                return data
        ...
        def _parse_subdevice_role(data: object) -> Union["DeviceTypeSubdeviceRoleType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_airflow(data: object) -> Union["DeviceTypeAirflowType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_weight_unit(data: object) -> Union["DeviceTypeWeightUnitType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
