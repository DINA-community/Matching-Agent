...
from ..models.writable_power_port_template_request_type_type_1 import WritablePowerPortTemplateRequestTypeType1
from ..models.writable_power_port_template_request_type_type_2_type_1 import (
    WritablePowerPortTemplateRequestTypeType2Type1,
)
from ..models.writable_power_port_template_request_type_type_3_type_1 import (
...
T = TypeVar("T", bound="WritablePowerPortTemplateRequest")
...
class WritablePowerPortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[None, Unset, WritablePowerPortTemplateRequestTypeType1,
                WritablePowerPortTemplateRequestTypeType2Type1, WritablePowerPortTemplateRequestTypeType3Type1]): *
                `iec-60320-c6` - C6
                * `iec-60320-c8` - C8
                * `iec-60320-c14` - C14
                * `iec-60320-c16` - C16
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, WritablePowerPortTemplateRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritablePowerPortTemplateRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritablePowerPortTemplateRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = WritablePowerPortTemplateRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritablePowerPortTemplateRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritablePowerPortTemplateRequestTypeType3Type1(data)
        ...
        writable_power_port_template_request = cls(
            name=name,
        ...
        writable_power_port_template_request.additional_properties = d
        return writable_power_port_template_request
