...
T = TypeVar("T", bound="PaginatedIPSecPolicyList")
...
class PaginatedIPSecPolicyList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IPSecPolicy.from_dict(results_item_data)
        ...
        paginated_ip_sec_policy_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ip_sec_policy_list.additional_properties = d
        return paginated_ip_sec_policy_list
