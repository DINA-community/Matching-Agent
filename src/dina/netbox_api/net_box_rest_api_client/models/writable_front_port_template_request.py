...
from ..models.writable_front_port_template_request_type import WritableFrontPortTemplateRequestType
...
T = TypeVar("T", bound="WritableFrontPortTemplateRequest")
...
class WritableFrontPortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (WritableFrontPortTemplateRequestType): * `8p8c` - 8P8C
                * `8p6c` - 8P6C
                * `8p4c` - 8P4C
                * `8p2c` - 8P2C
                * `6p6c` - 6P6C
                ...
                * `other` - Other
            rear_port (Union['BriefRearPortTemplateRequest', int]):
    ...
    name: str
    type_: WritableFrontPortTemplateRequestType
    rear_port: Union["BriefRearPortTemplateRequest", int]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        rear_port: Union[dict[str, Any], int]
        if isinstance(self.rear_port, BriefRearPortTemplateRequest):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        rear_port: tuple[None, bytes, str]

        if isinstance(self.rear_port, int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = WritableFrontPortTemplateRequestType(d.pop("type"))

        def _parse_rear_port(data: object) -> Union["BriefRearPortTemplateRequest", int]:
            try:
                ...
                pass
            return cast(Union["BriefRearPortTemplateRequest", int], data)

        rear_port = _parse_rear_port(d.pop("rear_port"))
        ...
        writable_front_port_template_request = cls(
            name=name,
            type_=type_,
            rear_port=rear_port,
        ...
        writable_front_port_template_request.additional_properties = d
        return writable_front_port_template_request
