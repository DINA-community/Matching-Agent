...
from ..models.writable_l2vpn_request_status import WritableL2VPNRequestStatus
from ..models.writable_l2vpn_request_type import WritableL2VPNRequestType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.brief_tenant_request import BriefTenantRequest
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.writable_l2vpn_request_custom_fields import WritableL2VPNRequestCustomFields


T = TypeVar("T", bound="WritableL2VPNRequest")
...
class WritableL2VPNRequest:
    ...
    Attributes:
        name (str):
        slug (str):
        type_ (WritableL2VPNRequestType): * `vpws` - VPWS
            * `vpls` - VPLS
            * `vxlan` - VXLAN
        ...
        status (Union[Unset, WritableL2VPNRequestStatus]): * `active` - Active
            * `planned` - Planned
        ...
        custom_fields (Union[Unset, WritableL2VPNRequestCustomFields]):
    """

    name: str
    slug: str
    type_: WritableL2VPNRequestType
    identifier: Union[None, Unset, int] = UNSET
    status: Union[Unset, WritableL2VPNRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritableL2VPNRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = WritableL2VPNRequestType(d.pop("type"))
        ...
        status: Union[Unset, WritableL2VPNRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableL2VPNRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableL2VPNRequestCustomFields.from_dict(_custom_fields)

        writable_l2vpn_request = cls(
            name=name,
            slug=slug,
            type_=type_,
        ...
        writable_l2vpn_request.additional_properties = d
        return writable_l2vpn_request
