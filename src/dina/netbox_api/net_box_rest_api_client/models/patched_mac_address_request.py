...
if TYPE_CHECKING:
    ...
    from ..models.patched_mac_address_request_custom_fields import PatchedMACAddressRequestCustomFields


T = TypeVar("T", bound="PatchedMACAddressRequest")
...
class PatchedMACAddressRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PatchedMACAddressRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PatchedMACAddressRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedMACAddressRequestCustomFields.from_dict(_custom_fields)

        patched_mac_address_request = cls(
        ...
        patched_mac_address_request.additional_properties = d
        return patched_mac_address_request
