...
T = TypeVar("T", bound="PaginatedTaggedItemList")
...
class PaginatedTaggedItemList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TaggedItem.from_dict(results_item_data)
        ...
        paginated_tagged_item_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_tagged_item_list.additional_properties = d
        return paginated_tagged_item_list
