...
T = TypeVar("T", bound="PaginatedConsolePortList")
...
class PaginatedConsolePortList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ConsolePort.from_dict(results_item_data)
        ...
        paginated_console_port_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_console_port_list.additional_properties = d
        return paginated_console_port_list
