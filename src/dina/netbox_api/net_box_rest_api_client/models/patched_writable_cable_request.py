...
from ..models.patched_writable_cable_request_length_unit_type_1 import PatchedWritableCableRequestLengthUnitType1
...
from ..models.patched_writable_cable_request_status import PatchedWritableCableRequestStatus
from ..models.patched_writable_cable_request_type_type_1 import PatchedWritableCableRequestTypeType1
from ..models.patched_writable_cable_request_type_type_2_type_1 import PatchedWritableCableRequestTypeType2Type1
from ..models.patched_writable_cable_request_type_type_3_type_1 import PatchedWritableCableRequestTypeType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_cable_request_custom_fields import PatchedWritableCableRequestCustomFields
...
class PatchedWritableCableRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.length_unit, PatchedWritableCableRequestLengthUnitType2Type1):
            length_unit = self.length_unit.value
        elif isinstance(self.length_unit, PatchedWritableCableRequestLengthUnitType3Type1):
            length_unit = self.length_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_length_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_2_type_1 = PatchedWritableCableRequestLengthUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_3_type_1 = PatchedWritableCableRequestLengthUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableCableRequestCustomFields.from_dict(_custom_fields)
