...
from ..models.interface_template_type_label import InterfaceTemplateTypeLabel
from ..models.interface_template_type_value import InterfaceTemplateTypeValue
from ..types import UNSET, Unset

T = TypeVar("T", bound="InterfaceTemplateType")
...
class InterfaceTemplateType:
    """
    Attributes:
        value (Union[Unset, InterfaceTemplateTypeValue]): * `virtual` - Virtual
            * `bridge` - Bridge
            ...
            * `other` - Other
        label (Union[Unset, InterfaceTemplateTypeLabel]):
    """

    value: Union[Unset, InterfaceTemplateTypeValue] = UNSET
    label: Union[Unset, InterfaceTemplateTypeLabel] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: Union[Unset, InterfaceTemplateTypeValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = InterfaceTemplateTypeValue(_value)
        ...
        if isinstance(_label, Unset):
            ...
            label = InterfaceTemplateTypeLabel(_label)

        interface_template_type = cls(
            value=value,
            label=label,
        )

        interface_template_type.additional_properties = d
        return interface_template_type
