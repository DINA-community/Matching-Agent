...
if TYPE_CHECKING:
    ...
    from ..models.interface_template_poe_mode_type_0 import InterfaceTemplatePoeModeType0
    from ..models.interface_template_poe_type_type_0 import InterfaceTemplatePoeTypeType0
...
class InterfaceTemplate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_bridge(data: object) -> Union["NestedInterfaceTemplate", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_poe_mode(data: object) -> Union["InterfaceTemplatePoeModeType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_poe_type(data: object) -> Union["InterfaceTemplatePoeTypeType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_rf_role(data: object) -> Union["InterfaceTemplateRfRoleType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
