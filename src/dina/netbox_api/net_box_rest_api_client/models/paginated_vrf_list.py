...
T = TypeVar("T", bound="PaginatedVRFList")
...
class PaginatedVRFList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VRF.from_dict(results_item_data)
        ...
        paginated_vrf_list.additional_properties = d
        return paginated_vrf_list
