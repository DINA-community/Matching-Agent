...
T = TypeVar("T", bound="PaginatedModuleBayList")
...
class PaginatedModuleBayList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ModuleBay.from_dict(results_item_data)
        ...
        paginated_module_bay_list.additional_properties = d
        return paginated_module_bay_list
