...
from ..models.patched_webhook_request_http_method import PatchedWebhookRequestHttpMethod
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.patched_webhook_request_custom_fields import PatchedWebhookRequestCustomFields
...
class PatchedWebhookRequest:
    ...
    Attributes:
        ...
        payload_url (Union[Unset, str]): This URL will be called using the HTTP method defined when the webhook is
            called. Jinja2 template processing is supported with the same context as the request body.
        http_method (Union[Unset, PatchedWebhookRequestHttpMethod]): * `GET` - GET
            * `POST` - POST
            * `PUT` - PUT
            * `PATCH` - PATCH
            * `DELETE` - DELETE
        ...
        custom_fields (Union[Unset, PatchedWebhookRequestCustomFields]):
        tags (Union[Unset, list['NestedTagRequest']]):
    """

    name: Union[Unset, str] = UNSET
    description: Union[Unset, str] = UNSET
    payload_url: Union[Unset, str] = UNSET
    http_method: Union[Unset, PatchedWebhookRequestHttpMethod] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedWebhookRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if payload_url is not UNSET:
            field_dict["payload_url"] = payload_url
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        payload_url = (
            self.payload_url
            if isinstance(self.payload_url, Unset)
            else (None, str(self.payload_url).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payload_url = d.pop("payload_url", UNSET)

        _http_method = d.pop("http_method", UNSET)
        http_method: Union[Unset, PatchedWebhookRequestHttpMethod]
        if isinstance(_http_method, Unset):
            http_method = UNSET
        else:
            http_method = PatchedWebhookRequestHttpMethod(_http_method)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWebhookRequestCustomFields.from_dict(_custom_fields)
        ...
        patched_webhook_request.additional_properties = d
        return patched_webhook_request
