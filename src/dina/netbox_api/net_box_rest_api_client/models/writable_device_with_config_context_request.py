...
from ..models.writable_device_with_config_context_request_airflow_type_1 import (
    WritableDeviceWithConfigContextRequestAirflowType1,
)
from ..models.writable_device_with_config_context_request_airflow_type_2_type_1 import (
    WritableDeviceWithConfigContextRequestAirflowType2Type1,
)
from ..models.writable_device_with_config_context_request_airflow_type_3_type_1 import (
...
from ..models.writable_device_with_config_context_request_status import WritableDeviceWithConfigContextRequestStatus
...
class WritableDeviceWithConfigContextRequest:
    ...
    Attributes:
        ...
        face (Union[None, Unset, WritableDeviceWithConfigContextRequestRackFace]): * `front` - Front
            * `rear` - Rear
        ...
        airflow (Union[None, Unset, WritableDeviceWithConfigContextRequestAirflowType1,
            WritableDeviceWithConfigContextRequestAirflowType2Type1,
            WritableDeviceWithConfigContextRequestAirflowType3Type1]): * `front-to-rear` - Front to rear
    ...
    face: Union[None, Unset, WritableDeviceWithConfigContextRequestRackFace] = UNSET
    ...
    custom_fields: Union[Unset, "WritableDeviceWithConfigContextRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.face, Unset):
            face = UNSET
        elif isinstance(self.face, WritableDeviceWithConfigContextRequestRackFace):
        ...
        if isinstance(self.airflow, Unset):
            airflow = UNSET
        elif isinstance(self.airflow, WritableDeviceWithConfigContextRequestAirflowType1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, WritableDeviceWithConfigContextRequestAirflowType2Type1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, WritableDeviceWithConfigContextRequestAirflowType3Type1):
            airflow = self.airflow.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_face(data: object) -> Union[None, Unset, WritableDeviceWithConfigContextRequestRackFace]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_1 = WritableDeviceWithConfigContextRequestRackFace(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_2_type_1 = WritableDeviceWithConfigContextRequestRackFace(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_3_type_1 = WritableDeviceWithConfigContextRequestRackFace(data)

                return face_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, WritableDeviceWithConfigContextRequestRackFace], data)
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_1 = WritableDeviceWithConfigContextRequestAirflowType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_2_type_1 = WritableDeviceWithConfigContextRequestAirflowType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_3_type_1 = WritableDeviceWithConfigContextRequestAirflowType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableDeviceWithConfigContextRequestCustomFields.from_dict(_custom_fields)
