...
T = TypeVar("T", bound="PatchedModuleBayTemplateRequest")
...
class PatchedModuleBayTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_module_bay_template_request = cls(
        ...
        patched_module_bay_template_request.additional_properties = d
        return patched_module_bay_template_request
