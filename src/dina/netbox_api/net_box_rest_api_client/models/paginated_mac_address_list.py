...
T = TypeVar("T", bound="PaginatedMACAddressList")
...
class PaginatedMACAddressList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MACAddress.from_dict(results_item_data)
        ...
        paginated_mac_address_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_mac_address_list.additional_properties = d
        return paginated_mac_address_list
