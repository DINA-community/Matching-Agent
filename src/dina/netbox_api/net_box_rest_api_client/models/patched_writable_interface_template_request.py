...
from ..models.patched_writable_interface_template_request_type import PatchedWritableInterfaceTemplateRequestType
...
class PatchedWritableInterfaceTemplateRequest:
    ...
    rf_role: Union[None, PatchedWritableInterfaceTemplateRequestWirelessRole, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.poe_mode, Unset):
            poe_mode = UNSET
        elif isinstance(self.poe_mode, PatchedWritableInterfaceTemplateRequestPoeModeType1):
            poe_mode = self.poe_mode.value
        elif isinstance(self.poe_mode, PatchedWritableInterfaceTemplateRequestPoeModeType2Type1):
            poe_mode = self.poe_mode.value
        elif isinstance(self.poe_mode, PatchedWritableInterfaceTemplateRequestPoeModeType3Type1):
            poe_mode = self.poe_mode.value
        else:
        ...
        if isinstance(self.poe_type, Unset):
            poe_type = UNSET
        elif isinstance(self.poe_type, PatchedWritableInterfaceTemplateRequestPoeTypeType1):
            poe_type = self.poe_type.value
        elif isinstance(self.poe_type, PatchedWritableInterfaceTemplateRequestPoeTypeType2Type1):
            poe_type = self.poe_type.value
        elif isinstance(self.poe_type, PatchedWritableInterfaceTemplateRequestPoeTypeType3Type1):
            poe_type = self.poe_type.value
        else:
        ...
        if isinstance(self.rf_role, Unset):
            rf_role = UNSET
        elif isinstance(self.rf_role, PatchedWritableInterfaceTemplateRequestWirelessRole):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_poe_mode(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_mode_type_1 = PatchedWritableInterfaceTemplateRequestPoeModeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_mode_type_2_type_1 = PatchedWritableInterfaceTemplateRequestPoeModeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_mode_type_3_type_1 = PatchedWritableInterfaceTemplateRequestPoeModeType3Type1(data)
        ...
        def _parse_poe_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_type_type_1 = PatchedWritableInterfaceTemplateRequestPoeTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_type_type_2_type_1 = PatchedWritableInterfaceTemplateRequestPoeTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_type_type_3_type_1 = PatchedWritableInterfaceTemplateRequestPoeTypeType3Type1(data)
        ...
        def _parse_rf_role(data: object) -> Union[None, PatchedWritableInterfaceTemplateRequestWirelessRole, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_1 = PatchedWritableInterfaceTemplateRequestWirelessRole(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_2_type_1 = PatchedWritableInterfaceTemplateRequestWirelessRole(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_3_type_1 = PatchedWritableInterfaceTemplateRequestWirelessRole(data)

                return rf_role_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PatchedWritableInterfaceTemplateRequestWirelessRole, Unset], data)
