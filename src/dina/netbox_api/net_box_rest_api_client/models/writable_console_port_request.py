...
from ..models.writable_console_port_request_speed_type_1 import WritableConsolePortRequestSpeedType1
from ..models.writable_console_port_request_speed_type_2_type_1 import WritableConsolePortRequestSpeedType2Type1
from ..models.writable_console_port_request_speed_type_3_type_1 import WritableConsolePortRequestSpeedType3Type1
from ..models.writable_console_port_request_type_type_1 import WritableConsolePortRequestTypeType1
from ..models.writable_console_port_request_type_type_2_type_1 import WritableConsolePortRequestTypeType2Type1
from ..models.writable_console_port_request_type_type_3_type_1 import WritableConsolePortRequestTypeType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_console_port_request_custom_fields import WritableConsolePortRequestCustomFields
...
class WritableConsolePortRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableConsolePortRequestCustomFields.from_dict(_custom_fields)
