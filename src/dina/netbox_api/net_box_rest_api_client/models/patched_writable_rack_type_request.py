...
from ..models.patched_writable_rack_type_request_form_factor import PatchedWritableRackTypeRequestFormFactor
from ..models.patched_writable_rack_type_request_outer_unit_type_1 import PatchedWritableRackTypeRequestOuterUnitType1
from ..models.patched_writable_rack_type_request_outer_unit_type_2_type_1 import (
    PatchedWritableRackTypeRequestOuterUnitType2Type1,
)
from ..models.patched_writable_rack_type_request_outer_unit_type_3_type_1 import (
    PatchedWritableRackTypeRequestOuterUnitType3Type1,
)
from ..models.patched_writable_rack_type_request_weight_unit_type_1 import PatchedWritableRackTypeRequestWeightUnitType1
from ..models.patched_writable_rack_type_request_weight_unit_type_2_type_1 import (
    PatchedWritableRackTypeRequestWeightUnitType2Type1,
)
from ..models.patched_writable_rack_type_request_weight_unit_type_3_type_1 import (
    PatchedWritableRackTypeRequestWeightUnitType3Type1,
)
from ..models.patched_writable_rack_type_request_width import PatchedWritableRackTypeRequestWidth
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.brief_manufacturer_request import BriefManufacturerRequest
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.patched_writable_rack_type_request_custom_fields import PatchedWritableRackTypeRequestCustomFields


T = TypeVar("T", bound="PatchedWritableRackTypeRequest")
...
class PatchedWritableRackTypeRequest:
    ...
    Attributes:
        ...
        form_factor (Union[Unset, PatchedWritableRackTypeRequestFormFactor]): * `2-post-frame` - 2-post frame
        ...
        width (Union[Unset, PatchedWritableRackTypeRequestWidth]): Rail-to-rail width
        ...
        outer_unit (Union[None, PatchedWritableRackTypeRequestOuterUnitType1,
            PatchedWritableRackTypeRequestOuterUnitType2Type1, PatchedWritableRackTypeRequestOuterUnitType3Type1, Unset]): *
            `mm` - Millimeters
            * `in` - Inches
        weight (Union[None, Unset, float]):
        max_weight (Union[None, Unset, int]): Maximum load capacity for the rack
        weight_unit (Union[None, PatchedWritableRackTypeRequestWeightUnitType1,
            PatchedWritableRackTypeRequestWeightUnitType2Type1, PatchedWritableRackTypeRequestWeightUnitType3Type1, Unset]):
            * `kg` - Kilograms
            * `g` - Grams
            * `lb` - Pounds
            * `oz` - Ounces
        ...
        custom_fields (Union[Unset, PatchedWritableRackTypeRequestCustomFields]):
    """
    ...
    form_factor: Union[Unset, PatchedWritableRackTypeRequestFormFactor] = UNSET
    width: Union[Unset, PatchedWritableRackTypeRequestWidth] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedWritableRackTypeRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.outer_unit, Unset):
            outer_unit = UNSET
        elif isinstance(self.outer_unit, PatchedWritableRackTypeRequestOuterUnitType1):
            outer_unit = self.outer_unit.value
        elif isinstance(self.outer_unit, PatchedWritableRackTypeRequestOuterUnitType2Type1):
            outer_unit = self.outer_unit.value
        elif isinstance(self.outer_unit, PatchedWritableRackTypeRequestOuterUnitType3Type1):
            outer_unit = self.outer_unit.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            weight_unit = UNSET
        elif isinstance(self.weight_unit, PatchedWritableRackTypeRequestWeightUnitType1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableRackTypeRequestWeightUnitType2Type1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableRackTypeRequestWeightUnitType3Type1):
            weight_unit = self.weight_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        form_factor: Union[Unset, tuple[None, bytes, str]] = UNSET
        if not isinstance(self.form_factor, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_manufacturer(data: object) -> Union["BriefManufacturerRequest", Unset, int]:
        ...
        form_factor: Union[Unset, PatchedWritableRackTypeRequestFormFactor]
        if isinstance(_form_factor, Unset):
            form_factor = UNSET
        else:
            form_factor = PatchedWritableRackTypeRequestFormFactor(_form_factor)

        _width = d.pop("width", UNSET)
        width: Union[Unset, PatchedWritableRackTypeRequestWidth]
        if isinstance(_width, Unset):
            width = UNSET
        else:
            width = PatchedWritableRackTypeRequestWidth(_width)
        ...
        def _parse_outer_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_1 = PatchedWritableRackTypeRequestOuterUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_2_type_1 = PatchedWritableRackTypeRequestOuterUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_3_type_1 = PatchedWritableRackTypeRequestOuterUnitType3Type1(data)
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_1 = PatchedWritableRackTypeRequestWeightUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = PatchedWritableRackTypeRequestWeightUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = PatchedWritableRackTypeRequestWeightUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableRackTypeRequestCustomFields.from_dict(_custom_fields)

        patched_writable_rack_type_request = cls(
        ...
        patched_writable_rack_type_request.additional_properties = d
        return patched_writable_rack_type_request
