...
from ..models.writable_ip_address_request_role_type_1 import WritableIPAddressRequestRoleType1
from ..models.writable_ip_address_request_role_type_2_type_1 import WritableIPAddressRequestRoleType2Type1
from ..models.writable_ip_address_request_role_type_3_type_1 import WritableIPAddressRequestRoleType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ip_address_request_custom_fields import WritableIPAddressRequestCustomFields
...
class WritableIPAddressRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIPAddressRequestCustomFields.from_dict(_custom_fields)
