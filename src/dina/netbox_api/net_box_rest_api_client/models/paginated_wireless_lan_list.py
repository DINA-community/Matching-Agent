...
T = TypeVar("T", bound="PaginatedWirelessLANList")
...
class PaginatedWirelessLANList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = WirelessLAN.from_dict(results_item_data)
        ...
        paginated_wireless_lan_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_wireless_lan_list.additional_properties = d
        return paginated_wireless_lan_list
