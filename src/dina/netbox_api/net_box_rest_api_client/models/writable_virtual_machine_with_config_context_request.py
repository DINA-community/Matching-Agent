...
from ..models.writable_virtual_machine_with_config_context_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_virtual_machine_with_config_context_request_custom_fields import (
        WritableVirtualMachineWithConfigContextRequestCustomFields,
    )


T = TypeVar("T", bound="WritableVirtualMachineWithConfigContextRequest")
...
class WritableVirtualMachineWithConfigContextRequest:
    ...
    Attributes:
        name (str):
        status (Union[Unset, WritableVirtualMachineWithConfigContextRequestStatus]): * `offline` - Offline
            * `active` - Active
            * `planned` - Planned
            * `staged` - Staged
            * `failed` - Failed
        ...
        custom_fields (Union[Unset, WritableVirtualMachineWithConfigContextRequestCustomFields]):
    """

    name: str
    status: Union[Unset, WritableVirtualMachineWithConfigContextRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritableVirtualMachineWithConfigContextRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        elif isinstance(self.device, None):
            device = (None, str(self.device).encode(), "text/plain")
        elif isinstance(self.device, BriefDeviceRequest):
        ...
        vcpus: Union[Unset, tuple[None, bytes, str]]
        ...
        memory: Union[Unset, tuple[None, bytes, str]]
        ...
        disk: Union[Unset, tuple[None, bytes, str]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, WritableVirtualMachineWithConfigContextRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableVirtualMachineWithConfigContextRequestStatus(_status)
        ...
        def _parse_device(data: object) -> Union["BriefDeviceRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_role(data: object) -> Union["BriefDeviceRoleRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableVirtualMachineWithConfigContextRequestCustomFields.from_dict(_custom_fields)

        writable_virtual_machine_with_config_context_request = cls(
            name=name,
            status=status,
            site=site,
            cluster=cluster,
        ...
        writable_virtual_machine_with_config_context_request.additional_properties = d
        return writable_virtual_machine_with_config_context_request
