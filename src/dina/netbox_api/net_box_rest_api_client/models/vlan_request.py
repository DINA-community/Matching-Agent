...
from ..models.vlan_request_qinq_role_type_1 import VLANRequestQinqRoleType1
from ..models.vlan_request_qinq_role_type_2_type_1 import VLANRequestQinqRoleType2Type1
from ..models.vlan_request_qinq_role_type_3_type_1 import VLANRequestQinqRoleType3Type1
from ..models.vlan_request_status import VLANRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.vlan_request_custom_fields import VLANRequestCustomFields


T = TypeVar("T", bound="VLANRequest")
...
class VLANRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, VLANRequestStatus]): * `active` - Active
            * `reserved` - Reserved
            * `deprecated` - Deprecated
        role (Union['BriefRoleRequest', None, Unset, int]):
        description (Union[Unset, str]):
        qinq_role (Union[None, Unset, VLANRequestQinqRoleType1, VLANRequestQinqRoleType2Type1,
            VLANRequestQinqRoleType3Type1]): * `svlan` - Service
            * `cvlan` - Customer
        qinq_svlan (Union['NestedVLANRequest', None, Unset]):
        comments (Union[Unset, str]):
        tags (Union[Unset, list['NestedTagRequest']]):
        custom_fields (Union[Unset, VLANRequestCustomFields]):
    """
    ...
    status: Union[Unset, VLANRequestStatus] = UNSET
    role: Union["BriefRoleRequest", None, Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    qinq_role: Union[
        None, Unset, VLANRequestQinqRoleType1, VLANRequestQinqRoleType2Type1, VLANRequestQinqRoleType3Type1
    ] = UNSET
    qinq_svlan: Union["NestedVLANRequest", None, Unset] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "VLANRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.qinq_role, Unset):
            qinq_role = UNSET
        elif isinstance(self.qinq_role, VLANRequestQinqRoleType1):
            qinq_role = self.qinq_role.value
        elif isinstance(self.qinq_role, VLANRequestQinqRoleType2Type1):
            qinq_role = self.qinq_role.value
        elif isinstance(self.qinq_role, VLANRequestQinqRoleType3Type1):
            qinq_role = self.qinq_role.value
        else:
        ...
        if isinstance(self.qinq_svlan, Unset):
            qinq_svlan = UNSET
        elif isinstance(self.qinq_svlan, NestedVLANRequest):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, VLANRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = VLANRequestStatus(_status)
        ...
        def _parse_qinq_role(
            data: object,
        ) -> Union[None, Unset, VLANRequestQinqRoleType1, VLANRequestQinqRoleType2Type1, VLANRequestQinqRoleType3Type1]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                qinq_role_type_1 = VLANRequestQinqRoleType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                qinq_role_type_2_type_1 = VLANRequestQinqRoleType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                qinq_role_type_3_type_1 = VLANRequestQinqRoleType3Type1(data)
        ...
        def _parse_qinq_svlan(data: object) -> Union["NestedVLANRequest", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                qinq_svlan_type_1 = NestedVLANRequest.from_dict(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VLANRequestCustomFields.from_dict(_custom_fields)
        ...
        vlan_request.additional_properties = d
        return vlan_request
