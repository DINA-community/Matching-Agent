...
from ..models.patched_writable_front_port_template_request_type import PatchedWritableFrontPortTemplateRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.brief_rear_port_template_request import BriefRearPortTemplateRequest


T = TypeVar("T", bound="PatchedWritableFrontPortTemplateRequest")
...
class PatchedWritableFrontPortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[Unset, PatchedWritableFrontPortTemplateRequestType]): * `8p8c` - 8P8C
                * `8p6c` - 8P6C
                * `8p4c` - 8P4C
                * `8p2c` - 8P2C
                * `6p6c` - 6P6C
            ...
            rear_port (Union['BriefRearPortTemplateRequest', Unset, int]):
    ...
    type_: Union[Unset, PatchedWritableFrontPortTemplateRequestType] = UNSET
    color: Union[Unset, str] = UNSET
    rear_port: Union["BriefRearPortTemplateRequest", Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        rear_port: Union[Unset, dict[str, Any], int]
        if isinstance(self.rear_port, Unset):
            rear_port = UNSET
        elif isinstance(self.rear_port, BriefRearPortTemplateRequest):
        ...
        if rear_port is not UNSET:
            field_dict["rear_port"] = rear_port
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        rear_port: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.rear_port, Unset):
            rear_port = UNSET
        elif isinstance(self.rear_port, int):
            rear_port = (None, str(self.rear_port).encode(), "text/plain")
        else:
            rear_port = (None, json.dumps(self.rear_port.to_dict()).encode(), "application/json")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, PatchedWritableFrontPortTemplateRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PatchedWritableFrontPortTemplateRequestType(_type_)

        color = d.pop("color", UNSET)

        def _parse_rear_port(data: object) -> Union["BriefRearPortTemplateRequest", Unset, int]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                rear_port_type_1 = BriefRearPortTemplateRequest.from_dict(data)

                return rear_port_type_1
            except:  # noqa: E722
                pass
            return cast(Union["BriefRearPortTemplateRequest", Unset, int], data)

        rear_port = _parse_rear_port(d.pop("rear_port", UNSET))

        rear_port_position = d.pop("rear_port_position", UNSET)

        description = d.pop("description", UNSET)

        patched_writable_front_port_template_request = cls(
        ...
        patched_writable_front_port_template_request.additional_properties = d
        return patched_writable_front_port_template_request
