...
T = TypeVar("T", bound="PaginatedVLANTranslationPolicyList")
...
class PaginatedVLANTranslationPolicyList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VLANTranslationPolicy.from_dict(results_item_data)
        ...
        paginated_vlan_translation_policy_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vlan_translation_policy_list.additional_properties = d
        return paginated_vlan_translation_policy_list
