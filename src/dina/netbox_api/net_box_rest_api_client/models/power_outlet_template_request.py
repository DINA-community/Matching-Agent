...
from ..models.power_outlet_template_request_feed_leg_type_1 import PowerOutletTemplateRequestFeedLegType1
from ..models.power_outlet_template_request_feed_leg_type_2_type_1 import PowerOutletTemplateRequestFeedLegType2Type1
from ..models.power_outlet_template_request_feed_leg_type_3_type_1 import PowerOutletTemplateRequestFeedLegType3Type1
from ..models.power_outlet_template_request_type_type_1 import PowerOutletTemplateRequestTypeType1
from ..models.power_outlet_template_request_type_type_2_type_1 import PowerOutletTemplateRequestTypeType2Type1
from ..models.power_outlet_template_request_type_type_3_type_1 import PowerOutletTemplateRequestTypeType3Type1
...
class PowerOutletTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[None, PowerOutletTemplateRequestTypeType1, PowerOutletTemplateRequestTypeType2Type1,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, PowerOutletTemplateRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, PowerOutletTemplateRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, PowerOutletTemplateRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_power_port(data: object) -> Union["BriefPowerPortTemplateRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_feed_leg(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_2_type_1 = PowerOutletTemplateRequestFeedLegType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_3_type_1 = PowerOutletTemplateRequestFeedLegType3Type1(data)
