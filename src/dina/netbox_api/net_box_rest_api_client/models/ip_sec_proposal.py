...
if TYPE_CHECKING:
    from ..models.ip_sec_proposal_authentication_algorithm import IPSecProposalAuthenticationAlgorithm
    from ..models.ip_sec_proposal_custom_fields import IPSecProposalCustomFields
    from ..models.ip_sec_proposal_encryption_algorithm import IPSecProposalEncryptionAlgorithm
    from ..models.nested_tag import NestedTag


T = TypeVar("T", bound="IPSecProposal")
...
class IPSecProposal:
    ...
    Attributes:
        ...
        encryption_algorithm (Union[Unset, IPSecProposalEncryptionAlgorithm]):
        authentication_algorithm (Union[Unset, IPSecProposalAuthenticationAlgorithm]):
        ...
        custom_fields (Union[Unset, IPSecProposalCustomFields]):
    """
    ...
    encryption_algorithm: Union[Unset, "IPSecProposalEncryptionAlgorithm"] = UNSET
    authentication_algorithm: Union[Unset, "IPSecProposalAuthenticationAlgorithm"] = UNSET
    sa_lifetime_seconds: Union[None, Unset, int] = UNSET
    sa_lifetime_data: Union[None, Unset, int] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTag"]] = UNSET
    custom_fields: Union[Unset, "IPSecProposalCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_encryption_algorithm, Unset):
            ...
            encryption_algorithm = IPSecProposalEncryptionAlgorithm.from_dict(_encryption_algorithm)
        ...
        if isinstance(_authentication_algorithm, Unset):
            ...
            authentication_algorithm = IPSecProposalAuthenticationAlgorithm.from_dict(_authentication_algorithm)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = IPSecProposalCustomFields.from_dict(_custom_fields)
        ...
        ip_sec_proposal.additional_properties = d
        return ip_sec_proposal
