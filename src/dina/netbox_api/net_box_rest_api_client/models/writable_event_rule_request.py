...
from ..models.writable_event_rule_request_action_type import WritableEventRuleRequestActionType
from ..models.writable_event_rule_request_event_types_item import WritableEventRuleRequestEventTypesItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.writable_event_rule_request_custom_fields import WritableEventRuleRequestCustomFields
...
class WritableEventRuleRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for event_types_item_data in _event_types:
            event_types_item = WritableEventRuleRequestEventTypesItem(event_types_item_data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableEventRuleRequestCustomFields.from_dict(_custom_fields)
