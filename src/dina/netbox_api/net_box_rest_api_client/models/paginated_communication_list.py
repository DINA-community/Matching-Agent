...
T = TypeVar("T", bound="PaginatedCommunicationList")


@_attrs_define
class PaginatedCommunicationList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Communication.from_dict(results_item_data)
        ...
        paginated_communication_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_communication_list.additional_properties = d
        return paginated_communication_list
