...
from ..models.writable_ip_range_request_status import WritableIPRangeRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ip_range_request_custom_fields import WritableIPRangeRequestCustomFields


T = TypeVar("T", bound="WritableIPRangeRequest")
...
class WritableIPRangeRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, WritableIPRangeRequestStatus]): Operational status of this range
        ...
        custom_fields (Union[Unset, WritableIPRangeRequestCustomFields]):
    ...
    status: Union[Unset, WritableIPRangeRequestStatus] = UNSET
    role: Union["BriefRoleRequest", None, Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "WritableIPRangeRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        start_address = (None, str(self.start_address).encode(), "text/plain")

        end_address = (None, str(self.end_address).encode(), "text/plain")
        ...
        mark_populated = (
            self.mark_populated
            if isinstance(self.mark_populated, Unset)
            else (None, str(self.mark_populated).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, WritableIPRangeRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableIPRangeRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIPRangeRequestCustomFields.from_dict(_custom_fields)

        mark_populated = d.pop("mark_populated", UNSET)

        mark_utilized = d.pop("mark_utilized", UNSET)

        writable_ip_range_request = cls(
            start_address=start_address,
            end_address=end_address,
            vrf=vrf,
            tenant=tenant,
        ...
        writable_ip_range_request.additional_properties = d
        return writable_ip_range_request
