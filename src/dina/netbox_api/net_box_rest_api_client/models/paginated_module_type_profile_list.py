...
T = TypeVar("T", bound="PaginatedModuleTypeProfileList")
...
class PaginatedModuleTypeProfileList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ModuleTypeProfile.from_dict(results_item_data)
        ...
        paginated_module_type_profile_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_module_type_profile_list.additional_properties = d
        return paginated_module_type_profile_list
