...
from ..models.patched_writable_tunnel_request_encapsulation import PatchedWritableTunnelRequestEncapsulation
from ..models.patched_writable_tunnel_request_status import PatchedWritableTunnelRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_tunnel_request_custom_fields import PatchedWritableTunnelRequestCustomFields
...
class PatchedWritableTunnelRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableTunnelRequestCustomFields.from_dict(_custom_fields)
