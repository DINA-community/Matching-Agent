...
from ..models.patched_writable_journal_entry_request_kind import PatchedWritableJournalEntryRequestKind
...
class PatchedWritableJournalEntryRequest:
    ...
    custom_fields: Union[Unset, "PatchedWritableJournalEntryRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableJournalEntryRequestCustomFields.from_dict(_custom_fields)
