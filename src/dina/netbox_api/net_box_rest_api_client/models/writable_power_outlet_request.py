...
from ..models.writable_power_outlet_request_feed_leg_type_1 import WritablePowerOutletRequestFeedLegType1
from ..models.writable_power_outlet_request_feed_leg_type_2_type_1 import WritablePowerOutletRequestFeedLegType2Type1
from ..models.writable_power_outlet_request_feed_leg_type_3_type_1 import WritablePowerOutletRequestFeedLegType3Type1
from ..models.writable_power_outlet_request_status import WritablePowerOutletRequestStatus
from ..models.writable_power_outlet_request_type_type_1 import WritablePowerOutletRequestTypeType1
from ..models.writable_power_outlet_request_type_type_2_type_1 import WritablePowerOutletRequestTypeType2Type1
from ..models.writable_power_outlet_request_type_type_3_type_1 import WritablePowerOutletRequestTypeType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_power_outlet_request_custom_fields import WritablePowerOutletRequestCustomFields


T = TypeVar("T", bound="WritablePowerOutletRequest")
...
class WritablePowerOutletRequest:
    ...
    Attributes:
        ...
        type_ (Union[None, Unset, WritablePowerOutletRequestTypeType1, WritablePowerOutletRequestTypeType2Type1,
            WritablePowerOutletRequestTypeType3Type1]): Physical port type
            ...
            * `hardwired` - Hardwired
            * `other` - Other
        status (Union[Unset, WritablePowerOutletRequestStatus]): * `enabled` - Enabled
            * `disabled` - Disabled
            * `faulty` - Faulty
        color (Union[Unset, str]):
        power_port (Union['BriefPowerPortRequest', None, Unset, int]):
        feed_leg (Union[None, Unset, WritablePowerOutletRequestFeedLegType1,
            WritablePowerOutletRequestFeedLegType2Type1, WritablePowerOutletRequestFeedLegType3Type1]): Phase (for three-
            phase feeds)
        ...
        custom_fields (Union[Unset, WritablePowerOutletRequestCustomFields]):
    """
    ...
    status: Union[Unset, WritablePowerOutletRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritablePowerOutletRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, WritablePowerOutletRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritablePowerOutletRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritablePowerOutletRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
        ...
        if isinstance(self.feed_leg, Unset):
            feed_leg = UNSET
        elif isinstance(self.feed_leg, WritablePowerOutletRequestFeedLegType1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, WritablePowerOutletRequestFeedLegType2Type1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, WritablePowerOutletRequestFeedLegType3Type1):
            feed_leg = self.feed_leg.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.power_port, Unset):
            ...
            power_port = (None, json.dumps(self.power_port.to_dict()).encode(), "application/json")
        else:
            power_port = (None, str(self.power_port).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = WritablePowerOutletRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritablePowerOutletRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritablePowerOutletRequestTypeType3Type1(data)
        ...
        status: Union[Unset, WritablePowerOutletRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritablePowerOutletRequestStatus(_status)
        ...
        def _parse_feed_leg(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_1 = WritablePowerOutletRequestFeedLegType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_2_type_1 = WritablePowerOutletRequestFeedLegType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_3_type_1 = WritablePowerOutletRequestFeedLegType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritablePowerOutletRequestCustomFields.from_dict(_custom_fields)

        writable_power_outlet_request = cls(
            device=device,
            name=name,
            module=module,
            label=label,
        ...
        writable_power_outlet_request.additional_properties = d
        return writable_power_outlet_request
