...
T = TypeVar("T", bound="PaginatedVirtualCircuitList")
...
class PaginatedVirtualCircuitList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VirtualCircuit.from_dict(results_item_data)
        ...
        paginated_virtual_circuit_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_virtual_circuit_list.additional_properties = d
        return paginated_virtual_circuit_list
