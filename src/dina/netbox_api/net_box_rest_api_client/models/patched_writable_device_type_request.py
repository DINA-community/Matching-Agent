...
from ..models.patched_writable_device_type_request_airflow_type_1 import PatchedWritableDeviceTypeRequestAirflowType1
from ..models.patched_writable_device_type_request_airflow_type_2_type_1 import (
    PatchedWritableDeviceTypeRequestAirflowType2Type1,
)
from ..models.patched_writable_device_type_request_airflow_type_3_type_1 import (
...
from ..models.patched_writable_device_type_request_weight_unit_type_1 import (
    PatchedWritableDeviceTypeRequestWeightUnitType1,
)
from ..models.patched_writable_device_type_request_weight_unit_type_2_type_1 import (
    PatchedWritableDeviceTypeRequestWeightUnitType2Type1,
)
from ..models.patched_writable_device_type_request_weight_unit_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_device_type_request_custom_fields import PatchedWritableDeviceTypeRequestCustomFields
...
class PatchedWritableDeviceTypeRequest:
    ...
    Attributes:
        ...
        subdevice_role (Union[None, PatchedWritableDeviceTypeRequestParentchildStatus, Unset]): Parent devices house
            child devices in device bays. Leave blank if this device type is neither a parent nor a child.

            * `parent` - Parent
            * `child` - Child
        airflow (Union[None, PatchedWritableDeviceTypeRequestAirflowType1,
            PatchedWritableDeviceTypeRequestAirflowType2Type1, PatchedWritableDeviceTypeRequestAirflowType3Type1, Unset]): *
        ...
        weight_unit (Union[None, PatchedWritableDeviceTypeRequestWeightUnitType1,
            PatchedWritableDeviceTypeRequestWeightUnitType2Type1, PatchedWritableDeviceTypeRequestWeightUnitType3Type1,
            Unset]): * `kg` - Kilograms
            * `g` - Grams
            * `lb` - Pounds
            * `oz` - Ounces
    ...
    subdevice_role: Union[None, PatchedWritableDeviceTypeRequestParentchildStatus, Unset] = UNSET
    airflow: Union[
        None,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.subdevice_role, PatchedWritableDeviceTypeRequestParentchildStatus):
        ...
        if isinstance(self.airflow, Unset):
            airflow = UNSET
        elif isinstance(self.airflow, PatchedWritableDeviceTypeRequestAirflowType1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, PatchedWritableDeviceTypeRequestAirflowType2Type1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, PatchedWritableDeviceTypeRequestAirflowType3Type1):
            airflow = self.airflow.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            weight_unit = UNSET
        elif isinstance(self.weight_unit, PatchedWritableDeviceTypeRequestWeightUnitType1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableDeviceTypeRequestWeightUnitType2Type1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableDeviceTypeRequestWeightUnitType3Type1):
            weight_unit = self.weight_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.default_platform, Unset):
            ...
            default_platform = (None, json.dumps(self.default_platform.to_dict()).encode(), "application/json")
        else:
            default_platform = (None, str(self.default_platform).encode(), "text/plain")
        ...
        if isinstance(self.subdevice_role, Unset):
            ...
            subdevice_role = (None, str(self.subdevice_role.value).encode(), "text/plain")
        elif isinstance(self.subdevice_role, None):
            subdevice_role = (None, str(self.subdevice_role).encode(), "text/plain")
        elif isinstance(self.subdevice_role, PatchedWritableDeviceTypeRequestParentchildStatus):
            subdevice_role = (None, str(self.subdevice_role.value).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subdevice_role(
            data: object,
        ) -> Union[None, PatchedWritableDeviceTypeRequestParentchildStatus, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subdevice_role_type_1 = PatchedWritableDeviceTypeRequestParentchildStatus(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subdevice_role_type_2_type_1 = PatchedWritableDeviceTypeRequestParentchildStatus(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subdevice_role_type_3_type_1 = PatchedWritableDeviceTypeRequestParentchildStatus(data)

                return subdevice_role_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PatchedWritableDeviceTypeRequestParentchildStatus, Unset], data)
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_1 = PatchedWritableDeviceTypeRequestAirflowType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_2_type_1 = PatchedWritableDeviceTypeRequestAirflowType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_3_type_1 = PatchedWritableDeviceTypeRequestAirflowType3Type1(data)
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_1 = PatchedWritableDeviceTypeRequestWeightUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = PatchedWritableDeviceTypeRequestWeightUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = PatchedWritableDeviceTypeRequestWeightUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableDeviceTypeRequestCustomFields.from_dict(_custom_fields)
