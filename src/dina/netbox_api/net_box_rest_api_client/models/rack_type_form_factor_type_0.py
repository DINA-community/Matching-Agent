...
from ..models.rack_type_form_factor_type_0_value_type_1 import RackTypeFormFactorType0ValueType1
...
class RackTypeFormFactorType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[None, RackTypeFormFactorType0ValueType1, Unset]:
            if data is None:
                return data
