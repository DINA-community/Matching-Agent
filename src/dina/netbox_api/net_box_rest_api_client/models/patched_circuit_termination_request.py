...
from ..models.patched_circuit_termination_request_termination_side import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_circuit_termination_request_custom_fields import PatchedCircuitTerminationRequestCustomFields


T = TypeVar("T", bound="PatchedCircuitTerminationRequest")
...
class PatchedCircuitTerminationRequest:
    ...
    Attributes:
        circuit (Union['BriefCircuitRequest', Unset, int]):
        term_side (Union[Unset, PatchedCircuitTerminationRequestTerminationSide]): * `A` - A
            * `Z` - Z
        ...
        custom_fields (Union[Unset, PatchedCircuitTerminationRequestCustomFields]):
    """

    circuit: Union["BriefCircuitRequest", Unset, int] = UNSET
    term_side: Union[Unset, PatchedCircuitTerminationRequestTerminationSide] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedCircuitTerminationRequestCustomFields"] = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.brief_circuit_request import BriefCircuitRequest

        circuit: Union[Unset, dict[str, Any], int]
        if isinstance(self.circuit, Unset):
            circuit = UNSET
        elif isinstance(self.circuit, BriefCircuitRequest):
            circuit = self.circuit.to_dict()
        else:
            circuit = self.circuit

        term_side: Union[Unset, str] = UNSET
        if not isinstance(self.term_side, Unset):
        ...
        if term_side is not UNSET:
            field_dict["term_side"] = term_side
    ...
    def to_multipart(self) -> dict[str, Any]:
        circuit: Union[Unset, tuple[None, bytes, str]]

        if isinstance(self.circuit, Unset):
            circuit = UNSET
        elif isinstance(self.circuit, int):
            circuit = (None, str(self.circuit).encode(), "text/plain")
        else:
            circuit = (None, json.dumps(self.circuit.to_dict()).encode(), "application/json")

        term_side: Union[Unset, tuple[None, bytes, str]] = UNSET
        if not isinstance(self.term_side, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.brief_circuit_request import BriefCircuitRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.patched_circuit_termination_request_custom_fields import (
            PatchedCircuitTerminationRequestCustomFields,
        )

        d = dict(src_dict)

        def _parse_circuit(data: object) -> Union["BriefCircuitRequest", Unset, int]:
            ...
            try:
                ...
                pass
            return cast(Union["BriefCircuitRequest", Unset, int], data)

        circuit = _parse_circuit(d.pop("circuit", UNSET))

        _term_side = d.pop("term_side", UNSET)
        term_side: Union[Unset, PatchedCircuitTerminationRequestTerminationSide]
        if isinstance(_term_side, Unset):
            term_side = UNSET
        else:
            term_side = PatchedCircuitTerminationRequestTerminationSide(_term_side)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedCircuitTerminationRequestCustomFields.from_dict(_custom_fields)

        patched_circuit_termination_request = cls(
            circuit=circuit,
            term_side=term_side,
        ...
        patched_circuit_termination_request.additional_properties = d
        return patched_circuit_termination_request
