...
T = TypeVar("T", bound="PatchedConfigContextRequest")
...
class PatchedConfigContextRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if not isinstance(self.site_groups, Unset):
            ...
            site_groups = (None, json.dumps(_temp_site_groups).encode(), "application/json")
        ...
        if not isinstance(self.device_types, Unset):
            ...
            device_types = (None, json.dumps(_temp_device_types).encode(), "application/json")
        ...
        if not isinstance(self.cluster_types, Unset):
            ...
            cluster_types = (None, json.dumps(_temp_cluster_types).encode(), "application/json")

        cluster_groups: Union[Unset, tuple[None, bytes, str]] = UNSET
        if not isinstance(self.cluster_groups, Unset):
            _temp_cluster_groups = self.cluster_groups
            cluster_groups = (None, json.dumps(_temp_cluster_groups).encode(), "application/json")
        ...
        if not isinstance(self.tenant_groups, Unset):
            ...
            tenant_groups = (None, json.dumps(_temp_tenant_groups).encode(), "application/json")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_config_context_request = cls(
            name=name,
            weight=weight,
        ...
        patched_config_context_request.additional_properties = d
        return patched_config_context_request
