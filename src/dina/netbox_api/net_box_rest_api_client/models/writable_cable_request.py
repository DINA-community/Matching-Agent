...
from ..models.writable_cable_request_length_unit_type_1 import WritableCableRequestLengthUnitType1
from ..models.writable_cable_request_length_unit_type_2_type_1 import WritableCableRequestLengthUnitType2Type1
from ..models.writable_cable_request_length_unit_type_3_type_1 import WritableCableRequestLengthUnitType3Type1
from ..models.writable_cable_request_status import WritableCableRequestStatus
from ..models.writable_cable_request_type_type_1 import WritableCableRequestTypeType1
from ..models.writable_cable_request_type_type_2_type_1 import WritableCableRequestTypeType2Type1
from ..models.writable_cable_request_type_type_3_type_1 import WritableCableRequestTypeType3Type1
...
if TYPE_CHECKING:
    ...
    from ..models.writable_cable_request_custom_fields import WritableCableRequestCustomFields


T = TypeVar("T", bound="WritableCableRequest")
...
class WritableCableRequest:
    ...
    Attributes:
        type_ (Union[None, Unset, WritableCableRequestTypeType1, WritableCableRequestTypeType2Type1,
            WritableCableRequestTypeType3Type1]): * `cat3` - CAT3
            * `cat5` - CAT5
            * `cat5e` - CAT5e
            * `cat6` - CAT6
            * `cat6a` - CAT6a
        ...
        status (Union[Unset, WritableCableRequestStatus]): * `connected` - Connected
            * `planned` - Planned
        ...
        length_unit (Union[None, Unset, WritableCableRequestLengthUnitType1, WritableCableRequestLengthUnitType2Type1,
            WritableCableRequestLengthUnitType3Type1]): * `km` - Kilometers
            * `m` - Meters
            * `cm` - Centimeters
            * `mi` - Miles
            * `ft` - Feet
        ...
        custom_fields (Union[Unset, WritableCableRequestCustomFields]):
    """
    ...
    status: Union[Unset, WritableCableRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritableCableRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, WritableCableRequestTypeType1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritableCableRequestTypeType2Type1):
            type_ = self.type_.value
        elif isinstance(self.type_, WritableCableRequestTypeType3Type1):
            type_ = self.type_.value
        else:
            type_ = self.type_
        ...
        if isinstance(self.length_unit, Unset):
            length_unit = UNSET
        elif isinstance(self.length_unit, WritableCableRequestLengthUnitType1):
            length_unit = self.length_unit.value
        elif isinstance(self.length_unit, WritableCableRequestLengthUnitType2Type1):
            length_unit = self.length_unit.value
        elif isinstance(self.length_unit, WritableCableRequestLengthUnitType3Type1):
            length_unit = self.length_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if not isinstance(self.a_terminations, Unset):
            ...
            a_terminations = (None, json.dumps(_temp_a_terminations).encode(), "application/json")
        ...
        if not isinstance(self.b_terminations, Unset):
            ...
            b_terminations = (None, json.dumps(_temp_b_terminations).encode(), "application/json")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = WritableCableRequestTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritableCableRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritableCableRequestTypeType3Type1(data)
        ...
        status: Union[Unset, WritableCableRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableCableRequestStatus(_status)
        ...
        def _parse_length_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_1 = WritableCableRequestLengthUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_2_type_1 = WritableCableRequestLengthUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_3_type_1 = WritableCableRequestLengthUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableCableRequestCustomFields.from_dict(_custom_fields)

        writable_cable_request = cls(
            type_=type_,
        ...
        writable_cable_request.additional_properties = d
        return writable_cable_request
