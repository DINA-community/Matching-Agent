...
from ..models.power_port_type_type_0_label import PowerPortTypeType0Label
from ..models.power_port_type_type_0_value_type_1 import PowerPortTypeType0ValueType1
from ..types import UNSET, Unset

T = TypeVar("T", bound="PowerPortTypeType0")


@_attrs_define
class PowerPortTypeType0:
    """
    Attributes:
        value (Union[None, PowerPortTypeType0ValueType1, Unset]): * `iec-60320-c6` - C6
            * `iec-60320-c8` - C8
            * `iec-60320-c14` - C14
            * `iec-60320-c16` - C16
            * `iec-60320-c20` - C20
            ...
            * `hardwired` - Hardwired
            * `other` - Other
        label (Union[Unset, PowerPortTypeType0Label]):
    """

    value: Union[None, PowerPortTypeType0ValueType1, Unset] = UNSET
    label: Union[Unset, PowerPortTypeType0Label] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, PowerPortTypeType0ValueType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union[None, PowerPortTypeType0ValueType1, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                value_type_1 = PowerPortTypeType0ValueType1(data)

                return value_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PowerPortTypeType0ValueType1, Unset], data)
        ...
        if isinstance(_label, Unset):
            ...
            label = PowerPortTypeType0Label(_label)

        power_port_type_type_0 = cls(
            value=value,
            label=label,
        )

        power_port_type_type_0.additional_properties = d
        return power_port_type_type_0
