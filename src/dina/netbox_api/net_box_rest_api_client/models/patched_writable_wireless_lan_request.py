...
from ..models.patched_writable_wireless_lan_request_status import PatchedWritableWirelessLANRequestStatus
...
class PatchedWritableWirelessLANRequest:
    ...
    Attributes:
        ...
        auth_type (Union[None, PatchedWritableWirelessLANRequestAuthenticationType, Unset]): * `open` - Open
            * `wep` - WEP
            * `wpa-personal` - WPA Personal (PSK)
            * `wpa-enterprise` - WPA Enterprise
        auth_cipher (Union[None, PatchedWritableWirelessLANRequestAuthenticationCipher, Unset]): * `auto` - Auto
            * `tkip` - TKIP
            * `aes` - AES
    ...
    auth_type: Union[None, PatchedWritableWirelessLANRequestAuthenticationType, Unset] = UNSET
    auth_cipher: Union[None, PatchedWritableWirelessLANRequestAuthenticationCipher, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.auth_type, Unset):
            auth_type = UNSET
        elif isinstance(self.auth_type, PatchedWritableWirelessLANRequestAuthenticationType):
        ...
        if isinstance(self.auth_cipher, Unset):
            auth_cipher = UNSET
        elif isinstance(self.auth_cipher, PatchedWritableWirelessLANRequestAuthenticationCipher):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_auth_type(data: object) -> Union[None, PatchedWritableWirelessLANRequestAuthenticationType, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_1 = PatchedWritableWirelessLANRequestAuthenticationType(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_2_type_1 = PatchedWritableWirelessLANRequestAuthenticationType(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_3_type_1 = PatchedWritableWirelessLANRequestAuthenticationType(data)

                return auth_type_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PatchedWritableWirelessLANRequestAuthenticationType, Unset], data)

        auth_type = _parse_auth_type(d.pop("auth_type", UNSET))

        def _parse_auth_cipher(
            data: object,
        ) -> Union[None, PatchedWritableWirelessLANRequestAuthenticationCipher, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_1 = PatchedWritableWirelessLANRequestAuthenticationCipher(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_2_type_1 = PatchedWritableWirelessLANRequestAuthenticationCipher(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_3_type_1 = PatchedWritableWirelessLANRequestAuthenticationCipher(data)

                return auth_cipher_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, PatchedWritableWirelessLANRequestAuthenticationCipher, Unset], data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableWirelessLANRequestCustomFields.from_dict(_custom_fields)
