...
from ..models.writable_power_outlet_template_request_type_type_1 import WritablePowerOutletTemplateRequestTypeType1
...
class WritablePowerOutletTemplateRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.feed_leg, WritablePowerOutletTemplateRequestFeedLegType2Type1):
            feed_leg = self.feed_leg.value
        elif isinstance(self.feed_leg, WritablePowerOutletTemplateRequestFeedLegType3Type1):
            feed_leg = self.feed_leg.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritablePowerOutletTemplateRequestTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritablePowerOutletTemplateRequestTypeType3Type1(data)
        ...
        def _parse_feed_leg(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_2_type_1 = WritablePowerOutletTemplateRequestFeedLegType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_3_type_1 = WritablePowerOutletTemplateRequestFeedLegType3Type1(data)
