...
class PatchedWritableIPSecPolicyRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.pfs_group, PatchedWritableIPSecPolicyRequestPfsGroupType2Type1):
            pfs_group = self.pfs_group.value
        elif isinstance(self.pfs_group, PatchedWritableIPSecPolicyRequestPfsGroupType3Type1):
            pfs_group = self.pfs_group.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_pfs_group(
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                pfs_group_type_2_type_1 = PatchedWritableIPSecPolicyRequestPfsGroupType2Type1(data)
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                pfs_group_type_3_type_1 = PatchedWritableIPSecPolicyRequestPfsGroupType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIPSecPolicyRequestCustomFields.from_dict(_custom_fields)
