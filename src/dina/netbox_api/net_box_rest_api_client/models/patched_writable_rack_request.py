...
from ..models.patched_writable_rack_request_airflow_type_1 import PatchedWritableRackRequestAirflowType1
from ..models.patched_writable_rack_request_airflow_type_2_type_1 import PatchedWritableRackRequestAirflowType2Type1
from ..models.patched_writable_rack_request_airflow_type_3_type_1 import PatchedWritableRackRequestAirflowType3Type1
from ..models.patched_writable_rack_request_form_factor_type_1 import PatchedWritableRackRequestFormFactorType1
from ..models.patched_writable_rack_request_form_factor_type_2_type_1 import (
    PatchedWritableRackRequestFormFactorType2Type1,
)
from ..models.patched_writable_rack_request_form_factor_type_3_type_1 import (
    PatchedWritableRackRequestFormFactorType3Type1,
)
from ..models.patched_writable_rack_request_outer_unit_type_1 import PatchedWritableRackRequestOuterUnitType1
from ..models.patched_writable_rack_request_outer_unit_type_2_type_1 import (
    PatchedWritableRackRequestOuterUnitType2Type1,
)
from ..models.patched_writable_rack_request_outer_unit_type_3_type_1 import (
    PatchedWritableRackRequestOuterUnitType3Type1,
)
from ..models.patched_writable_rack_request_status import PatchedWritableRackRequestStatus
from ..models.patched_writable_rack_request_weight_unit_type_1 import PatchedWritableRackRequestWeightUnitType1
from ..models.patched_writable_rack_request_weight_unit_type_2_type_1 import (
    PatchedWritableRackRequestWeightUnitType2Type1,
)
from ..models.patched_writable_rack_request_weight_unit_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_rack_request_custom_fields import PatchedWritableRackRequestCustomFields
...
class PatchedWritableRackRequest:
    ...
    Attributes:
        ...
        form_factor (Union[None, PatchedWritableRackRequestFormFactorType1,
            PatchedWritableRackRequestFormFactorType2Type1, PatchedWritableRackRequestFormFactorType3Type1, Unset]): *
        ...
        weight_unit (Union[None, PatchedWritableRackRequestWeightUnitType1,
            PatchedWritableRackRequestWeightUnitType2Type1, PatchedWritableRackRequestWeightUnitType3Type1, Unset]): * `kg`
            - Kilograms
            * `g` - Grams
            * `lb` - Pounds
            * `oz` - Ounces
        ...
        outer_unit (Union[None, PatchedWritableRackRequestOuterUnitType1, PatchedWritableRackRequestOuterUnitType2Type1,
            PatchedWritableRackRequestOuterUnitType3Type1, Unset]): * `mm` - Millimeters
            * `in` - Inches
        ...
        airflow (Union[None, PatchedWritableRackRequestAirflowType1, PatchedWritableRackRequestAirflowType2Type1,
            PatchedWritableRackRequestAirflowType3Type1, Unset]): * `front-to-rear` - Front to rear
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form_factor, Unset):
            form_factor = UNSET
        elif isinstance(self.form_factor, PatchedWritableRackRequestFormFactorType1):
            form_factor = self.form_factor.value
        elif isinstance(self.form_factor, PatchedWritableRackRequestFormFactorType2Type1):
            form_factor = self.form_factor.value
        elif isinstance(self.form_factor, PatchedWritableRackRequestFormFactorType3Type1):
            form_factor = self.form_factor.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            weight_unit = UNSET
        elif isinstance(self.weight_unit, PatchedWritableRackRequestWeightUnitType1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableRackRequestWeightUnitType2Type1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableRackRequestWeightUnitType3Type1):
            weight_unit = self.weight_unit.value
        else:
        ...
        if isinstance(self.outer_unit, Unset):
            outer_unit = UNSET
        elif isinstance(self.outer_unit, PatchedWritableRackRequestOuterUnitType1):
            outer_unit = self.outer_unit.value
        elif isinstance(self.outer_unit, PatchedWritableRackRequestOuterUnitType2Type1):
            outer_unit = self.outer_unit.value
        elif isinstance(self.outer_unit, PatchedWritableRackRequestOuterUnitType3Type1):
            outer_unit = self.outer_unit.value
        else:
        ...
        if isinstance(self.airflow, Unset):
            airflow = UNSET
        elif isinstance(self.airflow, PatchedWritableRackRequestAirflowType1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, PatchedWritableRackRequestAirflowType2Type1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, PatchedWritableRackRequestAirflowType3Type1):
            airflow = self.airflow.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_form_factor(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_1 = PatchedWritableRackRequestFormFactorType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_2_type_1 = PatchedWritableRackRequestFormFactorType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_3_type_1 = PatchedWritableRackRequestFormFactorType3Type1(data)
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_1 = PatchedWritableRackRequestWeightUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = PatchedWritableRackRequestWeightUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = PatchedWritableRackRequestWeightUnitType3Type1(data)
        ...
        def _parse_outer_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_1 = PatchedWritableRackRequestOuterUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_2_type_1 = PatchedWritableRackRequestOuterUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_3_type_1 = PatchedWritableRackRequestOuterUnitType3Type1(data)
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_1 = PatchedWritableRackRequestAirflowType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_2_type_1 = PatchedWritableRackRequestAirflowType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_3_type_1 = PatchedWritableRackRequestAirflowType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableRackRequestCustomFields.from_dict(_custom_fields)
