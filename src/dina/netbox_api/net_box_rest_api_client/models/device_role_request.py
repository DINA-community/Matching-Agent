...
class DeviceRoleRequest:
    ...
    Attributes:
        ...
        parent (Union['NestedDeviceRoleRequest', None, Unset]):
    ...
    parent: Union["NestedDeviceRoleRequest", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.parent, Unset):
            parent = UNSET
        elif isinstance(self.parent, NestedDeviceRoleRequest):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_parent(data: object) -> Union["NestedDeviceRoleRequest", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                parent_type_1 = NestedDeviceRoleRequest.from_dict(data)
