...
from ..models.patched_writable_prefix_request_status import PatchedWritablePrefixRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_prefix_request_custom_fields import PatchedWritablePrefixRequestCustomFields


T = TypeVar("T", bound="PatchedWritablePrefixRequest")
...
class PatchedWritablePrefixRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, PatchedWritablePrefixRequestStatus]): Operational status of this prefix
        ...
        custom_fields (Union[Unset, PatchedWritablePrefixRequestCustomFields]):
    """
    ...
    status: Union[Unset, PatchedWritablePrefixRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedWritablePrefixRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        is_pool = self.is_pool if isinstance(self.is_pool, Unset) else (None, str(self.is_pool).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PatchedWritablePrefixRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritablePrefixRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritablePrefixRequestCustomFields.from_dict(_custom_fields)

        patched_writable_prefix_request = cls(
            prefix=prefix,
            vrf=vrf,
        ...
        patched_writable_prefix_request.additional_properties = d
        return patched_writable_prefix_request
