...
T = TypeVar("T", bound="NotificationGroupRequest")
...
class NotificationGroupRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notification_group_request = cls(
            name=name,
        ...
        notification_group_request.additional_properties = d
        return notification_group_request
