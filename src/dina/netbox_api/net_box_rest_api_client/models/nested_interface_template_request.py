...
T = TypeVar("T", bound="NestedInterfaceTemplateRequest")
...
class NestedInterfaceTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nested_interface_template_request = cls(
            name=name,
        )

        nested_interface_template_request.additional_properties = d
        return nested_interface_template_request
