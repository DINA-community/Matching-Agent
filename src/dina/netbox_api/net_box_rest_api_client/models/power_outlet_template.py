...
if TYPE_CHECKING:
    ...
    from ..models.power_outlet_template_feed_leg_type_0 import PowerOutletTemplateFeedLegType0
...
class PowerOutletTemplate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(data: object) -> Union["PowerOutletTemplateTypeType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_power_port(data: object) -> Union["BriefPowerPortTemplate", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_feed_leg(data: object) -> Union["PowerOutletTemplateFeedLegType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
