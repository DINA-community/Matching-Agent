...
from ..models.patched_writable_module_type_request_airflow_type_1 import PatchedWritableModuleTypeRequestAirflowType1
from ..models.patched_writable_module_type_request_airflow_type_2_type_1 import (
    PatchedWritableModuleTypeRequestAirflowType2Type1,
)
from ..models.patched_writable_module_type_request_airflow_type_3_type_1 import (
    PatchedWritableModuleTypeRequestAirflowType3Type1,
)
from ..models.patched_writable_module_type_request_weight_unit_type_1 import (
    PatchedWritableModuleTypeRequestWeightUnitType1,
)
from ..models.patched_writable_module_type_request_weight_unit_type_2_type_1 import (
    PatchedWritableModuleTypeRequestWeightUnitType2Type1,
)
from ..models.patched_writable_module_type_request_weight_unit_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_module_type_request_custom_fields import PatchedWritableModuleTypeRequestCustomFields


T = TypeVar("T", bound="PatchedWritableModuleTypeRequest")
...
class PatchedWritableModuleTypeRequest:
    ...
    Attributes:
        ...
        airflow (Union[None, PatchedWritableModuleTypeRequestAirflowType1,
            PatchedWritableModuleTypeRequestAirflowType2Type1, PatchedWritableModuleTypeRequestAirflowType3Type1, Unset]): *
        ...
        weight_unit (Union[None, PatchedWritableModuleTypeRequestWeightUnitType1,
            PatchedWritableModuleTypeRequestWeightUnitType2Type1, PatchedWritableModuleTypeRequestWeightUnitType3Type1,
            Unset]): * `kg` - Kilograms
            * `g` - Grams
            * `lb` - Pounds
            * `oz` - Ounces
        ...
        custom_fields (Union[Unset, PatchedWritableModuleTypeRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PatchedWritableModuleTypeRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.airflow, Unset):
            airflow = UNSET
        elif isinstance(self.airflow, PatchedWritableModuleTypeRequestAirflowType1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, PatchedWritableModuleTypeRequestAirflowType2Type1):
            airflow = self.airflow.value
        elif isinstance(self.airflow, PatchedWritableModuleTypeRequestAirflowType3Type1):
            airflow = self.airflow.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            weight_unit = UNSET
        elif isinstance(self.weight_unit, PatchedWritableModuleTypeRequestWeightUnitType1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableModuleTypeRequestWeightUnitType2Type1):
            weight_unit = self.weight_unit.value
        elif isinstance(self.weight_unit, PatchedWritableModuleTypeRequestWeightUnitType3Type1):
            weight_unit = self.weight_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.profile, Unset):
            ...
            profile = (None, json.dumps(self.profile.to_dict()).encode(), "application/json")
        else:
            profile = (None, str(self.profile).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_module_type_profile_request import BriefModuleTypeProfileRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.patched_writable_module_type_request_custom_fields import (
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_1 = PatchedWritableModuleTypeRequestAirflowType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_2_type_1 = PatchedWritableModuleTypeRequestAirflowType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_3_type_1 = PatchedWritableModuleTypeRequestAirflowType3Type1(data)
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_1 = PatchedWritableModuleTypeRequestWeightUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = PatchedWritableModuleTypeRequestWeightUnitType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = PatchedWritableModuleTypeRequestWeightUnitType3Type1(data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableModuleTypeRequestCustomFields.from_dict(_custom_fields)

        patched_writable_module_type_request = cls(
            profile=profile,
        ...
        patched_writable_module_type_request.additional_properties = d
        return patched_writable_module_type_request
