...
class ASNRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, ASNRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "ASNRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        asn = (None, str(self.asn).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = ASNRequestCustomFields.from_dict(_custom_fields)
        ...
        asn_request.additional_properties = d
        return asn_request
