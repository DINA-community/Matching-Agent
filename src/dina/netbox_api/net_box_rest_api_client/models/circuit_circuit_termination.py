...
T = TypeVar("T", bound="CircuitCircuitTermination")
...
class CircuitCircuitTermination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        circuit_circuit_termination = cls(
            id=id,
            url=url,
            display_url=display_url,
            display=display,
        ...
        circuit_circuit_termination.additional_properties = d
        return circuit_circuit_termination
