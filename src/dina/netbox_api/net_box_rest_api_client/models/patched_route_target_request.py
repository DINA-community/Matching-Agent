...
if TYPE_CHECKING:
    ...
    from ..models.patched_route_target_request_custom_fields import PatchedRouteTargetRequestCustomFields
...
class PatchedRouteTargetRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedRouteTargetRequestCustomFields.from_dict(_custom_fields)
