...
from ...models.paginated_vlan_translation_policy_list import PaginatedVLANTranslationPolicyList
...
) -> Optional[PaginatedVLANTranslationPolicyList]:
    if response.status_code == 200:
        response_200 = PaginatedVLANTranslationPolicyList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedVLANTranslationPolicyList]:
    return Response(
