...
from ...models.paginated_ip_address_list import PaginatedIPAddressList
...
def _get_kwargs(
    *,
    ...
    nat_inside_id: Union[Unset, list[int]] = UNSET,
    nat_inside_id_n: Union[Unset, list[int]] = UNSET,
    ...
    role: Union[Unset, list[Union[None, str]]] = UNSET,
    role_empty: Union[Unset, bool] = UNSET,
    role_ic: Union[Unset, list[Union[None, str]]] = UNSET,
    role_ie: Union[Unset, list[Union[None, str]]] = UNSET,
    role_iew: Union[Unset, list[Union[None, str]]] = UNSET,
    role_isw: Union[Unset, list[Union[None, str]]] = UNSET,
    role_n: Union[Unset, list[Union[None, str]]] = UNSET,
    role_nic: Union[Unset, list[Union[None, str]]] = UNSET,
    role_nie: Union[Unset, list[Union[None, str]]] = UNSET,
    role_niew: Union[Unset, list[Union[None, str]]] = UNSET,
    role_nisw: Union[Unset, list[Union[None, str]]] = UNSET,
    service_id: Union[Unset, list[int]] = UNSET,
    service_id_n: Union[Unset, list[int]] = UNSET,
    ...
    json_nat_inside_id: Union[Unset, list[int]] = UNSET
    if not isinstance(nat_inside_id, Unset):
        json_nat_inside_id = nat_inside_id

    params["nat_inside_id"] = json_nat_inside_id

    json_nat_inside_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(nat_inside_id_n, Unset):
        json_nat_inside_id_n = nat_inside_id_n

    params["nat_inside_id__n"] = json_nat_inside_id_n
    ...
    json_role: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role, Unset):
        json_role = []
        for role_item_data in role:
            role_item: Union[None, str]
            role_item = role_item_data
    ...
    json_role_ic: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_ic, Unset):
        json_role_ic = []
        for role_ic_item_data in role_ic:
            role_ic_item: Union[None, str]
            role_ic_item = role_ic_item_data
            json_role_ic.append(role_ic_item)

    params["role__ic"] = json_role_ic

    json_role_ie: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_ie, Unset):
        json_role_ie = []
        for role_ie_item_data in role_ie:
            role_ie_item: Union[None, str]
            role_ie_item = role_ie_item_data
            json_role_ie.append(role_ie_item)

    params["role__ie"] = json_role_ie

    json_role_iew: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_iew, Unset):
        json_role_iew = []
        for role_iew_item_data in role_iew:
            role_iew_item: Union[None, str]
            role_iew_item = role_iew_item_data
            json_role_iew.append(role_iew_item)

    params["role__iew"] = json_role_iew

    json_role_isw: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_isw, Unset):
        json_role_isw = []
        for role_isw_item_data in role_isw:
            role_isw_item: Union[None, str]
            role_isw_item = role_isw_item_data
            json_role_isw.append(role_isw_item)

    params["role__isw"] = json_role_isw

    json_role_n: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_n, Unset):
        json_role_n = []
        for role_n_item_data in role_n:
            role_n_item: Union[None, str]
            role_n_item = role_n_item_data
            json_role_n.append(role_n_item)

    params["role__n"] = json_role_n

    json_role_nic: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_nic, Unset):
        json_role_nic = []
        for role_nic_item_data in role_nic:
            role_nic_item: Union[None, str]
            role_nic_item = role_nic_item_data
            json_role_nic.append(role_nic_item)

    params["role__nic"] = json_role_nic

    json_role_nie: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_nie, Unset):
        json_role_nie = []
        for role_nie_item_data in role_nie:
            role_nie_item: Union[None, str]
            role_nie_item = role_nie_item_data
            json_role_nie.append(role_nie_item)

    params["role__nie"] = json_role_nie

    json_role_niew: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_niew, Unset):
        json_role_niew = []
        for role_niew_item_data in role_niew:
            role_niew_item: Union[None, str]
            role_niew_item = role_niew_item_data
            json_role_niew.append(role_niew_item)

    params["role__niew"] = json_role_niew

    json_role_nisw: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(role_nisw, Unset):
        json_role_nisw = []
        for role_nisw_item_data in role_nisw:
            role_nisw_item: Union[None, str]
            role_nisw_item = role_nisw_item_data
            json_role_nisw.append(role_nisw_item)

    params["role__nisw"] = json_role_nisw

    json_service_id: Union[Unset, list[int]] = UNSET
    if not isinstance(service_id, Unset):
        json_service_id = service_id

    params["service_id"] = json_service_id

    json_service_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(service_id_n, Unset):
        json_service_id_n = service_id_n

    params["service_id__n"] = json_service_id_n
...
) -> Optional[PaginatedIPAddressList]:
    if response.status_code == 200:
        response_200 = PaginatedIPAddressList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedIPAddressList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        nat_inside_id (Union[Unset, list[int]]):
        nat_inside_id_n (Union[Unset, list[int]]):
        ...
        q (Union[Unset, str]):
        role (Union[Unset, list[Union[None, str]]]):
        role_empty (Union[Unset, bool]):
        role_ic (Union[Unset, list[Union[None, str]]]):
        role_ie (Union[Unset, list[Union[None, str]]]):
        role_iew (Union[Unset, list[Union[None, str]]]):
        role_isw (Union[Unset, list[Union[None, str]]]):
        role_n (Union[Unset, list[Union[None, str]]]):
        role_nic (Union[Unset, list[Union[None, str]]]):
        role_nie (Union[Unset, list[Union[None, str]]]):
        role_niew (Union[Unset, list[Union[None, str]]]):
        role_nisw (Union[Unset, list[Union[None, str]]]):
        service_id (Union[Unset, list[int]]):
        service_id_n (Union[Unset, list[int]]):
    ...
    kwargs = _get_kwargs(
        ...
        nat_inside_id_n=nat_inside_id_n,
        offset=offset,
        ordering=ordering,
        parent=parent,
