...
from ...models.paginated_aggregate_list import PaginatedAggregateList
...
def _get_kwargs(
    *,
    ...
    date_added: Union[Unset, list[datetime.date]] = UNSET,
    date_added_empty: Union[Unset, bool] = UNSET,
    date_added_gt: Union[Unset, list[datetime.date]] = UNSET,
    date_added_gte: Union[Unset, list[datetime.date]] = UNSET,
    date_added_lt: Union[Unset, list[datetime.date]] = UNSET,
    date_added_lte: Union[Unset, list[datetime.date]] = UNSET,
    date_added_n: Union[Unset, list[datetime.date]] = UNSET,
    ...
    json_date_added: Union[Unset, list[str]] = UNSET
    if not isinstance(date_added, Unset):
        json_date_added = []
        for date_added_item_data in date_added:
            date_added_item = date_added_item_data.isoformat()
            json_date_added.append(date_added_item)

    params["date_added"] = json_date_added

    params["date_added__empty"] = date_added_empty

    json_date_added_gt: Union[Unset, list[str]] = UNSET
    if not isinstance(date_added_gt, Unset):
        json_date_added_gt = []
        for date_added_gt_item_data in date_added_gt:
            date_added_gt_item = date_added_gt_item_data.isoformat()
            json_date_added_gt.append(date_added_gt_item)

    params["date_added__gt"] = json_date_added_gt

    json_date_added_gte: Union[Unset, list[str]] = UNSET
    if not isinstance(date_added_gte, Unset):
        json_date_added_gte = []
        for date_added_gte_item_data in date_added_gte:
            date_added_gte_item = date_added_gte_item_data.isoformat()
            json_date_added_gte.append(date_added_gte_item)

    params["date_added__gte"] = json_date_added_gte

    json_date_added_lt: Union[Unset, list[str]] = UNSET
    if not isinstance(date_added_lt, Unset):
        json_date_added_lt = []
        for date_added_lt_item_data in date_added_lt:
            date_added_lt_item = date_added_lt_item_data.isoformat()
            json_date_added_lt.append(date_added_lt_item)

    params["date_added__lt"] = json_date_added_lt

    json_date_added_lte: Union[Unset, list[str]] = UNSET
    if not isinstance(date_added_lte, Unset):
        json_date_added_lte = []
        for date_added_lte_item_data in date_added_lte:
            date_added_lte_item = date_added_lte_item_data.isoformat()
            json_date_added_lte.append(date_added_lte_item)

    params["date_added__lte"] = json_date_added_lte

    json_date_added_n: Union[Unset, list[str]] = UNSET
    if not isinstance(date_added_n, Unset):
        json_date_added_n = []
        for date_added_n_item_data in date_added_n:
            date_added_n_item = date_added_n_item_data.isoformat()
            json_date_added_n.append(date_added_n_item)

    params["date_added__n"] = json_date_added_n
...
) -> Optional[PaginatedAggregateList]:
    if response.status_code == 200:
        response_200 = PaginatedAggregateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedAggregateList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        date_added (Union[Unset, list[datetime.date]]):
        date_added_empty (Union[Unset, bool]):
        date_added_gt (Union[Unset, list[datetime.date]]):
        date_added_gte (Union[Unset, list[datetime.date]]):
        date_added_lt (Union[Unset, list[datetime.date]]):
        date_added_lte (Union[Unset, list[datetime.date]]):
        date_added_n (Union[Unset, list[datetime.date]]):
    ...
    kwargs = _get_kwargs(
        ...
        date_added_empty=date_added_empty,
