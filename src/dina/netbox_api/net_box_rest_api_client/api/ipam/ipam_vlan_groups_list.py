...
from ...models.paginated_vlan_group_list import PaginatedVLANGroupList
...
def _get_kwargs(
    *,
    ...
    cluster_group: Union[Unset, int] = UNSET,
    contains_vid: Union[Unset, float] = UNSET,
    ...
    site_group: Union[Unset, int] = UNSET,
    ...
    params["cluster_group"] = cluster_group

    params["contains_vid"] = contains_vid
...
) -> Optional[PaginatedVLANGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedVLANGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedVLANGroupList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        cluster_group (Union[Unset, int]):
        contains_vid (Union[Unset, float]):
