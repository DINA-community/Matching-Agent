...
from ...models.patched_route_target_request import PatchedRouteTargetRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedRouteTargetRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedRouteTargetRequest): Adds support for custom fields and tags.
        body (PatchedRouteTargetRequest): Adds support for custom fields and tags.
