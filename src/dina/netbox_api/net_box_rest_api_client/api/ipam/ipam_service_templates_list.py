...
from ...models.ipam_service_templates_list_protocol import IpamServiceTemplatesListProtocol
from ...models.paginated_service_template_list import PaginatedServiceTemplateList
...
def _get_kwargs(
    *,
    ...
    protocol: Union[Unset, IpamServiceTemplatesListProtocol] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/ipam/service-templates/",
        "params": params,
    }
...
) -> Optional[PaginatedServiceTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedServiceTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedServiceTemplateList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        protocol (Union[Unset, IpamServiceTemplatesListProtocol]):
        q (Union[Unset, str]):
