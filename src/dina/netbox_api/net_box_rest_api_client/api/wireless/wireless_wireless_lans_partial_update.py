...
from ...models.patched_writable_wireless_lan_request import PatchedWritableWirelessLANRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/wireless/wireless-lans/{id}/",
    }

    if isinstance(body, PatchedWritableWirelessLANRequest):
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[WirelessLAN]:
    if response.status_code == 200:
        response_200 = WirelessLAN.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableWirelessLANRequest): Adds support for custom fields and tags.
        body (PatchedWritableWirelessLANRequest): Adds support for custom fields and tags.
