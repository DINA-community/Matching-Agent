...
from ...models.paginated_event_rule_list import PaginatedEventRuleList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    action_object_id: Union[Unset, list[int]] = UNSET,
    action_object_id_empty: Union[Unset, list[int]] = UNSET,
    action_object_id_gt: Union[Unset, list[int]] = UNSET,
    action_object_id_gte: Union[Unset, list[int]] = UNSET,
    action_object_id_lt: Union[Unset, list[int]] = UNSET,
    action_object_id_lte: Union[Unset, list[int]] = UNSET,
    action_object_id_n: Union[Unset, list[int]] = UNSET,
    action_object_type: Union[Unset, str] = UNSET,
    action_object_type_n: Union[Unset, str] = UNSET,
    action_type: Union[Unset, list[str]] = UNSET,
    action_type_empty: Union[Unset, bool] = UNSET,
    action_type_ic: Union[Unset, list[str]] = UNSET,
    action_type_ie: Union[Unset, list[str]] = UNSET,
    action_type_iew: Union[Unset, list[str]] = UNSET,
    action_type_isw: Union[Unset, list[str]] = UNSET,
    action_type_n: Union[Unset, list[str]] = UNSET,
    action_type_nic: Union[Unset, list[str]] = UNSET,
    action_type_nie: Union[Unset, list[str]] = UNSET,
    action_type_niew: Union[Unset, list[str]] = UNSET,
    action_type_nisw: Union[Unset, list[str]] = UNSET,
    ...
    json_action_object_id: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id, Unset):
        json_action_object_id = action_object_id

    params["action_object_id"] = json_action_object_id

    json_action_object_id_empty: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id_empty, Unset):
        json_action_object_id_empty = action_object_id_empty

    params["action_object_id__empty"] = json_action_object_id_empty

    json_action_object_id_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id_gt, Unset):
        json_action_object_id_gt = action_object_id_gt

    params["action_object_id__gt"] = json_action_object_id_gt

    json_action_object_id_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id_gte, Unset):
        json_action_object_id_gte = action_object_id_gte

    params["action_object_id__gte"] = json_action_object_id_gte

    json_action_object_id_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id_lt, Unset):
        json_action_object_id_lt = action_object_id_lt

    params["action_object_id__lt"] = json_action_object_id_lt

    json_action_object_id_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id_lte, Unset):
        json_action_object_id_lte = action_object_id_lte

    params["action_object_id__lte"] = json_action_object_id_lte

    json_action_object_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(action_object_id_n, Unset):
        json_action_object_id_n = action_object_id_n

    params["action_object_id__n"] = json_action_object_id_n

    params["action_object_type"] = action_object_type

    params["action_object_type__n"] = action_object_type_n

    json_action_type: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type, Unset):
        json_action_type = action_type

    params["action_type"] = json_action_type

    params["action_type__empty"] = action_type_empty

    json_action_type_ic: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_ic, Unset):
        json_action_type_ic = action_type_ic

    params["action_type__ic"] = json_action_type_ic

    json_action_type_ie: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_ie, Unset):
        json_action_type_ie = action_type_ie

    params["action_type__ie"] = json_action_type_ie

    json_action_type_iew: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_iew, Unset):
        json_action_type_iew = action_type_iew

    params["action_type__iew"] = json_action_type_iew

    json_action_type_isw: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_isw, Unset):
        json_action_type_isw = action_type_isw

    params["action_type__isw"] = json_action_type_isw

    json_action_type_n: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_n, Unset):
        json_action_type_n = action_type_n

    params["action_type__n"] = json_action_type_n

    json_action_type_nic: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_nic, Unset):
        json_action_type_nic = action_type_nic

    params["action_type__nic"] = json_action_type_nic

    json_action_type_nie: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_nie, Unset):
        json_action_type_nie = action_type_nie

    params["action_type__nie"] = json_action_type_nie

    json_action_type_niew: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_niew, Unset):
        json_action_type_niew = action_type_niew

    params["action_type__niew"] = json_action_type_niew

    json_action_type_nisw: Union[Unset, list[str]] = UNSET
    if not isinstance(action_type_nisw, Unset):
        json_action_type_nisw = action_type_nisw

    params["action_type__nisw"] = json_action_type_nisw
...
) -> Optional[PaginatedEventRuleList]:
    if response.status_code == 200:
        response_200 = PaginatedEventRuleList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedEventRuleList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        action_object_id (Union[Unset, list[int]]):
        action_object_id_empty (Union[Unset, list[int]]):
        action_object_id_gt (Union[Unset, list[int]]):
        action_object_id_gte (Union[Unset, list[int]]):
        action_object_id_lt (Union[Unset, list[int]]):
        action_object_id_lte (Union[Unset, list[int]]):
        action_object_id_n (Union[Unset, list[int]]):
        action_object_type (Union[Unset, str]):
        action_object_type_n (Union[Unset, str]):
        action_type (Union[Unset, list[str]]):
        action_type_empty (Union[Unset, bool]):
        action_type_ic (Union[Unset, list[str]]):
        action_type_ie (Union[Unset, list[str]]):
        action_type_iew (Union[Unset, list[str]]):
        action_type_isw (Union[Unset, list[str]]):
        action_type_n (Union[Unset, list[str]]):
        action_type_nic (Union[Unset, list[str]]):
        action_type_nie (Union[Unset, list[str]]):
        action_type_niew (Union[Unset, list[str]]):
        action_type_nisw (Union[Unset, list[str]]):
    ...
    kwargs = _get_kwargs(
        ...
        action_object_id_empty=action_object_id_empty,
        action_object_id_gt=action_object_id_gt,
        action_object_id_gte=action_object_id_gte,
        action_object_id_lt=action_object_id_lt,
        action_object_id_lte=action_object_id_lte,
        action_object_id_n=action_object_id_n,
        action_object_type=action_object_type,
        action_object_type_n=action_object_type_n,
        action_type=action_type,
        action_type_empty=action_type_empty,
        action_type_ic=action_type_ic,
        action_type_ie=action_type_ie,
        action_type_iew=action_type_iew,
        action_type_isw=action_type_isw,
        action_type_n=action_type_n,
        action_type_nic=action_type_nic,
        action_type_nie=action_type_nie,
        action_type_niew=action_type_niew,
        action_type_nisw=action_type_nisw,
        created=created,
