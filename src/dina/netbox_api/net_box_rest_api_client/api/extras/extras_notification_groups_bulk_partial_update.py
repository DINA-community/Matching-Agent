...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/extras/notification-groups/",
    }

    if isinstance(body, list["NotificationGroupRequest"]):
        _json_body = []
...
) -> Optional[list["NotificationGroup"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = NotificationGroup.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["NotificationGroup"]]:
    return Response(
