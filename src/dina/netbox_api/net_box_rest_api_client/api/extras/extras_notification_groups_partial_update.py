...
from ...models.patched_notification_group_request import PatchedNotificationGroupRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedNotificationGroupRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedNotificationGroupRequest): Extends the built-in ModelSerializer to enforce
