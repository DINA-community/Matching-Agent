...
from ...models.extras_custom_field_choice_sets_list_base_choices import ExtrasCustomFieldChoiceSetsListBaseChoices
from ...models.paginated_custom_field_choice_set_list import PaginatedCustomFieldChoiceSetList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    base_choices: Union[Unset, ExtrasCustomFieldChoiceSetsListBaseChoices] = UNSET,
    choice: Union[Unset, list[str]] = UNSET,
    ...
    json_base_choices: Union[Unset, str] = UNSET
    if not isinstance(base_choices, Unset):
        json_base_choices = base_choices.value

    params["base_choices"] = json_base_choices

    json_choice: Union[Unset, list[str]] = UNSET
    if not isinstance(choice, Unset):
        json_choice = choice

    params["choice"] = json_choice
    ...
    params["order_alphabetically"] = order_alphabetically
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/extras/custom-field-choice-sets/",
        "params": params,
    }
...
) -> Optional[PaginatedCustomFieldChoiceSetList]:
    if response.status_code == 200:
        response_200 = PaginatedCustomFieldChoiceSetList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedCustomFieldChoiceSetList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        base_choices (Union[Unset, ExtrasCustomFieldChoiceSetsListBaseChoices]):
        choice (Union[Unset, list[str]]):
        ...
        order_alphabetically (Union[Unset, bool]):
