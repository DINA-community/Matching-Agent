...
from ...models.export_template_request import ExportTemplateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/extras/export-templates/{id}/sync/",
    }

    if isinstance(body, ExportTemplateRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (ExportTemplateRequest): Extends the built-in ModelSerializer to enforce calling
