...
def _get_kwargs(
    *,
    ...
    if isinstance(body, list["TableConfigRequest"]):
        _json_body = []
...
) -> Optional[list["TableConfig"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TableConfig.from_dict(response_200_item_data)
