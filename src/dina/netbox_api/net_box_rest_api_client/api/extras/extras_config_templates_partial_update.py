...
from ...models.patched_config_template_request import PatchedConfigTemplateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/extras/config-templates/{id}/",
    }

    if isinstance(body, PatchedConfigTemplateRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedConfigTemplateRequest): Introduces support for Tag assignment. Adds `tags`
