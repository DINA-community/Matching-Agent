...
from ...models.paginated_script_list import PaginatedScriptList
...
def _get_kwargs(
    *,
    ...
    is_executable: Union[Unset, bool] = UNSET,
    limit: Union[Unset, int] = UNSET,
    module_id: Union[Unset, list[int]] = UNSET,
    module_id_n: Union[Unset, list[int]] = UNSET,
    ...
    params["is_executable"] = is_executable

    params["limit"] = limit

    json_module_id: Union[Unset, list[int]] = UNSET
    if not isinstance(module_id, Unset):
        json_module_id = module_id

    params["module_id"] = json_module_id

    json_module_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(module_id_n, Unset):
        json_module_id_n = module_id_n
...
) -> Optional[PaginatedScriptList]:
    if response.status_code == 200:
        response_200 = PaginatedScriptList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        is_executable (Union[Unset, bool]):
        limit (Union[Unset, int]):
        module_id (Union[Unset, list[int]]):
        module_id_n (Union[Unset, list[int]]):
