...
from ...models.patched_webhook_request import PatchedWebhookRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/extras/webhooks/{id}/",
    }

    if isinstance(body, PatchedWebhookRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWebhookRequest): Adds support for custom fields and tags.
        body (PatchedWebhookRequest): Adds support for custom fields and tags.
