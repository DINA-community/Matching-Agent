...
def _get_kwargs(
    *,
    ...
    if isinstance(body, list["ImageAttachmentRequest"]):
        _json_body = []
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ImageAttachment.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        body (list['ImageAttachmentRequest']):
        body (list['ImageAttachmentRequest']):
