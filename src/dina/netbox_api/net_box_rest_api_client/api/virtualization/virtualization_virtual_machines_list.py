...
from ...models.paginated_virtual_machine_with_config_context_list import PaginatedVirtualMachineWithConfigContextList
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PaginatedVirtualMachineWithConfigContextList.from_dict(response.json())
