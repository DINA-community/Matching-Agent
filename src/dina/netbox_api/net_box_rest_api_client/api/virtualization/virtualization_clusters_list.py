...
from ...models.paginated_cluster_list import PaginatedClusterList
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/virtualization/clusters/",
        "params": params,
    }
...
) -> Optional[PaginatedClusterList]:
    if response.status_code == 200:
        response_200 = PaginatedClusterList.from_dict(response.json())
