...
from ...models.paginated_cluster_group_list import PaginatedClusterGroupList
...
) -> Optional[PaginatedClusterGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedClusterGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedClusterGroupList]:
    return Response(
