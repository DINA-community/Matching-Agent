...
from ...models.patched_token_request import PatchedTokenRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedTokenRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedTokenRequest): Extends the built-in ModelSerializer to enforce calling
