...
from ...models.dcim_racks_elevation_retrieve_render import DcimRacksElevationRetrieveRender
...
def _get_kwargs(
    ...
    *,
    ...
    render: Union[Unset, DcimRacksElevationRetrieveRender] = DcimRacksElevationRetrieveRender.JSON,
