...
from ...models.paginated_front_port_template_list import PaginatedFrontPortTemplateList
...
) -> Optional[PaginatedFrontPortTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedFrontPortTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedFrontPortTemplateList]:
    return Response(
