...
from ...models.writable_region_request import WritableRegionRequest
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, WritableRegionRequest):
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Region]:
    if response.status_code == 201:
        response_201 = Region.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (WritableRegionRequest): Extends PrimaryModelSerializer to include MPTT support.
        body (WritableRegionRequest): Extends PrimaryModelSerializer to include MPTT support.
