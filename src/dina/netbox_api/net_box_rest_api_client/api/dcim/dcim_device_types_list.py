...
from ...models.dcim_device_types_list_parentchild_status import DcimDeviceTypesListParentchildStatus
...
def _get_kwargs(
    *,
    ...
    params["console_server_port_template_count"] = json_console_server_port_template_count

    params["console_server_port_template_count__empty"] = console_server_port_template_count_empty
    ...
    if not isinstance(console_server_port_template_count_gt, Unset):
        json_console_server_port_template_count_gt = console_server_port_template_count_gt

    params["console_server_port_template_count__gt"] = json_console_server_port_template_count_gt
    ...
    if not isinstance(console_server_port_template_count_gte, Unset):
        json_console_server_port_template_count_gte = console_server_port_template_count_gte

    params["console_server_port_template_count__gte"] = json_console_server_port_template_count_gte
    ...
    if not isinstance(console_server_port_template_count_lt, Unset):
        json_console_server_port_template_count_lt = console_server_port_template_count_lt

    params["console_server_port_template_count__lt"] = json_console_server_port_template_count_lt
    ...
    if not isinstance(console_server_port_template_count_lte, Unset):
        json_console_server_port_template_count_lte = console_server_port_template_count_lte

    params["console_server_port_template_count__lte"] = json_console_server_port_template_count_lte
    ...
    params["console_server_port_template_count__n"] = json_console_server_port_template_count_n
    ...
    params["inventory_item_template_count__gte"] = json_inventory_item_template_count_gte
    ...
    params["inventory_item_template_count__lte"] = json_inventory_item_template_count_lte
