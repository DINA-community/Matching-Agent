...
from ...models.paginated_module_type_profile_list import PaginatedModuleTypeProfileList
...
) -> Optional[PaginatedModuleTypeProfileList]:
    if response.status_code == 200:
        response_200 = PaginatedModuleTypeProfileList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedModuleTypeProfileList]:
    return Response(
