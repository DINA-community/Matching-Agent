...
from ...models.paginated_site_group_list import PaginatedSiteGroupList
...
) -> Optional[PaginatedSiteGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedSiteGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedSiteGroupList]:
    return Response(
