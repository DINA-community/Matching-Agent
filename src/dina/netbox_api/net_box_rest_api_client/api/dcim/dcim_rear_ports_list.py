...
from ...models.dcim_rear_ports_list_cable_end import DcimRearPortsListCableEnd
from ...models.paginated_rear_port_list import PaginatedRearPortList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    cable_end: Union[Unset, DcimRearPortsListCableEnd] = UNSET,
...
) -> Optional[PaginatedRearPortList]:
    if response.status_code == 200:
        response_200 = PaginatedRearPortList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedRearPortList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        cable_end (Union[Unset, DcimRearPortsListCableEnd]):
