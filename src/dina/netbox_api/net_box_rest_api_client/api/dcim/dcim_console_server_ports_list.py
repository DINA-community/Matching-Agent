...
from ...models.dcim_console_server_ports_list_cable_end import DcimConsoleServerPortsListCableEnd
from ...models.dcim_console_server_ports_list_speed import DcimConsoleServerPortsListSpeed
from ...models.paginated_console_server_port_list import PaginatedConsoleServerPortList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    cable_end: Union[Unset, DcimConsoleServerPortsListCableEnd] = UNSET,
    ...
    speed: Union[Unset, DcimConsoleServerPortsListSpeed] = UNSET,
    ...
    json_speed: Union[Unset, int] = UNSET
    if not isinstance(speed, Unset):
        json_speed = speed.value
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/dcim/console-server-ports/",
        "params": params,
    }
...
) -> Optional[PaginatedConsoleServerPortList]:
    if response.status_code == 200:
        response_200 = PaginatedConsoleServerPortList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedConsoleServerPortList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        cable_end (Union[Unset, DcimConsoleServerPortsListCableEnd]):
        ...
        speed (Union[Unset, DcimConsoleServerPortsListSpeed]):
