...
from ...models.dcim_module_types_list_airflow import DcimModuleTypesListAirflow
from ...models.dcim_module_types_list_weight_unit import DcimModuleTypesListWeightUnit
...
def _get_kwargs(
    *,
    airflow: Union[Unset, DcimModuleTypesListAirflow] = UNSET,
    ...
    profile_n: Union[Unset, list[str]] = UNSET,
    profile_id: Union[Unset, list[Union[None, int]]] = UNSET,
    profile_id_n: Union[Unset, list[Union[None, int]]] = UNSET,
    ...
    weight_unit: Union[Unset, DcimModuleTypesListWeightUnit] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_profile: Union[Unset, list[str]] = UNSET
    if not isinstance(profile, Unset):
        json_profile = profile

    params["profile"] = json_profile

    json_profile_n: Union[Unset, list[str]] = UNSET
    if not isinstance(profile_n, Unset):
        json_profile_n = profile_n

    params["profile__n"] = json_profile_n

    json_profile_id: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(profile_id, Unset):
        json_profile_id = []
        for profile_id_item_data in profile_id:
            profile_id_item: Union[None, int]
            profile_id_item = profile_id_item_data
            json_profile_id.append(profile_id_item)

    params["profile_id"] = json_profile_id

    json_profile_id_n: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(profile_id_n, Unset):
        json_profile_id_n = []
        for profile_id_n_item_data in profile_id_n:
            profile_id_n_item: Union[None, int]
            profile_id_n_item = profile_id_n_item_data
            json_profile_id_n.append(profile_id_n_item)

    params["profile_id__n"] = json_profile_id_n
...
def sync_detailed(
    *,
    ...
    Args:
        airflow (Union[Unset, DcimModuleTypesListAirflow]):
        ...
        profile (Union[Unset, list[str]]):
        profile_n (Union[Unset, list[str]]):
        profile_id (Union[Unset, list[Union[None, int]]]):
        profile_id_n (Union[Unset, list[Union[None, int]]]):
        q (Union[Unset, str]):
        ...
        weight_unit (Union[Unset, DcimModuleTypesListWeightUnit]):
