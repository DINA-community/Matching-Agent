...
from ...models.paginated_device_bay_list import PaginatedDeviceBayList
...
def _get_kwargs(
    *,
    ...
    installed_device: Union[Unset, list[Union[None, str]]] = UNSET,
    installed_device_n: Union[Unset, list[Union[None, str]]] = UNSET,
    installed_device_id: Union[Unset, list[Union[None, int]]] = UNSET,
    installed_device_id_n: Union[Unset, list[Union[None, int]]] = UNSET,
    ...
    json_installed_device: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(installed_device, Unset):
        json_installed_device = []
        for installed_device_item_data in installed_device:
            installed_device_item: Union[None, str]
            installed_device_item = installed_device_item_data
            json_installed_device.append(installed_device_item)

    params["installed_device"] = json_installed_device

    json_installed_device_n: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(installed_device_n, Unset):
        json_installed_device_n = []
        for installed_device_n_item_data in installed_device_n:
            installed_device_n_item: Union[None, str]
            installed_device_n_item = installed_device_n_item_data
            json_installed_device_n.append(installed_device_n_item)

    params["installed_device__n"] = json_installed_device_n

    json_installed_device_id: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(installed_device_id, Unset):
        json_installed_device_id = []
        for installed_device_id_item_data in installed_device_id:
            installed_device_id_item: Union[None, int]
            installed_device_id_item = installed_device_id_item_data
            json_installed_device_id.append(installed_device_id_item)

    params["installed_device_id"] = json_installed_device_id

    json_installed_device_id_n: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(installed_device_id_n, Unset):
        json_installed_device_id_n = []
        for installed_device_id_n_item_data in installed_device_id_n:
            installed_device_id_n_item: Union[None, int]
            installed_device_id_n_item = installed_device_id_n_item_data
            json_installed_device_id_n.append(installed_device_id_n_item)

    params["installed_device_id__n"] = json_installed_device_id_n
...
) -> Optional[PaginatedDeviceBayList]:
    if response.status_code == 200:
        response_200 = PaginatedDeviceBayList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedDeviceBayList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        installed_device (Union[Unset, list[Union[None, str]]]):
        installed_device_n (Union[Unset, list[Union[None, str]]]):
        installed_device_id (Union[Unset, list[Union[None, int]]]):
        installed_device_id_n (Union[Unset, list[Union[None, int]]]):
    ...
    kwargs = _get_kwargs(
        ...
        installed_device_n=installed_device_n,
        installed_device_id=installed_device_id,
        installed_device_id_n=installed_device_id_n,
        label=label,
