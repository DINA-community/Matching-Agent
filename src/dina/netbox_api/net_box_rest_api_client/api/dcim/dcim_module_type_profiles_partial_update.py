...
from ...models.patched_module_type_profile_request import PatchedModuleTypeProfileRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedModuleTypeProfileRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedModuleTypeProfileRequest): Adds support for custom fields and tags.
        body (PatchedModuleTypeProfileRequest): Adds support for custom fields and tags.
