...
from ...models.patched_writable_interface_template_request import PatchedWritableInterfaceTemplateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/dcim/interface-templates/{id}/",
    }

    if isinstance(body, PatchedWritableInterfaceTemplateRequest):
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = InterfaceTemplate.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableInterfaceTemplateRequest): Extends the built-in ModelSerializer to
