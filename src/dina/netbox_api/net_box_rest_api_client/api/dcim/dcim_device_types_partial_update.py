...
from ...models.patched_writable_device_type_request import PatchedWritableDeviceTypeRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedWritableDeviceTypeRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableDeviceTypeRequest): Adds support for custom fields and tags.
        body (PatchedWritableDeviceTypeRequest): Adds support for custom fields and tags.
