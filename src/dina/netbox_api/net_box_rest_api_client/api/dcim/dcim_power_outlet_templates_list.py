...
from ...models.dcim_power_outlet_templates_list_type import DcimPowerOutletTemplatesListType
from ...models.paginated_power_outlet_template_list import PaginatedPowerOutletTemplateList
...
def _get_kwargs(
    *,
    ...
    type_: Union[Unset, DcimPowerOutletTemplatesListType] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/dcim/power-outlet-templates/",
        "params": params,
    }
...
) -> Optional[PaginatedPowerOutletTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedPowerOutletTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedPowerOutletTemplateList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        q (Union[Unset, str]):
        type_ (Union[Unset, DcimPowerOutletTemplatesListType]):
