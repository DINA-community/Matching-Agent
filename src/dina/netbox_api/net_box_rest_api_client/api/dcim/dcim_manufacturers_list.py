...
from ...models.paginated_manufacturer_list import PaginatedManufacturerList
...
) -> Optional[PaginatedManufacturerList]:
    if response.status_code == 200:
        response_200 = PaginatedManufacturerList.from_dict(response.json())
