...
from ...models.paginated_device_bay_template_list import PaginatedDeviceBayTemplateList
...
) -> Optional[PaginatedDeviceBayTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedDeviceBayTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedDeviceBayTemplateList]:
    return Response(
