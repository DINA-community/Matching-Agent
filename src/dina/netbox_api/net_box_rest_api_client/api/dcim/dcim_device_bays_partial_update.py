...
from ...models.patched_device_bay_request import PatchedDeviceBayRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/dcim/device-bays/{id}/",
    }

    if isinstance(body, PatchedDeviceBayRequest):
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[DeviceBay]:
    if response.status_code == 200:
        response_200 = DeviceBay.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedDeviceBayRequest): Adds support for custom fields and tags.
        body (PatchedDeviceBayRequest): Adds support for custom fields and tags.
