...
from ...models.dcim_console_server_port_templates_list_type import DcimConsoleServerPortTemplatesListType
from ...models.paginated_console_server_port_template_list import PaginatedConsoleServerPortTemplateList
...
def _get_kwargs(
    *,
    ...
    type_: Union[Unset, DcimConsoleServerPortTemplatesListType] = UNSET,
...
) -> Optional[PaginatedConsoleServerPortTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedConsoleServerPortTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedConsoleServerPortTemplateList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        q (Union[Unset, str]):
        type_ (Union[Unset, DcimConsoleServerPortTemplatesListType]):
