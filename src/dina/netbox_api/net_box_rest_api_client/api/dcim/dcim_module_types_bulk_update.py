...
from ...models.module_type_request import ModuleTypeRequest
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, list["ModuleTypeRequest"]):
        _json_body = []
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ModuleType.from_dict(response_200_item_data)
