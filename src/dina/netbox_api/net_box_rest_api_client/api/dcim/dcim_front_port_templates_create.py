...
from ...models.writable_front_port_template_request import WritableFrontPortTemplateRequest
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, WritableFrontPortTemplateRequest):
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = FrontPortTemplate.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (WritableFrontPortTemplateRequest): Extends the built-in ModelSerializer to enforce
