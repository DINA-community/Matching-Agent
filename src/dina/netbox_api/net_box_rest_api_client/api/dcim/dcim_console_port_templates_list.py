...
from ...models.dcim_console_port_templates_list_type import DcimConsolePortTemplatesListType
from ...models.paginated_console_port_template_list import PaginatedConsolePortTemplateList
...
def _get_kwargs(
    *,
    ...
    type_: Union[Unset, DcimConsolePortTemplatesListType] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/dcim/console-port-templates/",
        "params": params,
    }
...
) -> Optional[PaginatedConsolePortTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedConsolePortTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedConsolePortTemplateList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        q (Union[Unset, str]):
        type_ (Union[Unset, DcimConsolePortTemplatesListType]):
