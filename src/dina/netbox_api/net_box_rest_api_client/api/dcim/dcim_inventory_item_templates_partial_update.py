...
from ...models.patched_inventory_item_template_request import PatchedInventoryItemTemplateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedInventoryItemTemplateRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedInventoryItemTemplateRequest): Extends the built-in ModelSerializer to
