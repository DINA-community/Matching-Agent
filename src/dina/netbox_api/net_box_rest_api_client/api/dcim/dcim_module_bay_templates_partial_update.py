...
from ...models.patched_module_bay_template_request import PatchedModuleBayTemplateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/dcim/module-bay-templates/{id}/",
    }

    if isinstance(body, PatchedModuleBayTemplateRequest):
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ModuleBayTemplate.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedModuleBayTemplateRequest): Extends the built-in ModelSerializer to enforce
