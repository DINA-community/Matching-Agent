...
from ...models.dcim_console_ports_list_cable_end import DcimConsolePortsListCableEnd
from ...models.dcim_console_ports_list_speed import DcimConsolePortsListSpeed
from ...models.paginated_console_port_list import PaginatedConsolePortList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    cable_end: Union[Unset, DcimConsolePortsListCableEnd] = UNSET,
    ...
    speed: Union[Unset, DcimConsolePortsListSpeed] = UNSET,
...
) -> Optional[PaginatedConsolePortList]:
    if response.status_code == 200:
        response_200 = PaginatedConsolePortList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedConsolePortList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        cable_end (Union[Unset, DcimConsolePortsListCableEnd]):
        ...
        speed (Union[Unset, DcimConsolePortsListSpeed]):
