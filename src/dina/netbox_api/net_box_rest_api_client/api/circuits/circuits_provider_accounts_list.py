...
from ...models.paginated_provider_account_list import PaginatedProviderAccountList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    account: Union[Unset, list[str]] = UNSET,
    account_empty: Union[Unset, bool] = UNSET,
    account_ic: Union[Unset, list[str]] = UNSET,
    account_ie: Union[Unset, list[str]] = UNSET,
    account_iew: Union[Unset, list[str]] = UNSET,
    account_isw: Union[Unset, list[str]] = UNSET,
    account_n: Union[Unset, list[str]] = UNSET,
    account_nic: Union[Unset, list[str]] = UNSET,
    account_nie: Union[Unset, list[str]] = UNSET,
    account_niew: Union[Unset, list[str]] = UNSET,
    account_nisw: Union[Unset, list[str]] = UNSET,
    ...
    json_account: Union[Unset, list[str]] = UNSET
    if not isinstance(account, Unset):
        json_account = account

    params["account"] = json_account

    params["account__empty"] = account_empty

    json_account_ic: Union[Unset, list[str]] = UNSET
    if not isinstance(account_ic, Unset):
        json_account_ic = account_ic

    params["account__ic"] = json_account_ic

    json_account_ie: Union[Unset, list[str]] = UNSET
    if not isinstance(account_ie, Unset):
        json_account_ie = account_ie

    params["account__ie"] = json_account_ie

    json_account_iew: Union[Unset, list[str]] = UNSET
    if not isinstance(account_iew, Unset):
        json_account_iew = account_iew

    params["account__iew"] = json_account_iew

    json_account_isw: Union[Unset, list[str]] = UNSET
    if not isinstance(account_isw, Unset):
        json_account_isw = account_isw

    params["account__isw"] = json_account_isw

    json_account_n: Union[Unset, list[str]] = UNSET
    if not isinstance(account_n, Unset):
        json_account_n = account_n

    params["account__n"] = json_account_n

    json_account_nic: Union[Unset, list[str]] = UNSET
    if not isinstance(account_nic, Unset):
        json_account_nic = account_nic

    params["account__nic"] = json_account_nic

    json_account_nie: Union[Unset, list[str]] = UNSET
    if not isinstance(account_nie, Unset):
        json_account_nie = account_nie

    params["account__nie"] = json_account_nie

    json_account_niew: Union[Unset, list[str]] = UNSET
    if not isinstance(account_niew, Unset):
        json_account_niew = account_niew

    params["account__niew"] = json_account_niew

    json_account_nisw: Union[Unset, list[str]] = UNSET
    if not isinstance(account_nisw, Unset):
        json_account_nisw = account_nisw

    params["account__nisw"] = json_account_nisw
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/circuits/provider-accounts/",
        "params": params,
    }
...
) -> Optional[PaginatedProviderAccountList]:
    if response.status_code == 200:
        response_200 = PaginatedProviderAccountList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedProviderAccountList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        account (Union[Unset, list[str]]):
        account_empty (Union[Unset, bool]):
        account_ic (Union[Unset, list[str]]):
        account_ie (Union[Unset, list[str]]):
        account_iew (Union[Unset, list[str]]):
        account_isw (Union[Unset, list[str]]):
        account_n (Union[Unset, list[str]]):
        account_nic (Union[Unset, list[str]]):
        account_nie (Union[Unset, list[str]]):
        account_niew (Union[Unset, list[str]]):
        account_nisw (Union[Unset, list[str]]):
