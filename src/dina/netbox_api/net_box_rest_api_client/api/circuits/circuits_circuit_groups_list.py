...
from ...models.paginated_circuit_group_list import PaginatedCircuitGroupList
...
) -> Optional[PaginatedCircuitGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedCircuitGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedCircuitGroupList]:
    return Response(
