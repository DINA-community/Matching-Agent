...
from ...models.paginated_virtual_circuit_type_list import PaginatedVirtualCircuitTypeList
...
) -> Optional[PaginatedVirtualCircuitTypeList]:
    if response.status_code == 200:
        response_200 = PaginatedVirtualCircuitTypeList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedVirtualCircuitTypeList]:
    return Response(
