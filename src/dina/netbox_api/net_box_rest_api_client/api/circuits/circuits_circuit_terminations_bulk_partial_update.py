...
def _get_kwargs(
    *,
    body: Union[
        list["CircuitTerminationRequest"],
        list["CircuitTerminationRequest"],
    ],
) -> dict[str, Any]:
    ...
    if isinstance(body, list["CircuitTerminationRequest"]):
        _json_body = []
...
) -> Optional[list["CircuitTermination"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CircuitTermination.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["CircuitTermination"]]:
    return Response(
