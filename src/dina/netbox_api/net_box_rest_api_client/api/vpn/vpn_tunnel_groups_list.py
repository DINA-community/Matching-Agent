...
from ...models.paginated_tunnel_group_list import PaginatedTunnelGroupList
...
) -> Optional[PaginatedTunnelGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedTunnelGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedTunnelGroupList]:
    return Response(
