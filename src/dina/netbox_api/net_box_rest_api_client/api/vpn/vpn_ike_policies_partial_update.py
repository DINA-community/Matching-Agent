...
from ...models.patched_writable_ike_policy_request import PatchedWritableIKEPolicyRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/vpn/ike-policies/{id}/",
    }

    if isinstance(body, PatchedWritableIKEPolicyRequest):
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[IKEPolicy]:
    if response.status_code == 200:
        response_200 = IKEPolicy.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableIKEPolicyRequest): Adds support for custom fields and tags.
        body (PatchedWritableIKEPolicyRequest): Adds support for custom fields and tags.
