...
from ...models.patched_writable_ip_sec_profile_request import PatchedWritableIPSecProfileRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/vpn/ipsec-profiles/{id}/",
    }

    if isinstance(body, PatchedWritableIPSecProfileRequest):
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[IPSecProfile]:
    if response.status_code == 200:
        response_200 = IPSecProfile.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableIPSecProfileRequest): Adds support for custom fields and tags.
        body (PatchedWritableIPSecProfileRequest): Adds support for custom fields and tags.
