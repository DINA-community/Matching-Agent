...
from ...models.patched_writable_ip_sec_proposal_request import PatchedWritableIPSecProposalRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedWritableIPSecProposalRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableIPSecProposalRequest): Adds support for custom fields and tags.
        body (PatchedWritableIPSecProposalRequest): Adds support for custom fields and tags.
