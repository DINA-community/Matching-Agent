...
from ...models.paginated_tunnel_list import PaginatedTunnelList
...
def _get_kwargs(
    *,
    ...
    encapsulation: Union[Unset, list[str]] = UNSET,
    encapsulation_empty: Union[Unset, bool] = UNSET,
    encapsulation_ic: Union[Unset, list[str]] = UNSET,
    encapsulation_ie: Union[Unset, list[str]] = UNSET,
    encapsulation_iew: Union[Unset, list[str]] = UNSET,
    encapsulation_isw: Union[Unset, list[str]] = UNSET,
    encapsulation_n: Union[Unset, list[str]] = UNSET,
    encapsulation_nic: Union[Unset, list[str]] = UNSET,
    encapsulation_nie: Union[Unset, list[str]] = UNSET,
    encapsulation_niew: Union[Unset, list[str]] = UNSET,
    encapsulation_nisw: Union[Unset, list[str]] = UNSET,
    ...
    ipsec_profile: Union[Unset, list[str]] = UNSET,
    ipsec_profile_n: Union[Unset, list[str]] = UNSET,
    ipsec_profile_id: Union[Unset, list[Union[None, int]]] = UNSET,
    ipsec_profile_id_n: Union[Unset, list[Union[None, int]]] = UNSET,
    ...
    tunnel_id_empty: Union[Unset, bool] = UNSET,
    tunnel_id_gt: Union[Unset, list[int]] = UNSET,
    tunnel_id_gte: Union[Unset, list[int]] = UNSET,
    tunnel_id_lt: Union[Unset, list[int]] = UNSET,
    tunnel_id_lte: Union[Unset, list[int]] = UNSET,
    ...
    json_encapsulation: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation, Unset):
        json_encapsulation = encapsulation

    params["encapsulation"] = json_encapsulation

    params["encapsulation__empty"] = encapsulation_empty

    json_encapsulation_ic: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_ic, Unset):
        json_encapsulation_ic = encapsulation_ic

    params["encapsulation__ic"] = json_encapsulation_ic

    json_encapsulation_ie: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_ie, Unset):
        json_encapsulation_ie = encapsulation_ie

    params["encapsulation__ie"] = json_encapsulation_ie

    json_encapsulation_iew: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_iew, Unset):
        json_encapsulation_iew = encapsulation_iew

    params["encapsulation__iew"] = json_encapsulation_iew

    json_encapsulation_isw: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_isw, Unset):
        json_encapsulation_isw = encapsulation_isw

    params["encapsulation__isw"] = json_encapsulation_isw

    json_encapsulation_n: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_n, Unset):
        json_encapsulation_n = encapsulation_n

    params["encapsulation__n"] = json_encapsulation_n

    json_encapsulation_nic: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_nic, Unset):
        json_encapsulation_nic = encapsulation_nic

    params["encapsulation__nic"] = json_encapsulation_nic

    json_encapsulation_nie: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_nie, Unset):
        json_encapsulation_nie = encapsulation_nie

    params["encapsulation__nie"] = json_encapsulation_nie

    json_encapsulation_niew: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_niew, Unset):
        json_encapsulation_niew = encapsulation_niew

    params["encapsulation__niew"] = json_encapsulation_niew

    json_encapsulation_nisw: Union[Unset, list[str]] = UNSET
    if not isinstance(encapsulation_nisw, Unset):
        json_encapsulation_nisw = encapsulation_nisw

    params["encapsulation__nisw"] = json_encapsulation_nisw
    ...
    json_ipsec_profile: Union[Unset, list[str]] = UNSET
    if not isinstance(ipsec_profile, Unset):
        json_ipsec_profile = ipsec_profile

    params["ipsec_profile"] = json_ipsec_profile

    json_ipsec_profile_n: Union[Unset, list[str]] = UNSET
    if not isinstance(ipsec_profile_n, Unset):
        json_ipsec_profile_n = ipsec_profile_n

    params["ipsec_profile__n"] = json_ipsec_profile_n

    json_ipsec_profile_id: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(ipsec_profile_id, Unset):
        json_ipsec_profile_id = []
        for ipsec_profile_id_item_data in ipsec_profile_id:
            ipsec_profile_id_item: Union[None, int]
            ipsec_profile_id_item = ipsec_profile_id_item_data
            json_ipsec_profile_id.append(ipsec_profile_id_item)

    params["ipsec_profile_id"] = json_ipsec_profile_id

    json_ipsec_profile_id_n: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(ipsec_profile_id_n, Unset):
        json_ipsec_profile_id_n = []
        for ipsec_profile_id_n_item_data in ipsec_profile_id_n:
            ipsec_profile_id_n_item: Union[None, int]
            ipsec_profile_id_n_item = ipsec_profile_id_n_item_data
            json_ipsec_profile_id_n.append(ipsec_profile_id_n_item)

    params["ipsec_profile_id__n"] = json_ipsec_profile_id_n
    ...
    params["tunnel_id__empty"] = tunnel_id_empty

    json_tunnel_id_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(tunnel_id_gt, Unset):
        json_tunnel_id_gt = tunnel_id_gt

    params["tunnel_id__gt"] = json_tunnel_id_gt

    json_tunnel_id_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(tunnel_id_gte, Unset):
        json_tunnel_id_gte = tunnel_id_gte

    params["tunnel_id__gte"] = json_tunnel_id_gte

    json_tunnel_id_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(tunnel_id_lt, Unset):
        json_tunnel_id_lt = tunnel_id_lt

    params["tunnel_id__lt"] = json_tunnel_id_lt

    json_tunnel_id_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(tunnel_id_lte, Unset):
        json_tunnel_id_lte = tunnel_id_lte

    params["tunnel_id__lte"] = json_tunnel_id_lte
...
) -> Optional[PaginatedTunnelList]:
    if response.status_code == 200:
        response_200 = PaginatedTunnelList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        encapsulation (Union[Unset, list[str]]):
        encapsulation_empty (Union[Unset, bool]):
        encapsulation_ic (Union[Unset, list[str]]):
        encapsulation_ie (Union[Unset, list[str]]):
        encapsulation_iew (Union[Unset, list[str]]):
        encapsulation_isw (Union[Unset, list[str]]):
        encapsulation_n (Union[Unset, list[str]]):
        encapsulation_nic (Union[Unset, list[str]]):
        encapsulation_nie (Union[Unset, list[str]]):
        encapsulation_niew (Union[Unset, list[str]]):
        encapsulation_nisw (Union[Unset, list[str]]):
        ...
        ipsec_profile (Union[Unset, list[str]]):
        ipsec_profile_n (Union[Unset, list[str]]):
        ipsec_profile_id (Union[Unset, list[Union[None, int]]]):
        ipsec_profile_id_n (Union[Unset, list[Union[None, int]]]):
        ...
        tunnel_id_empty (Union[Unset, bool]):
        tunnel_id_gt (Union[Unset, list[int]]):
        tunnel_id_gte (Union[Unset, list[int]]):
        tunnel_id_lt (Union[Unset, list[int]]):
        tunnel_id_lte (Union[Unset, list[int]]):
    ...
    kwargs = _get_kwargs(
        ...
        encapsulation_empty=encapsulation_empty,
        encapsulation_ic=encapsulation_ic,
        encapsulation_ie=encapsulation_ie,
        encapsulation_iew=encapsulation_iew,
        encapsulation_isw=encapsulation_isw,
        encapsulation_n=encapsulation_n,
        encapsulation_nic=encapsulation_nic,
        encapsulation_nie=encapsulation_nie,
        encapsulation_niew=encapsulation_niew,
        encapsulation_nisw=encapsulation_nisw,
        group=group,
        group_n=group_n,
        group_id=group_id,
        ...
        ipsec_profile_n=ipsec_profile_n,
        ipsec_profile_id=ipsec_profile_id,
        ipsec_profile_id_n=ipsec_profile_id_n,
        ...
        tunnel_id=tunnel_id,
        tunnel_id_empty=tunnel_id_empty,
        tunnel_id_gt=tunnel_id_gt,
        tunnel_id_gte=tunnel_id_gte,
        tunnel_id_lt=tunnel_id_lt,
        tunnel_id_lte=tunnel_id_lte,
