...
from ...models.paginated_tenant_group_list import PaginatedTenantGroupList
...
) -> Optional[PaginatedTenantGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedTenantGroupList.from_dict(response.json())
