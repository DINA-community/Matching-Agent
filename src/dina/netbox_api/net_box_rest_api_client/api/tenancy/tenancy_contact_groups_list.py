...
from ...models.paginated_contact_group_list import PaginatedContactGroupList
...
) -> Optional[PaginatedContactGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedContactGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedContactGroupList]:
    return Response(
