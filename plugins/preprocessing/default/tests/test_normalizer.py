...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("<V4.2.5015", Standards.VLS),
        ("grafana-0:5.2.4-6.el7rhgs.src", Standards.RPM),
        ("22.1.4_2024-11-11_Hot_Fix", Standards.FREETEXT),
        ("< 3.12.0", Standards.VLS),
        ("> 3.12.0", Standards.VLS),
        (">= 3.12.0", Standards.VLS),
        ("vers:all/*", Standards.VERS),
        ("vers:all/<V3.1.2.1", Standards.VERS),
        ("<=3.4.2.2.6", Standards.VLS),
        ("0.81", Standards.SAP),
        ("R15B_PC4", Standards.ERICSSON_RELEASE_SCHEMA),
        ("22.04", Standards.CALVER),
        ("V6 + SP9 + Upd2", Standards.SAP),
        ("6.+.9.+.2", Standards.WILDCARD),
        ("1.0.post1", Standards.PEP440),
        ("1.0a1", Standards.PEP440),
        ("1:2.31.1-0ubuntu9.9", Standards.DEB),
        (">=0.68|<=0.80", Standards.VLS),
        ("vers:pypi/>=1.0,<2.0|>=2.0", Standards.VERS),
        ("vers:pypi/>=1.0|<2.0", Standards.VERS),
        ("vers:pypi/1.5", Standards.VERS),
        ("5.1.106.0", Standards.PEP440),
        ("1.3.4", Standards.SEMVER),
        ("R15B", Standards.ERICSSON_RELEASE_SCHEMA),
        ("R17A_SP3", Standards.ERICSSON_RELEASE_SCHEMA),
        ("2024.11.11", Standards.CALVER),
        ("nginx-1:1.18.0-1.amd64.rpm", Standards.RPM),
        ("v4.2sp3", Standards.SAP),
        ("R18C_MR2", Standards.ERICSSON_RELEASE_SCHEMA),
        ("0.81.0", Standards.SEMVER),
        ("2.1.0rc2", Standards.PEP440),
        ("1.0.dev2", Standards.PEP440),
        ("6.+.9", Standards.WILDCARD),
        ("+.1", Standards.WILDCARD),
        ("2.31.1-1", Standards.SEMVER),
        ("random-string", Standards.FREETEXT),
        ("7 sp2", Standards.SAP),
        ("All versions < V5.7 SP1 HF1", Standards.FREETEXT),
        ("13", Standards.SAP),
        ("<V3.0", Standards.VLS),
        ("14 Sp1", Standards.SAP),
        ("21.0.0.0", Standards.PEP440),
        ("1.0.0-0.3.7", Standards.SEMVER),
        ("1.0.0-alpha", Standards.SEMVER),
        ("1.0.0-alpha.1", Standards.SEMVER),
        ("1.0.0-x.7.z.92", Standards.SEMVER),
        ("1.0.0-x-y-z.-", Standards.SEMVER),
        ("1.0.0+20130313144700", Standards.SEMVER),
        ("1.0.0+21AF26D3--117B344092BD", Standards.SEMVER),
        ("1.0.0-alpha+001", Standards.SEMVER),
        ("1.0.0-beta+exp.sha.5114f85", Standards.SEMVER),
    ],
)
