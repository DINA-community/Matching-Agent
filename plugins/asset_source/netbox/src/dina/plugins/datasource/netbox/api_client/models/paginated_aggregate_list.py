...
T = TypeVar("T", bound="PaginatedAggregateList")
...
class PaginatedAggregateList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Aggregate.from_dict(results_item_data)
        ...
        paginated_aggregate_list.additional_properties = d
        return paginated_aggregate_list
