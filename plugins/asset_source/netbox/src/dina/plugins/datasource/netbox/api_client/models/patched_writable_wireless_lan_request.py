...
class PatchedWritableWirelessLANRequest:
    ...
    auth_type: Union[
        None, PatchedWritableWirelessLANRequestAuthenticationType, Unset
    ] = UNSET
    auth_cipher: Union[
        None, PatchedWritableWirelessLANRequestAuthenticationCipher, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.auth_type, Unset):
            ...
            self.auth_type, PatchedWritableWirelessLANRequestAuthenticationType
        ):
        ...
        if isinstance(self.auth_cipher, Unset):
            ...
            self.auth_cipher, PatchedWritableWirelessLANRequestAuthenticationCipher
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_auth_type(
            data: object,
        ) -> Union[None, PatchedWritableWirelessLANRequestAuthenticationType, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_1 = PatchedWritableWirelessLANRequestAuthenticationType(
                    data
                )
            ...
            try:
                ...
                auth_type_type_2_type_1 = (
                    PatchedWritableWirelessLANRequestAuthenticationType(data)
                )
        ...
        def _parse_auth_cipher(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_1 = (
                    PatchedWritableWirelessLANRequestAuthenticationCipher(data)
                )
