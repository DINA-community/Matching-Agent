...
T = TypeVar("T", bound="PaginatedObjectPermissionList")
...
class PaginatedObjectPermissionList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ObjectPermission.from_dict(results_item_data)
        ...
        paginated_object_permission_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_object_permission_list.additional_properties = d
        return paginated_object_permission_list
