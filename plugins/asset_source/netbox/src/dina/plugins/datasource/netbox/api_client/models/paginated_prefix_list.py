...
T = TypeVar("T", bound="PaginatedPrefixList")
...
class PaginatedPrefixList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Prefix.from_dict(results_item_data)
        ...
        paginated_prefix_list.additional_properties = d
        return paginated_prefix_list
