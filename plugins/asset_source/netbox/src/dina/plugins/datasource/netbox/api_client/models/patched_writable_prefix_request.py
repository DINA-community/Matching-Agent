...
from ..models.patched_writable_prefix_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_prefix_request_custom_fields import (
...
class PatchedWritablePrefixRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        prefix = (
            ...
            else (None, str(self.prefix).encode(), "text/plain")
        )
        ...
        is_pool = (
            self.is_pool
            if isinstance(self.is_pool, Unset)
            else (None, str(self.is_pool).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritablePrefixRequestCustomFields.from_dict(
                _custom_fields
            )
