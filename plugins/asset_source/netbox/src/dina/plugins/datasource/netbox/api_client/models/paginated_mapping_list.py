...
T = TypeVar("T", bound="PaginatedMappingList")


@_attrs_define
class PaginatedMappingList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Mapping.from_dict(results_item_data)
        ...
        paginated_mapping_list.additional_properties = d
        return paginated_mapping_list
