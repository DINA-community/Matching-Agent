...
from ..models.patched_writable_site_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_site_request_custom_fields import (
...
class PatchedWritableSiteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableSiteRequestCustomFields.from_dict(
                _custom_fields
            )
