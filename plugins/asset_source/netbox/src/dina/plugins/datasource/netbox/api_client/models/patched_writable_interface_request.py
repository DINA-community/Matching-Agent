...
from ..models.patched_writable_interface_request_duplex_type_1 import (
...
from ..models.patched_writable_interface_request_mode_type_1 import (
    PatchedWritableInterfaceRequestModeType1,
)
from ..models.patched_writable_interface_request_mode_type_2_type_1 import (
    PatchedWritableInterfaceRequestModeType2Type1,
)
from ..models.patched_writable_interface_request_mode_type_3_type_1 import (
    PatchedWritableInterfaceRequestModeType3Type1,
)
from ..models.patched_writable_interface_request_poe_mode_type_1 import (
...
from ..models.patched_writable_interface_request_poe_type_type_1 import (
...
from ..models.patched_writable_interface_request_type import (
    PatchedWritableInterfaceRequestType,
)
from ..models.patched_writable_interface_request_wireless_channel import (
    PatchedWritableInterfaceRequestWirelessChannel,
)
from ..models.patched_writable_interface_request_wireless_role import (
...
class PatchedWritableInterfaceRequest:
    ...
    rf_channel: Union[None, PatchedWritableInterfaceRequestWirelessChannel, Unset] = (
        UNSET
    )
    poe_mode: Union[
        None,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.rf_channel, Unset):
            ...
            self.rf_channel, PatchedWritableInterfaceRequestWirelessChannel
        ):
        ...
        if isinstance(self.poe_mode, Unset):
            ...
            self.poe_mode, PatchedWritableInterfaceRequestPoeModeType2Type1
        ):
            poe_mode = self.poe_mode.value
        elif isinstance(
            self.poe_mode, PatchedWritableInterfaceRequestPoeModeType3Type1
        ):
            poe_mode = self.poe_mode.value
        else:
        ...
        if isinstance(self.poe_type, Unset):
            ...
            self.poe_type, PatchedWritableInterfaceRequestPoeTypeType2Type1
        ):
            poe_type = self.poe_type.value
        elif isinstance(
            self.poe_type, PatchedWritableInterfaceRequestPoeTypeType3Type1
        ):
            poe_type = self.poe_type.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_duplex(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_2_type_1 = PatchedWritableInterfaceRequestDuplexType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_3_type_1 = PatchedWritableInterfaceRequestDuplexType3Type1(
                    data
                )
        ...
        def _parse_rf_role(
            data: object,
        ) -> Union[None, PatchedWritableInterfaceRequestWirelessRole, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_2_type_1 = PatchedWritableInterfaceRequestWirelessRole(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_3_type_1 = PatchedWritableInterfaceRequestWirelessRole(
                    data
                )
                ...
                pass
            return cast(
                Union[None, PatchedWritableInterfaceRequestWirelessRole, Unset], data
            )
        ...
        def _parse_rf_channel(
            data: object,
        ) -> Union[None, PatchedWritableInterfaceRequestWirelessChannel, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_channel_type_2_type_1 = (
                    PatchedWritableInterfaceRequestWirelessChannel(data)
                )
            ...
            try:
                ...
                pass
            return cast(
                Union[None, PatchedWritableInterfaceRequestWirelessChannel, Unset], data
            )
        ...
        def _parse_poe_mode(
            ...
            try:
                ...
                poe_mode_type_2_type_1 = (
                    PatchedWritableInterfaceRequestPoeModeType2Type1(data)
                )
            ...
            try:
                ...
                poe_mode_type_3_type_1 = (
                    PatchedWritableInterfaceRequestPoeModeType3Type1(data)
                )
        ...
        def _parse_poe_type(
            ...
            try:
                ...
                poe_type_type_2_type_1 = (
                    PatchedWritableInterfaceRequestPoeTypeType2Type1(data)
                )
            ...
            try:
                ...
                poe_type_type_3_type_1 = (
                    PatchedWritableInterfaceRequestPoeTypeType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableInterfaceRequestCustomFields.from_dict(
                _custom_fields
            )
