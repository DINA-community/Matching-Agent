...
from ..models.writable_rack_type_request_form_factor import (
    WritableRackTypeRequestFormFactor,
)
from ..models.writable_rack_type_request_outer_unit_type_1 import (
    WritableRackTypeRequestOuterUnitType1,
)
from ..models.writable_rack_type_request_outer_unit_type_2_type_1 import (
    WritableRackTypeRequestOuterUnitType2Type1,
)
from ..models.writable_rack_type_request_outer_unit_type_3_type_1 import (
    WritableRackTypeRequestOuterUnitType3Type1,
)
from ..models.writable_rack_type_request_weight_unit_type_1 import (
    WritableRackTypeRequestWeightUnitType1,
)
from ..models.writable_rack_type_request_weight_unit_type_2_type_1 import (
    WritableRackTypeRequestWeightUnitType2Type1,
)
from ..models.writable_rack_type_request_weight_unit_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_rack_type_request_custom_fields import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_outer_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_2_type_1 = WritableRackTypeRequestOuterUnitType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_3_type_1 = WritableRackTypeRequestOuterUnitType3Type1(
                    data
                )
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = WritableRackTypeRequestWeightUnitType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = WritableRackTypeRequestWeightUnitType3Type1(
                    data
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableRackTypeRequestCustomFields.from_dict(
                _custom_fields
            )
