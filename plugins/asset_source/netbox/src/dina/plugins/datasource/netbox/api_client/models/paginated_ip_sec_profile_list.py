...
T = TypeVar("T", bound="PaginatedIPSecProfileList")
...
class PaginatedIPSecProfileList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IPSecProfile.from_dict(results_item_data)
        ...
        paginated_ip_sec_profile_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ip_sec_profile_list.additional_properties = d
        return paginated_ip_sec_profile_list
