...
from ..models.writable_wireless_link_request_authentication_type import (
    WritableWirelessLinkRequestAuthenticationType,
)
from ..models.writable_wireless_link_request_distance_unit_type_1 import (
...
from ..models.writable_wireless_link_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_wireless_link_request_custom_fields import (
...
class WritableWirelessLinkRequest:
    ...
    auth_cipher: Union[None, Unset, WritableWirelessLinkRequestAuthenticationCipher] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.auth_cipher, Unset):
            ...
            self.auth_cipher, WritableWirelessLinkRequestAuthenticationCipher
        ):
        ...
        if isinstance(self.distance_unit, Unset):
            ...
            self.distance_unit, WritableWirelessLinkRequestDistanceUnitType1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, WritableWirelessLinkRequestDistanceUnitType2Type1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, WritableWirelessLinkRequestDistanceUnitType3Type1
        ):
            distance_unit = self.distance_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.interface_a, int):
            ...
            interface_a = (
                None,
                json.dumps(self.interface_a.to_dict()).encode(),
                "application/json",
            )
        ...
        if isinstance(self.interface_b, int):
            ...
            interface_b = (
                None,
                json.dumps(self.interface_b.to_dict()).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_auth_type(
            data: object,
        ) -> Union[None, Unset, WritableWirelessLinkRequestAuthenticationType]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_2_type_1 = WritableWirelessLinkRequestAuthenticationType(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_3_type_1 = WritableWirelessLinkRequestAuthenticationType(
                    data
                )
                ...
                pass
            return cast(
                Union[None, Unset, WritableWirelessLinkRequestAuthenticationType], data
            )
        ...
        def _parse_auth_cipher(
            data: object,
        ) -> Union[None, Unset, WritableWirelessLinkRequestAuthenticationCipher]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_1 = WritableWirelessLinkRequestAuthenticationCipher(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_2_type_1 = (
                    WritableWirelessLinkRequestAuthenticationCipher(data)
                )
        ...
        def _parse_distance_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_1 = WritableWirelessLinkRequestDistanceUnitType1(
                    data
                )
            ...
            try:
                ...
                distance_unit_type_2_type_1 = (
                    WritableWirelessLinkRequestDistanceUnitType2Type1(data)
                )
            ...
            try:
                ...
                distance_unit_type_3_type_1 = (
                    WritableWirelessLinkRequestDistanceUnitType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableWirelessLinkRequestCustomFields.from_dict(
                _custom_fields
            )
