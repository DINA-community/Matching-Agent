...
T = TypeVar("T", bound="PaginatedProviderNetworkList")
...
class PaginatedProviderNetworkList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProviderNetwork.from_dict(results_item_data)
        ...
        paginated_provider_network_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_provider_network_list.additional_properties = d
        return paginated_provider_network_list
