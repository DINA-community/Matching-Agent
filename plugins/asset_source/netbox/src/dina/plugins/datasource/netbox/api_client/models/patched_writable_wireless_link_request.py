...
class PatchedWritableWirelessLinkRequest:
    ...
    auth_type: Union[
        None, PatchedWritableWirelessLinkRequestAuthenticationType, Unset
    ] = UNSET
    auth_cipher: Union[
        None, PatchedWritableWirelessLinkRequestAuthenticationCipher, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.auth_type, Unset):
            ...
            self.auth_type, PatchedWritableWirelessLinkRequestAuthenticationType
        ):
        ...
        if isinstance(self.auth_cipher, Unset):
            ...
            self.auth_cipher, PatchedWritableWirelessLinkRequestAuthenticationCipher
        ):
        ...
        if isinstance(self.distance_unit, Unset):
            ...
            self.distance_unit, PatchedWritableWirelessLinkRequestDistanceUnitType1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, PatchedWritableWirelessLinkRequestDistanceUnitType2Type1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, PatchedWritableWirelessLinkRequestDistanceUnitType3Type1
        ):
            distance_unit = self.distance_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_interface_a(
            data: object,
        ) -> Union["BriefInterfaceRequest", Unset, int]:
        ...
        def _parse_auth_type(
            data: object,
        ) -> Union[None, PatchedWritableWirelessLinkRequestAuthenticationType, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_1 = PatchedWritableWirelessLinkRequestAuthenticationType(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_2_type_1 = (
                    PatchedWritableWirelessLinkRequestAuthenticationType(data)
                )
        ...
        def _parse_auth_cipher(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_1 = (
                    PatchedWritableWirelessLinkRequestAuthenticationCipher(data)
                )
        ...
        def _parse_distance_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_1 = (
                    PatchedWritableWirelessLinkRequestDistanceUnitType1(data)
                )
            ...
            try:
                ...
                distance_unit_type_2_type_1 = (
                    PatchedWritableWirelessLinkRequestDistanceUnitType2Type1(data)
                )
            ...
            try:
                ...
                distance_unit_type_3_type_1 = (
                    PatchedWritableWirelessLinkRequestDistanceUnitType3Type1(data)
                )
