...
from ..models.patched_fhrp_group_request_authentication_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_fhrp_group_request_custom_fields import (
...
class PatchedFHRPGroupRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_auth_type(
            data: object,
        ) -> Union[None, PatchedFHRPGroupRequestAuthenticationType, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_2_type_1 = PatchedFHRPGroupRequestAuthenticationType(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_3_type_1 = PatchedFHRPGroupRequestAuthenticationType(
                    data
                )
                ...
                pass
            return cast(
                Union[None, PatchedFHRPGroupRequestAuthenticationType, Unset], data
            )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedFHRPGroupRequestCustomFields.from_dict(
                _custom_fields
            )
