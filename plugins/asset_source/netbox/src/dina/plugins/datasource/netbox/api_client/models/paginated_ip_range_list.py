...
T = TypeVar("T", bound="PaginatedIPRangeList")
...
class PaginatedIPRangeList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IPRange.from_dict(results_item_data)
        ...
        paginated_ip_range_list.additional_properties = d
        return paginated_ip_range_list
