...
from ...models.paginated_provider_list import PaginatedProviderList
...
) -> Optional[PaginatedProviderList]:
    if response.status_code == 200:
        response_200 = PaginatedProviderList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedProviderList]:
    return Response(
