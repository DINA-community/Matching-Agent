...
from ..models.patched_writable_module_type_request_airflow_type_1 import (
...
class PatchedWritableModuleTypeRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.airflow, Unset):
            ...
            self.airflow, PatchedWritableModuleTypeRequestAirflowType2Type1
        ):
            airflow = self.airflow.value
        elif isinstance(
            self.airflow, PatchedWritableModuleTypeRequestAirflowType3Type1
        ):
            airflow = self.airflow.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            ...
            self.weight_unit, PatchedWritableModuleTypeRequestWeightUnitType1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableModuleTypeRequestWeightUnitType2Type1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableModuleTypeRequestWeightUnitType3Type1
        ):
            weight_unit = self.weight_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_2_type_1 = (
                    PatchedWritableModuleTypeRequestAirflowType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_3_type_1 = (
                    PatchedWritableModuleTypeRequestAirflowType3Type1(data)
                )
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_1 = PatchedWritableModuleTypeRequestWeightUnitType1(
                    data
                )
            ...
            try:
                ...
                weight_unit_type_2_type_1 = (
                    PatchedWritableModuleTypeRequestWeightUnitType2Type1(data)
                )
            ...
            try:
                ...
                weight_unit_type_3_type_1 = (
                    PatchedWritableModuleTypeRequestWeightUnitType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableModuleTypeRequestCustomFields.from_dict(
                _custom_fields
            )
