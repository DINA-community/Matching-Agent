...
from ...models.paginated_virtual_disk_list import PaginatedVirtualDiskList
...
) -> Optional[PaginatedVirtualDiskList]:
    if response.status_code == 200:
        response_200 = PaginatedVirtualDiskList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedVirtualDiskList]:
    return Response(
