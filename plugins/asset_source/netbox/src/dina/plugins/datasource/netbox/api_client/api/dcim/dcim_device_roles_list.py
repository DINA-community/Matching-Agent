...
from ...models.paginated_device_role_list import PaginatedDeviceRoleList
...
) -> Optional[PaginatedDeviceRoleList]:
    if response.status_code == 200:
        response_200 = PaginatedDeviceRoleList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedDeviceRoleList]:
    return Response(
