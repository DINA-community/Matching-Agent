...
from ..models.patched_writable_tunnel_termination_request_role import (
...
class PatchedWritableTunnelTerminationRequest:
    ...
    custom_fields: Union[
        Unset, "PatchedWritableTunnelTerminationRequestCustomFields"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = (
                PatchedWritableTunnelTerminationRequestCustomFields.from_dict(
                    _custom_fields
                )
            )
