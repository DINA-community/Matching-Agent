...
from ..models.patched_writable_ip_sec_proposal_request_encryption import (
...
class PatchedWritableIPSecProposalRequest:
    ...
    encryption_algorithm: Union[
        None, PatchedWritableIPSecProposalRequestEncryption, Unset
    ] = UNSET
    authentication_algorithm: Union[
        None, PatchedWritableIPSecProposalRequestAuthentication, Unset
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.encryption_algorithm, Unset):
            ...
            self.encryption_algorithm, PatchedWritableIPSecProposalRequestEncryption
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_encryption_algorithm(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_1 = (
                    PatchedWritableIPSecProposalRequestEncryption(data)
                )
            ...
            try:
                ...
                pass
            return cast(
                Union[None, PatchedWritableIPSecProposalRequestEncryption, Unset], data
            )
        ...
        def _parse_authentication_algorithm(
            ...
            try:
                ...
                authentication_algorithm_type_1 = (
                    PatchedWritableIPSecProposalRequestAuthentication(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIPSecProposalRequestCustomFields.from_dict(
                _custom_fields
            )
