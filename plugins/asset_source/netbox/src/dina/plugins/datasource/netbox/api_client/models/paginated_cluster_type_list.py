...
T = TypeVar("T", bound="PaginatedClusterTypeList")
...
class PaginatedClusterTypeList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ClusterType.from_dict(results_item_data)
        ...
        paginated_cluster_type_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_cluster_type_list.additional_properties = d
        return paginated_cluster_type_list
