...
from ..models.writable_circuit_request_distance_unit_type_1 import (
    WritableCircuitRequestDistanceUnitType1,
)
from ..models.writable_circuit_request_distance_unit_type_2_type_1 import (
    WritableCircuitRequestDistanceUnitType2Type1,
)
from ..models.writable_circuit_request_distance_unit_type_3_type_1 import (
    WritableCircuitRequestDistanceUnitType3Type1,
)
from ..models.writable_circuit_request_status import WritableCircuitRequestStatus
...
if TYPE_CHECKING:
    ...
    from ..models.writable_circuit_request_custom_fields import (
        WritableCircuitRequestCustomFields,
    )


T = TypeVar("T", bound="WritableCircuitRequest")
...
class WritableCircuitRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, WritableCircuitRequestStatus]): * `planned` - Planned
        ...
        distance_unit (Union[None, Unset, WritableCircuitRequestDistanceUnitType1,
            WritableCircuitRequestDistanceUnitType2Type1, WritableCircuitRequestDistanceUnitType3Type1]): * `km` -
            Kilometers
            * `m` - Meters
            * `mi` - Miles
            * `ft` - Feet
        ...
        custom_fields (Union[Unset, WritableCircuitRequestCustomFields]):
    ...
    status: Union[Unset, WritableCircuitRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritableCircuitRequestCustomFields"] = UNSET
    assignments: Union[Unset, list["BriefCircuitGroupAssignmentSerializerRequest"]] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.distance_unit, Unset):
            distance_unit = UNSET
        elif isinstance(self.distance_unit, WritableCircuitRequestDistanceUnitType1):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, WritableCircuitRequestDistanceUnitType2Type1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, WritableCircuitRequestDistanceUnitType3Type1
        ):
            distance_unit = self.distance_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, int):
            ...
            type_ = (
                None,
                json.dumps(self.type_.to_dict()).encode(),
                "application/json",
            )
        ...
        if isinstance(self.provider_account, Unset):
            ...
            provider_account = (
                None,
                json.dumps(self.provider_account.to_dict()).encode(),
                "application/json",
            )
        else:
            provider_account = (None, str(self.provider_account).encode(), "text/plain")
        ...
        if not isinstance(self.assignments, Unset):
            ...
            assignments = (
                None,
                json.dumps(_temp_assignments).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, WritableCircuitRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableCircuitRequestStatus(_status)
        ...
        def _parse_distance_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_1 = WritableCircuitRequestDistanceUnitType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_2_type_1 = (
                    WritableCircuitRequestDistanceUnitType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_3_type_1 = (
                    WritableCircuitRequestDistanceUnitType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableCircuitRequestCustomFields.from_dict(_custom_fields)

        assignments = []
        _assignments = d.pop("assignments", UNSET)
        for assignments_item_data in _assignments or []:
            assignments_item = BriefCircuitGroupAssignmentSerializerRequest.from_dict(
                assignments_item_data
            )

            assignments.append(assignments_item)

        writable_circuit_request = cls(
            cid=cid,
            provider=provider,
            type_=type_,
        ...
        writable_circuit_request.additional_properties = d
        return writable_circuit_request
