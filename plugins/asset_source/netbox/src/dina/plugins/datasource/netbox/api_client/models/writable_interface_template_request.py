...
from ..models.writable_interface_template_request_poe_mode_type_1 import (
...
from ..models.writable_interface_template_request_poe_type_type_1 import (
...
from ..models.writable_interface_template_request_type import (
    WritableInterfaceTemplateRequestType,
)
from ..models.writable_interface_template_request_wireless_role import (
...
class WritableInterfaceTemplateRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.poe_mode, Unset):
            ...
            self.poe_mode, WritableInterfaceTemplateRequestPoeModeType2Type1
        ):
            poe_mode = self.poe_mode.value
        elif isinstance(
            self.poe_mode, WritableInterfaceTemplateRequestPoeModeType3Type1
        ):
            poe_mode = self.poe_mode.value
        else:
        ...
        if isinstance(self.poe_type, Unset):
            ...
            self.poe_type, WritableInterfaceTemplateRequestPoeTypeType2Type1
        ):
            poe_type = self.poe_type.value
        elif isinstance(
            self.poe_type, WritableInterfaceTemplateRequestPoeTypeType3Type1
        ):
            poe_type = self.poe_type.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_poe_mode(
            ...
            try:
                ...
                poe_mode_type_2_type_1 = (
                    WritableInterfaceTemplateRequestPoeModeType2Type1(data)
                )
            ...
            try:
                ...
                poe_mode_type_3_type_1 = (
                    WritableInterfaceTemplateRequestPoeModeType3Type1(data)
                )
        ...
        def _parse_poe_type(
            ...
            try:
                ...
                poe_type_type_2_type_1 = (
                    WritableInterfaceTemplateRequestPoeTypeType2Type1(data)
                )
            ...
            try:
                ...
                poe_type_type_3_type_1 = (
                    WritableInterfaceTemplateRequestPoeTypeType3Type1(data)
                )
        ...
        def _parse_rf_role(
            data: object,
        ) -> Union[None, Unset, WritableInterfaceTemplateRequestWirelessRole]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_2_type_1 = WritableInterfaceTemplateRequestWirelessRole(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_3_type_1 = WritableInterfaceTemplateRequestWirelessRole(
                    data
                )
                ...
                pass
            return cast(
                Union[None, Unset, WritableInterfaceTemplateRequestWirelessRole], data
            )
