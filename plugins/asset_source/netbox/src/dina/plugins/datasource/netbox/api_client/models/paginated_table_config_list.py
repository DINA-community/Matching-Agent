...
T = TypeVar("T", bound="PaginatedTableConfigList")
...
class PaginatedTableConfigList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TableConfig.from_dict(results_item_data)
        ...
        paginated_table_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_table_config_list.additional_properties = d
        return paginated_table_config_list
