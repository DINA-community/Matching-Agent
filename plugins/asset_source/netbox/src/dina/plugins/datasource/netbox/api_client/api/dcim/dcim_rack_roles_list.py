...
from ...models.paginated_rack_role_list import PaginatedRackRoleList
...
) -> Optional[PaginatedRackRoleList]:
    if response.status_code == 200:
        response_200 = PaginatedRackRoleList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedRackRoleList]:
    return Response(
