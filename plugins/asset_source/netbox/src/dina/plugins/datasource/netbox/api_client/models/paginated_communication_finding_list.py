...
T = TypeVar("T", bound="PaginatedCommunicationFindingList")


@_attrs_define
class PaginatedCommunicationFindingList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['CommunicationFinding']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CommunicationFinding.from_dict(results_item_data)
        ...
        paginated_communication_finding_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_communication_finding_list.additional_properties = d
        return paginated_communication_finding_list
