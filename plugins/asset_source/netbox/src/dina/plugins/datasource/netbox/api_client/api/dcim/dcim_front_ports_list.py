...
from ...models.dcim_front_ports_list_cable_end import DcimFrontPortsListCableEnd
from ...models.paginated_front_port_list import PaginatedFrontPortList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    cable_end: Union[Unset, DcimFrontPortsListCableEnd] = UNSET,
    ...
    rear_port_id: Union[Unset, list[int]] = UNSET,
    rear_port_id_n: Union[Unset, list[int]] = UNSET,
    rear_port_position: Union[Unset, list[int]] = UNSET,
    rear_port_position_empty: Union[Unset, bool] = UNSET,
    rear_port_position_gt: Union[Unset, list[int]] = UNSET,
    rear_port_position_gte: Union[Unset, list[int]] = UNSET,
    rear_port_position_lt: Union[Unset, list[int]] = UNSET,
    rear_port_position_lte: Union[Unset, list[int]] = UNSET,
    rear_port_position_n: Union[Unset, list[int]] = UNSET,
    ...
    json_rear_port_id: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_id, Unset):
        json_rear_port_id = rear_port_id

    params["rear_port_id"] = json_rear_port_id

    json_rear_port_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_id_n, Unset):
        json_rear_port_id_n = rear_port_id_n

    params["rear_port_id__n"] = json_rear_port_id_n

    json_rear_port_position: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_position, Unset):
        json_rear_port_position = rear_port_position

    params["rear_port_position"] = json_rear_port_position

    params["rear_port_position__empty"] = rear_port_position_empty

    json_rear_port_position_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_position_gt, Unset):
        json_rear_port_position_gt = rear_port_position_gt

    params["rear_port_position__gt"] = json_rear_port_position_gt

    json_rear_port_position_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_position_gte, Unset):
        json_rear_port_position_gte = rear_port_position_gte

    params["rear_port_position__gte"] = json_rear_port_position_gte

    json_rear_port_position_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_position_lt, Unset):
        json_rear_port_position_lt = rear_port_position_lt

    params["rear_port_position__lt"] = json_rear_port_position_lt

    json_rear_port_position_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_position_lte, Unset):
        json_rear_port_position_lte = rear_port_position_lte

    params["rear_port_position__lte"] = json_rear_port_position_lte

    json_rear_port_position_n: Union[Unset, list[int]] = UNSET
    if not isinstance(rear_port_position_n, Unset):
        json_rear_port_position_n = rear_port_position_n

    params["rear_port_position__n"] = json_rear_port_position_n
...
) -> Optional[PaginatedFrontPortList]:
    if response.status_code == 200:
        response_200 = PaginatedFrontPortList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedFrontPortList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        cable_end (Union[Unset, DcimFrontPortsListCableEnd]):
        ...
        rear_port_id (Union[Unset, list[int]]):
        rear_port_id_n (Union[Unset, list[int]]):
        rear_port_position (Union[Unset, list[int]]):
        rear_port_position_empty (Union[Unset, bool]):
        rear_port_position_gt (Union[Unset, list[int]]):
        rear_port_position_gte (Union[Unset, list[int]]):
        rear_port_position_lt (Union[Unset, list[int]]):
        rear_port_position_lte (Union[Unset, list[int]]):
        rear_port_position_n (Union[Unset, list[int]]):
    ...
    kwargs = _get_kwargs(
        ...
        rear_port_id_n=rear_port_id_n,
        rear_port_position=rear_port_position,
        rear_port_position_empty=rear_port_position_empty,
        rear_port_position_gt=rear_port_position_gt,
        rear_port_position_gte=rear_port_position_gte,
        rear_port_position_lt=rear_port_position_lt,
        rear_port_position_lte=rear_port_position_lte,
        rear_port_position_n=rear_port_position_n,
        region=region,
        region_n=region_n,
        region_id=region_id,
