...
if TYPE_CHECKING:
    ...
    from ..models.ip_range_custom_fields import IPRangeCustomFields
    from ..models.ip_range_family import IPRangeFamily
    from ..models.ip_range_status import IPRangeStatus
    from ..models.nested_tag import NestedTag


T = TypeVar("T", bound="IPRange")
...
class IPRange:
    ...
    Attributes:
        ...
        status (Union[Unset, IPRangeStatus]):
        role (Union['BriefRole', None, Unset]):
        description (Union[Unset, str]):
        comments (Union[Unset, str]):
        tags (Union[Unset, list['NestedTag']]):
        custom_fields (Union[Unset, IPRangeCustomFields]):
    ...
    status: Union[Unset, "IPRangeStatus"] = UNSET
    role: Union["BriefRole", None, Unset] = UNSET
    description: Union[Unset, str] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTag"]] = UNSET
    custom_fields: Union[Unset, "IPRangeCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        family = IPRangeFamily.from_dict(d.pop("family"))
        ...
        if isinstance(_status, Unset):
            ...
            status = IPRangeStatus.from_dict(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = IPRangeCustomFields.from_dict(_custom_fields)
        ...
        ip_range.additional_properties = d
        return ip_range
