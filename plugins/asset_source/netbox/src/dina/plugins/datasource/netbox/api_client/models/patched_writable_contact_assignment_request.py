...
class PatchedWritableContactAssignmentRequest:
    ...
    custom_fields: Union[
        Unset, "PatchedWritableContactAssignmentRequestCustomFields"
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.priority, Unset):
            ...
            self.priority, PatchedWritableContactAssignmentRequestPriorityType1
        ):
            priority = self.priority.value
        elif isinstance(
            self.priority, PatchedWritableContactAssignmentRequestPriorityType2Type1
        ):
            priority = self.priority.value
        elif isinstance(
            self.priority, PatchedWritableContactAssignmentRequestPriorityType3Type1
        ):
            priority = self.priority.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.contact, Unset):
            ...
            contact = (
                None,
                json.dumps(self.contact.to_dict()).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_priority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                priority_type_1 = PatchedWritableContactAssignmentRequestPriorityType1(
                    data
                )
            ...
            try:
                ...
                priority_type_2_type_1 = (
                    PatchedWritableContactAssignmentRequestPriorityType2Type1(data)
                )
            ...
            try:
                ...
                priority_type_3_type_1 = (
                    PatchedWritableContactAssignmentRequestPriorityType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = (
                PatchedWritableContactAssignmentRequestCustomFields.from_dict(
                    _custom_fields
                )
            )
