...
def _get_kwargs(
    *,
    ...
    content_type: Union[Unset, list[str]] = UNSET,
    ...
    for_object_type_id: Union[Unset, list[int]] = UNSET,
    ...
    json_content_type: Union[Unset, list[str]] = UNSET
    ...
    json_for_object_type_id: Union[Unset, list[int]] = UNSET
    if not isinstance(for_object_type_id, Unset):
        json_for_object_type_id = for_object_type_id

    params["for_object_type_id"] = json_for_object_type_id
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        content_type (Union[Unset, list[str]]):
        ...
        for_object_type_id (Union[Unset, list[int]]):
