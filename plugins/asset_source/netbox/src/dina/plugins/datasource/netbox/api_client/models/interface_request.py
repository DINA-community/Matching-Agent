...
from ..models.interface_request_duplex_type_1 import InterfaceRequestDuplexType1
from ..models.interface_request_duplex_type_2_type_1 import (
    InterfaceRequestDuplexType2Type1,
)
from ..models.interface_request_duplex_type_3_type_1 import (
    InterfaceRequestDuplexType3Type1,
)
from ..models.interface_request_mode import InterfaceRequestMode
from ..models.interface_request_poe_mode import InterfaceRequestPoeMode
from ..models.interface_request_poe_type import InterfaceRequestPoeType
from ..models.interface_request_rf_channel import InterfaceRequestRfChannel
from ..models.interface_request_rf_role import InterfaceRequestRfRole
from ..models.interface_request_type import InterfaceRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.interface_request_custom_fields import InterfaceRequestCustomFields
    from ..models.nested_interface_request import NestedInterfaceRequest
    from ..models.nested_tag_request import NestedTagRequest


T = TypeVar("T", bound="InterfaceRequest")
...
class InterfaceRequest:
    ...
    Attributes:
        ...
        name (str):
        type_ (InterfaceRequestType): * `virtual` - Virtual
            * `bridge` - Bridge
        ...
        parent (Union['NestedInterfaceRequest', None, Unset]):
        bridge (Union['NestedInterfaceRequest', None, Unset]):
        lag (Union['NestedInterfaceRequest', None, Unset]):
        mtu (Union[None, Unset, int]):
        primary_mac_address (Union['BriefMACAddressRequest', None, Unset, int]):
        speed (Union[None, Unset, int]):
        duplex (Union[InterfaceRequestDuplexType1, InterfaceRequestDuplexType2Type1, InterfaceRequestDuplexType3Type1,
            None, Unset]): * `half` - Half
            * `full` - Full
            * `auto` - Auto
        wwn (Union[None, Unset, str]):
        mgmt_only (Union[Unset, bool]): This interface is used only for out-of-band management
        description (Union[Unset, str]):
        mode (Union[Unset, InterfaceRequestMode]): * `access` - Access
            * `tagged` - Tagged
            * `tagged-all` - Tagged (All)
            * `q-in-q` - Q-in-Q (802.1ad)
        rf_role (Union[Unset, InterfaceRequestRfRole]): * `ap` - Access point
            * `station` - Station
        rf_channel (Union[Unset, InterfaceRequestRfChannel]): * `2.4g-1-2412-22` - 1 (2412 MHz)
        ...
        poe_mode (Union[Unset, InterfaceRequestPoeMode]): * `pd` - PD
            * `pse` - PSE
        poe_type (Union[Unset, InterfaceRequestPoeType]): * `type1-ieee802.3af` - 802.3af (Type 1)
        ...
        custom_fields (Union[Unset, InterfaceRequestCustomFields]):
    """

    device: Union["BriefDeviceRequest", int]
    name: str
    type_: InterfaceRequestType
    vdcs: Union[Unset, list[int]] = UNSET
    module: Union["BriefModuleRequest", None, Unset, int] = UNSET
    label: Union[Unset, str] = UNSET
    enabled: Union[Unset, bool] = UNSET
    parent: Union["NestedInterfaceRequest", None, Unset] = UNSET
    bridge: Union["NestedInterfaceRequest", None, Unset] = UNSET
    lag: Union["NestedInterfaceRequest", None, Unset] = UNSET
    ...
    mode: Union[Unset, InterfaceRequestMode] = UNSET
    rf_role: Union[Unset, InterfaceRequestRfRole] = UNSET
    rf_channel: Union[Unset, InterfaceRequestRfChannel] = UNSET
    poe_mode: Union[Unset, InterfaceRequestPoeMode] = UNSET
    poe_type: Union[Unset, InterfaceRequestPoeType] = UNSET
    ...
    custom_fields: Union[Unset, "InterfaceRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.parent, Unset):
            parent = UNSET
        elif isinstance(self.parent, NestedInterfaceRequest):
        ...
        if isinstance(self.bridge, Unset):
            bridge = UNSET
        elif isinstance(self.bridge, NestedInterfaceRequest):
        ...
        if isinstance(self.lag, Unset):
            lag = UNSET
        elif isinstance(self.lag, NestedInterfaceRequest):
        ...
        if isinstance(self.duplex, Unset):
            duplex = UNSET
        elif isinstance(self.duplex, InterfaceRequestDuplexType1):
            duplex = self.duplex.value
        elif isinstance(self.duplex, InterfaceRequestDuplexType2Type1):
            duplex = self.duplex.value
        elif isinstance(self.duplex, InterfaceRequestDuplexType3Type1):
            duplex = self.duplex.value
        else:
            duplex = self.duplex
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_vrf_request import BriefVRFRequest
        from ..models.interface_request_custom_fields import (
        ...
        type_ = InterfaceRequestType(d.pop("type"))
        ...
        def _parse_parent(data: object) -> Union["NestedInterfaceRequest", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                parent_type_1 = NestedInterfaceRequest.from_dict(data)

                return parent_type_1
            except:  # noqa: E722
                pass
            return cast(Union["NestedInterfaceRequest", None, Unset], data)

        parent = _parse_parent(d.pop("parent", UNSET))

        def _parse_bridge(data: object) -> Union["NestedInterfaceRequest", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                bridge_type_1 = NestedInterfaceRequest.from_dict(data)
        ...
        def _parse_lag(data: object) -> Union["NestedInterfaceRequest", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                lag_type_1 = NestedInterfaceRequest.from_dict(data)
        ...
        def _parse_duplex(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_1 = InterfaceRequestDuplexType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_2_type_1 = InterfaceRequestDuplexType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_3_type_1 = InterfaceRequestDuplexType3Type1(data)
        ...
        mode: Union[Unset, InterfaceRequestMode]
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = InterfaceRequestMode(_mode)

        _rf_role = d.pop("rf_role", UNSET)
        rf_role: Union[Unset, InterfaceRequestRfRole]
        if isinstance(_rf_role, Unset):
            rf_role = UNSET
        else:
            rf_role = InterfaceRequestRfRole(_rf_role)

        _rf_channel = d.pop("rf_channel", UNSET)
        rf_channel: Union[Unset, InterfaceRequestRfChannel]
        if isinstance(_rf_channel, Unset):
            rf_channel = UNSET
        else:
            rf_channel = InterfaceRequestRfChannel(_rf_channel)

        _poe_mode = d.pop("poe_mode", UNSET)
        poe_mode: Union[Unset, InterfaceRequestPoeMode]
        if isinstance(_poe_mode, Unset):
            poe_mode = UNSET
        else:
            poe_mode = InterfaceRequestPoeMode(_poe_mode)

        _poe_type = d.pop("poe_type", UNSET)
        poe_type: Union[Unset, InterfaceRequestPoeType]
        if isinstance(_poe_type, Unset):
            poe_type = UNSET
        else:
            poe_type = InterfaceRequestPoeType(_poe_type)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = InterfaceRequestCustomFields.from_dict(_custom_fields)

        interface_request = cls(
            device=device,
            name=name,
            type_=type_,
            vdcs=vdcs,
        ...
        interface_request.additional_properties = d
