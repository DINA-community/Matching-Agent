...
if TYPE_CHECKING:
    ...
    from ..models.patched_l2vpn_termination_request_custom_fields import (
...
class PatchedL2VPNTerminationRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.l2vpn, Unset):
            ...
            l2vpn = (
                None,
                json.dumps(self.l2vpn.to_dict()).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedL2VPNTerminationRequestCustomFields.from_dict(
                _custom_fields
            )
