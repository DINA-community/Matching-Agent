...
from ..models.virtual_circuit_termination_request_role import (
...
class VirtualCircuitTerminationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_virtual_circuit(
            data: object,
        ) -> Union["BriefVirtualCircuitRequest", int]:
            try:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VirtualCircuitTerminationRequestCustomFields.from_dict(
                _custom_fields
            )
