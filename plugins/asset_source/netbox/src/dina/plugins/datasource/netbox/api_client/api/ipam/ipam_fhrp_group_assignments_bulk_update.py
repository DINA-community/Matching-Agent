...
def _get_kwargs(
    *,
    body: Union[
        list["FHRPGroupAssignmentRequest"],
        list["FHRPGroupAssignmentRequest"],
    ],
) -> dict[str, Any]:
    ...
    if isinstance(body, list["FHRPGroupAssignmentRequest"]):
        _json_body = []
...
) -> Optional[list["FHRPGroupAssignment"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = FHRPGroupAssignment.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[list["FHRPGroupAssignment"]]:
    return Response(
