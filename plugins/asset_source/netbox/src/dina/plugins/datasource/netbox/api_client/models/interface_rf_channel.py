...
from ..models.interface_rf_channel_label import InterfaceRfChannelLabel
from ..models.interface_rf_channel_value import InterfaceRfChannelValue
from ..types import UNSET, Unset

T = TypeVar("T", bound="InterfaceRfChannel")
...
class InterfaceRfChannel:
    """
    Attributes:
        value (Union[Unset, InterfaceRfChannelValue]): * `2.4g-1-2412-22` - 1 (2412 MHz)
        ...
        label (Union[Unset, InterfaceRfChannelLabel]):
    """

    value: Union[Unset, InterfaceRfChannelValue] = UNSET
    label: Union[Unset, InterfaceRfChannelLabel] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: Union[Unset, InterfaceRfChannelValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = InterfaceRfChannelValue(_value)
        ...
        if isinstance(_label, Unset):
            ...
            label = InterfaceRfChannelLabel(_label)

        interface_rf_channel = cls(
            value=value,
            label=label,
        )

        interface_rf_channel.additional_properties = d
        return interface_rf_channel
