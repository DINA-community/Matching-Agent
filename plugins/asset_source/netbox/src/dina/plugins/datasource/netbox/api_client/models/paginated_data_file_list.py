...
T = TypeVar("T", bound="PaginatedDataFileList")
...
class PaginatedDataFileList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DataFile.from_dict(results_item_data)
        ...
        paginated_data_file_list.additional_properties = d
        return paginated_data_file_list
