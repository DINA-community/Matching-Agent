...
T = TypeVar("T", bound="PaginatedTenantGroupList")
...
class PaginatedTenantGroupList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TenantGroup.from_dict(results_item_data)
        ...
        paginated_tenant_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_tenant_group_list.additional_properties = d
        return paginated_tenant_group_list
