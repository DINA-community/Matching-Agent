...
T = TypeVar("T", bound="PaginatedRIRList")
...
class PaginatedRIRList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RIR.from_dict(results_item_data)
        ...
        paginated_rir_list.additional_properties = d
        return paginated_rir_list
