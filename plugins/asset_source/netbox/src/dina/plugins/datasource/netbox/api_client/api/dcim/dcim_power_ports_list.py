...
from ...models.dcim_power_ports_list_cable_end import DcimPowerPortsListCableEnd
from ...models.paginated_power_port_list import PaginatedPowerPortList
...
def _get_kwargs(
    *,
    ...
    cable_end: Union[Unset, DcimPowerPortsListCableEnd] = UNSET,
...
) -> Optional[PaginatedPowerPortList]:
    if response.status_code == 200:
        response_200 = PaginatedPowerPortList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedPowerPortList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        cable_end (Union[Unset, DcimPowerPortsListCableEnd]):
