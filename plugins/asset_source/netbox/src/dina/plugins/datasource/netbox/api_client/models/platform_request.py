...
if TYPE_CHECKING:
    ...
    from ..models.platform_request_custom_fields import PlatformRequestCustomFields


T = TypeVar("T", bound="PlatformRequest")
...
class PlatformRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PlatformRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PlatformRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PlatformRequestCustomFields.from_dict(_custom_fields)

        platform_request = cls(
            name=name,
            slug=slug,
        ...
        platform_request.additional_properties = d
