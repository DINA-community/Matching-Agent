...
from ..models.writable_tunnel_termination_request_role import (
...
class WritableTunnelTerminationRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.tunnel, int):
            ...
            tunnel = (
                None,
                json.dumps(self.tunnel.to_dict()).encode(),
                "application/json",
            )
        ...
        if isinstance(self.outside_ip, Unset):
            ...
            outside_ip = (
                None,
                json.dumps(self.outside_ip.to_dict()).encode(),
                "application/json",
            )
        else:
            outside_ip = (None, str(self.outside_ip).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableTunnelTerminationRequestCustomFields.from_dict(
                _custom_fields
            )
