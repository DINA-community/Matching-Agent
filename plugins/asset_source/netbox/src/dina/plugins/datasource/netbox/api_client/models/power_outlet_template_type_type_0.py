...
from ..models.power_outlet_template_type_type_0_label import (
    PowerOutletTemplateTypeType0Label,
)
from ..models.power_outlet_template_type_type_0_value_type_1 import (
...
class PowerOutletTemplateTypeType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(
            data: object,
        ) -> Union[None, PowerOutletTemplateTypeType0ValueType1, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(
                Union[None, PowerOutletTemplateTypeType0ValueType1, Unset], data
            )
