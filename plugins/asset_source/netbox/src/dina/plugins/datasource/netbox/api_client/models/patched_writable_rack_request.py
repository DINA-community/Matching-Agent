...
from ..models.patched_writable_rack_request_airflow_type_1 import (
    PatchedWritableRackRequestAirflowType1,
)
from ..models.patched_writable_rack_request_airflow_type_2_type_1 import (
    PatchedWritableRackRequestAirflowType2Type1,
)
from ..models.patched_writable_rack_request_airflow_type_3_type_1 import (
    PatchedWritableRackRequestAirflowType3Type1,
)
from ..models.patched_writable_rack_request_form_factor_type_1 import (
...
from ..models.patched_writable_rack_request_outer_unit_type_1 import (
...
from ..models.patched_writable_rack_request_weight_unit_type_1 import (
...
class PatchedWritableRackRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form_factor, Unset):
            ...
            self.form_factor, PatchedWritableRackRequestFormFactorType2Type1
        ):
            form_factor = self.form_factor.value
        elif isinstance(
            self.form_factor, PatchedWritableRackRequestFormFactorType3Type1
        ):
            form_factor = self.form_factor.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            ...
            self.weight_unit, PatchedWritableRackRequestWeightUnitType2Type1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableRackRequestWeightUnitType3Type1
        ):
            weight_unit = self.weight_unit.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.rack_type, Unset):
            ...
            rack_type = (
                None,
                json.dumps(self.rack_type.to_dict()).encode(),
                "application/json",
            )
        else:
            rack_type = (None, str(self.rack_type).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_form_factor(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_2_type_1 = (
                    PatchedWritableRackRequestFormFactorType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_3_type_1 = (
                    PatchedWritableRackRequestFormFactorType3Type1(data)
                )
        ...
        def _parse_weight_unit(
            ...
            try:
                ...
                weight_unit_type_2_type_1 = (
                    PatchedWritableRackRequestWeightUnitType2Type1(data)
                )
            ...
            try:
                ...
                weight_unit_type_3_type_1 = (
                    PatchedWritableRackRequestWeightUnitType3Type1(data)
                )
        ...
        def _parse_outer_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_2_type_1 = (
                    PatchedWritableRackRequestOuterUnitType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                outer_unit_type_3_type_1 = (
                    PatchedWritableRackRequestOuterUnitType3Type1(data)
                )
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_2_type_1 = PatchedWritableRackRequestAirflowType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_3_type_1 = PatchedWritableRackRequestAirflowType3Type1(
                    data
                )
