...
from ...models.paginated_rir_list import PaginatedRIRList
...
) -> Optional[PaginatedRIRList]:
    if response.status_code == 200:
        response_200 = PaginatedRIRList.from_dict(response.json())
