...
T = TypeVar("T", bound="PaginatedClusterList")
...
class PaginatedClusterList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Cluster.from_dict(results_item_data)
        ...
        paginated_cluster_list.additional_properties = d
        return paginated_cluster_list
