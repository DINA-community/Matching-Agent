...
from ..models.writable_custom_field_request_filter_logic import (
    WritableCustomFieldRequestFilterLogic,
)
from ..models.writable_custom_field_request_type import WritableCustomFieldRequestType
from ..models.writable_custom_field_request_ui_editable import (
    WritableCustomFieldRequestUiEditable,
)
from ..models.writable_custom_field_request_ui_visible import (
    WritableCustomFieldRequestUiVisible,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.brief_custom_field_choice_set_request import (
        BriefCustomFieldChoiceSetRequest,
    )


T = TypeVar("T", bound="WritableCustomFieldRequest")
...
class WritableCustomFieldRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[Unset, WritableCustomFieldRequestType]): The type of data this custom field holds
            ...
            filter_logic (Union[Unset, WritableCustomFieldRequestFilterLogic]): Loose matches any instance of a given
                string; exact matches the entire field.

                * `disabled` - Disabled
                * `loose` - Loose
                * `exact` - Exact
            ui_visible (Union[Unset, WritableCustomFieldRequestUiVisible]): Specifies whether the custom field is displayed
                in the UI

                * `always` - Always
                * `if-set` - If set
                * `hidden` - Hidden
            ui_editable (Union[Unset, WritableCustomFieldRequestUiEditable]): Specifies whether the custom field value can
                be edited in the UI
    ...
    object_types: list[str]
    name: str
    type_: Union[Unset, WritableCustomFieldRequestType] = UNSET
    ...
    filter_logic: Union[Unset, WritableCustomFieldRequestFilterLogic] = UNSET
    ui_visible: Union[Unset, WritableCustomFieldRequestUiVisible] = UNSET
    ui_editable: Union[Unset, WritableCustomFieldRequestUiEditable] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.related_object_type, Unset):
            ...
            related_object_type = (
                None,
                str(self.related_object_type).encode(),
                "text/plain",
            )
        else:
            related_object_type = (
        ...
        unique = (
            self.unique
            if isinstance(self.unique, Unset)
            else (None, str(self.unique).encode(), "text/plain")
        )
        ...
        if isinstance(self.choice_set, Unset):
            ...
            choice_set = (
                None,
                json.dumps(self.choice_set.to_dict()).encode(),
                "application/json",
            )
        else:
            choice_set = (None, str(self.choice_set).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, WritableCustomFieldRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = WritableCustomFieldRequestType(_type_)
        ...
        filter_logic: Union[Unset, WritableCustomFieldRequestFilterLogic]
        if isinstance(_filter_logic, Unset):
            filter_logic = UNSET
        else:
            filter_logic = WritableCustomFieldRequestFilterLogic(_filter_logic)

        _ui_visible = d.pop("ui_visible", UNSET)
        ui_visible: Union[Unset, WritableCustomFieldRequestUiVisible]
        if isinstance(_ui_visible, Unset):
            ui_visible = UNSET
        else:
            ui_visible = WritableCustomFieldRequestUiVisible(_ui_visible)

        _ui_editable = d.pop("ui_editable", UNSET)
        ui_editable: Union[Unset, WritableCustomFieldRequestUiEditable]
        if isinstance(_ui_editable, Unset):
            ui_editable = UNSET
        else:
            ui_editable = WritableCustomFieldRequestUiEditable(_ui_editable)
        ...
        def _parse_choice_set(
            data: object,
        ) -> Union["BriefCustomFieldChoiceSetRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                choice_set_type_1_type_1 = BriefCustomFieldChoiceSetRequest.from_dict(
                    data
                )
                ...
                pass
            return cast(
                Union["BriefCustomFieldChoiceSetRequest", None, Unset, int], data
            )
        ...
        writable_custom_field_request = cls(
            object_types=object_types,
            name=name,
            type_=type_,
        ...
        writable_custom_field_request.additional_properties = d
        return writable_custom_field_request
