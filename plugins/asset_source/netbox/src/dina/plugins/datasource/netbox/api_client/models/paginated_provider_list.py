...
T = TypeVar("T", bound="PaginatedProviderList")
...
class PaginatedProviderList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Provider.from_dict(results_item_data)
        ...
        paginated_provider_list.additional_properties = d
