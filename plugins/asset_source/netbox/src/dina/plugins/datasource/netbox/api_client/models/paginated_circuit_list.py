...
T = TypeVar("T", bound="PaginatedCircuitList")
...
class PaginatedCircuitList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Circuit.from_dict(results_item_data)
        ...
        paginated_circuit_list.additional_properties = d
        return paginated_circuit_list
