...
from ..models.front_port_request_type import FrontPortRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.front_port_rear_port_request import FrontPortRearPortRequest
    from ..models.front_port_request_custom_fields import FrontPortRequestCustomFields
    from ..models.nested_tag_request import NestedTagRequest


T = TypeVar("T", bound="FrontPortRequest")
...
class FrontPortRequest:
    ...
    Attributes:
        ...
        name (str):
        type_ (FrontPortRequestType): * `8p8c` - 8P8C
            * `8p6c` - 8P6C
            * `8p4c` - 8P4C
            * `8p2c` - 8P2C
            * `6p6c` - 6P6C
            ...
            * `other` - Other
        rear_port (FrontPortRearPortRequest): NestedRearPortSerializer but with parent device omitted (since front and
            rear ports must belong to same device)
        ...
        custom_fields (Union[Unset, FrontPortRequestCustomFields]):
    """

    device: Union["BriefDeviceRequest", int]
    name: str
    type_: FrontPortRequestType
    ...
    custom_fields: Union[Unset, "FrontPortRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_module_request import BriefModuleRequest
        from ..models.front_port_rear_port_request import FrontPortRearPortRequest
        from ..models.front_port_request_custom_fields import (
        ...
        type_ = FrontPortRequestType(d.pop("type"))

        rear_port = FrontPortRearPortRequest.from_dict(d.pop("rear_port"))
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = FrontPortRequestCustomFields.from_dict(_custom_fields)

        front_port_request = cls(
            device=device,
            name=name,
            type_=type_,
            rear_port=rear_port,
        ...
        front_port_request.additional_properties = d
        return front_port_request
