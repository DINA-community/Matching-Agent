...
class PatchedWritableCircuitRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.distance_unit, Unset):
            ...
            self.distance_unit, PatchedWritableCircuitRequestDistanceUnitType1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, PatchedWritableCircuitRequestDistanceUnitType2Type1
        ):
            distance_unit = self.distance_unit.value
        elif isinstance(
            self.distance_unit, PatchedWritableCircuitRequestDistanceUnitType3Type1
        ):
            distance_unit = self.distance_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_distance_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_1 = PatchedWritableCircuitRequestDistanceUnitType1(
                    data
                )
            ...
            try:
                ...
                distance_unit_type_2_type_1 = (
                    PatchedWritableCircuitRequestDistanceUnitType2Type1(data)
                )
            ...
            try:
                ...
                distance_unit_type_3_type_1 = (
                    PatchedWritableCircuitRequestDistanceUnitType3Type1(data)
                )
