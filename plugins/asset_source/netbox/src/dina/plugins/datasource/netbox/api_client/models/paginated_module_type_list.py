...
T = TypeVar("T", bound="PaginatedModuleTypeList")
...
class PaginatedModuleTypeList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ModuleType.from_dict(results_item_data)
        ...
        paginated_module_type_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_module_type_list.additional_properties = d
        return paginated_module_type_list
