...
from ..models.writable_power_port_request_type_type_1 import (
    WritablePowerPortRequestTypeType1,
)
from ..models.writable_power_port_request_type_type_2_type_1 import (
    WritablePowerPortRequestTypeType2Type1,
)
from ..models.writable_power_port_request_type_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_power_port_request_custom_fields import (
...
class WritablePowerPortRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritablePowerPortRequestCustomFields.from_dict(
                _custom_fields
            )
