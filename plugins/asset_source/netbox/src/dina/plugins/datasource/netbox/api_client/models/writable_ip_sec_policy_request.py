...
from ..models.writable_ip_sec_policy_request_pfs_group_type_1 import (
    WritableIPSecPolicyRequestPfsGroupType1,
)
from ..models.writable_ip_sec_policy_request_pfs_group_type_2_type_1 import (
    WritableIPSecPolicyRequestPfsGroupType2Type1,
)
from ..models.writable_ip_sec_policy_request_pfs_group_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ip_sec_policy_request_custom_fields import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_pfs_group(
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                pfs_group_type_2_type_1 = WritableIPSecPolicyRequestPfsGroupType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                pfs_group_type_3_type_1 = WritableIPSecPolicyRequestPfsGroupType3Type1(
                    data
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIPSecPolicyRequestCustomFields.from_dict(
                _custom_fields
            )
