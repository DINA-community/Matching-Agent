...
T = TypeVar("T", bound="PaginatedCustomLinkList")
...
class PaginatedCustomLinkList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CustomLink.from_dict(results_item_data)
        ...
        paginated_custom_link_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_custom_link_list.additional_properties = d
        return paginated_custom_link_list
