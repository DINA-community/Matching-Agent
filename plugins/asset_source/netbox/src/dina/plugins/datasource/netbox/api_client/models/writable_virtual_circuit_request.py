...
from ..models.writable_virtual_circuit_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_virtual_circuit_request_custom_fields import (
...
class WritableVirtualCircuitRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableVirtualCircuitRequestCustomFields.from_dict(
                _custom_fields
            )
