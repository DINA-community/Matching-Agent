...
T = TypeVar("T", bound="PaginatedTunnelTerminationList")
...
class PaginatedTunnelTerminationList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TunnelTermination.from_dict(results_item_data)
        ...
        paginated_tunnel_termination_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_tunnel_termination_list.additional_properties = d
        return paginated_tunnel_termination_list
