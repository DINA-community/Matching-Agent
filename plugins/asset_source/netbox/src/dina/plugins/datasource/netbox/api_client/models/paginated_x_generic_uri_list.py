...
T = TypeVar("T", bound="PaginatedXGenericUriList")


@_attrs_define
class PaginatedXGenericUriList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list['XGenericUri']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = XGenericUri.from_dict(results_item_data)
        ...
        paginated_x_generic_uri_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_x_generic_uri_list.additional_properties = d
        return paginated_x_generic_uri_list
