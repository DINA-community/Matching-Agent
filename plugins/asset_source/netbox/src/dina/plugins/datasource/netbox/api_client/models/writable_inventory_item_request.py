...
from ..models.writable_inventory_item_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_inventory_item_request_custom_fields import (
        WritableInventoryItemRequestCustomFields,
    )


T = TypeVar("T", bound="WritableInventoryItemRequest")
...
class WritableInventoryItemRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, WritableInventoryItemRequestStatus]): * `offline` - Offline
            * `active` - Active
            * `planned` - Planned
            * `staged` - Staged
            * `failed` - Failed
        ...
        custom_fields (Union[Unset, WritableInventoryItemRequestCustomFields]):
    """
    ...
    status: Union[Unset, WritableInventoryItemRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "WritableInventoryItemRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        part_id = (
            self.part_id
            if isinstance(self.part_id, Unset)
            else (None, str(self.part_id).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, WritableInventoryItemRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WritableInventoryItemRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableInventoryItemRequestCustomFields.from_dict(
                _custom_fields
            )

        writable_inventory_item_request = cls(
            device=device,
            name=name,
            parent=parent,
            label=label,
        ...
        writable_inventory_item_request.additional_properties = d
        return writable_inventory_item_request
