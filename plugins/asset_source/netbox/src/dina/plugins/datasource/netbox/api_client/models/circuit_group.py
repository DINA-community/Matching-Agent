...
if TYPE_CHECKING:
    ...
    from ..models.circuit_group_custom_fields import CircuitGroupCustomFields
    from ..models.nested_tag import NestedTag


T = TypeVar("T", bound="CircuitGroup")
...
class CircuitGroup:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, CircuitGroupCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "CircuitGroupCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = CircuitGroupCustomFields.from_dict(_custom_fields)
        ...
        circuit_group.additional_properties = d
