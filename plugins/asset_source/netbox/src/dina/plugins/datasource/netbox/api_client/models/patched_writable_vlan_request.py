...
from ..models.patched_writable_vlan_request_q_in_q_role import (
    PatchedWritableVLANRequestQInQRole,
)
from ..models.patched_writable_vlan_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_vlan_request_custom_fields import (
...
class PatchedWritableVLANRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        vid = (
            self.vid
            if isinstance(self.vid, Unset)
            else (None, str(self.vid).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_qinq_role(
            data: object,
        ) -> Union[None, PatchedWritableVLANRequestQInQRole, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVLANRequestCustomFields.from_dict(
                _custom_fields
            )
