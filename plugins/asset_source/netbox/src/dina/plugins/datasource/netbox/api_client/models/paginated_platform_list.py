...
T = TypeVar("T", bound="PaginatedPlatformList")
...
class PaginatedPlatformList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Platform.from_dict(results_item_data)
        ...
        paginated_platform_list.additional_properties = d
        return paginated_platform_list
