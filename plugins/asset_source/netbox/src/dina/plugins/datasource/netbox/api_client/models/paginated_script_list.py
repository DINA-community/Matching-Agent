...
T = TypeVar("T", bound="PaginatedScriptList")
...
class PaginatedScriptList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Script.from_dict(results_item_data)
        ...
        paginated_script_list.additional_properties = d
        return paginated_script_list
