...
class WritableCustomFieldChoiceSetRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.base_choices, Unset):
            ...
            self.base_choices, WritableCustomFieldChoiceSetRequestBaseChoicesType1
        ):
            base_choices = self.base_choices.value
        elif isinstance(
            self.base_choices, WritableCustomFieldChoiceSetRequestBaseChoicesType2Type1
        ):
            base_choices = self.base_choices.value
        elif isinstance(
            self.base_choices, WritableCustomFieldChoiceSetRequestBaseChoicesType3Type1
        ):
            base_choices = self.base_choices.value
        else:
        ...
        def _parse_base_choices(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                base_choices_type_1 = (
                    WritableCustomFieldChoiceSetRequestBaseChoicesType1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                base_choices_type_2_type_1 = (
                    WritableCustomFieldChoiceSetRequestBaseChoicesType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                base_choices_type_3_type_1 = (
                    WritableCustomFieldChoiceSetRequestBaseChoicesType3Type1(data)
                )
