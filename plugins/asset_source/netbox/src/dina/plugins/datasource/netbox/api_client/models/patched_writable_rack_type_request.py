...
from ..models.patched_writable_rack_type_request_form_factor import (
    PatchedWritableRackTypeRequestFormFactor,
)
from ..models.patched_writable_rack_type_request_outer_unit_type_1 import (
...
from ..models.patched_writable_rack_type_request_weight_unit_type_1 import (
...
from ..models.patched_writable_rack_type_request_width import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_rack_type_request_custom_fields import (
...
class PatchedWritableRackTypeRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.outer_unit, Unset):
            ...
            self.outer_unit, PatchedWritableRackTypeRequestOuterUnitType2Type1
        ):
            outer_unit = self.outer_unit.value
        elif isinstance(
            self.outer_unit, PatchedWritableRackTypeRequestOuterUnitType3Type1
        ):
            outer_unit = self.outer_unit.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            ...
            self.weight_unit, PatchedWritableRackTypeRequestWeightUnitType1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableRackTypeRequestWeightUnitType2Type1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableRackTypeRequestWeightUnitType3Type1
        ):
            weight_unit = self.weight_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_outer_unit(
            ...
            try:
                ...
                outer_unit_type_2_type_1 = (
                    PatchedWritableRackTypeRequestOuterUnitType2Type1(data)
                )
            ...
            try:
                ...
                outer_unit_type_3_type_1 = (
                    PatchedWritableRackTypeRequestOuterUnitType3Type1(data)
                )
        ...
        def _parse_weight_unit(
            ...
            try:
                ...
                weight_unit_type_2_type_1 = (
                    PatchedWritableRackTypeRequestWeightUnitType2Type1(data)
                )
            ...
            try:
                ...
                weight_unit_type_3_type_1 = (
                    PatchedWritableRackTypeRequestWeightUnitType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableRackTypeRequestCustomFields.from_dict(
                _custom_fields
            )
