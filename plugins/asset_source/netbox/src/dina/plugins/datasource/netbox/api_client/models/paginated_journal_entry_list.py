...
T = TypeVar("T", bound="PaginatedJournalEntryList")
...
class PaginatedJournalEntryList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = JournalEntry.from_dict(results_item_data)
        ...
        paginated_journal_entry_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_journal_entry_list.additional_properties = d
        return paginated_journal_entry_list
