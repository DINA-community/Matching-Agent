...
T = TypeVar("T", bound="PaginatedCableTerminationList")
...
class PaginatedCableTerminationList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CableTermination.from_dict(results_item_data)
        ...
        paginated_cable_termination_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_cable_termination_list.additional_properties = d
        return paginated_cable_termination_list
