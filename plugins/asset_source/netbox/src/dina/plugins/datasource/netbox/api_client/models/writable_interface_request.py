...
from ..models.writable_interface_request_duplex_type_1 import (
    WritableInterfaceRequestDuplexType1,
)
from ..models.writable_interface_request_duplex_type_2_type_1 import (
    WritableInterfaceRequestDuplexType2Type1,
)
from ..models.writable_interface_request_duplex_type_3_type_1 import (
    WritableInterfaceRequestDuplexType3Type1,
)
from ..models.writable_interface_request_mode_type_1 import (
    WritableInterfaceRequestModeType1,
)
from ..models.writable_interface_request_mode_type_2_type_1 import (
    WritableInterfaceRequestModeType2Type1,
)
from ..models.writable_interface_request_mode_type_3_type_1 import (
    WritableInterfaceRequestModeType3Type1,
)
from ..models.writable_interface_request_poe_mode_type_1 import (
    WritableInterfaceRequestPoeModeType1,
)
from ..models.writable_interface_request_poe_mode_type_2_type_1 import (
    WritableInterfaceRequestPoeModeType2Type1,
)
from ..models.writable_interface_request_poe_mode_type_3_type_1 import (
    WritableInterfaceRequestPoeModeType3Type1,
)
from ..models.writable_interface_request_poe_type_type_1 import (
    WritableInterfaceRequestPoeTypeType1,
)
from ..models.writable_interface_request_poe_type_type_2_type_1 import (
    WritableInterfaceRequestPoeTypeType2Type1,
)
from ..models.writable_interface_request_poe_type_type_3_type_1 import (
    WritableInterfaceRequestPoeTypeType3Type1,
)
from ..models.writable_interface_request_type import WritableInterfaceRequestType
from ..models.writable_interface_request_wireless_channel import (
    WritableInterfaceRequestWirelessChannel,
)
from ..models.writable_interface_request_wireless_role import (
...
if TYPE_CHECKING:
    ...
    from ..models.brief_vlan_translation_policy_request import (
        BriefVLANTranslationPolicyRequest,
    )
    from ..models.brief_vrf_request import BriefVRFRequest
    from ..models.nested_tag_request import NestedTagRequest
    from ..models.writable_interface_request_custom_fields import (
        WritableInterfaceRequestCustomFields,
    )


T = TypeVar("T", bound="WritableInterfaceRequest")
...
class WritableInterfaceRequest:
    ...
    Attributes:
        ...
        name (str):
        type_ (WritableInterfaceRequestType): * `virtual` - Virtual
            * `bridge` - Bridge
        ...
        duplex (Union[None, Unset, WritableInterfaceRequestDuplexType1, WritableInterfaceRequestDuplexType2Type1,
            WritableInterfaceRequestDuplexType3Type1]): * `half` - Half
            * `full` - Full
            * `auto` - Auto
        wwn (Union[None, Unset, str]):
        mgmt_only (Union[Unset, bool]): This interface is used only for out-of-band management
        description (Union[Unset, str]):
        mode (Union[None, Unset, WritableInterfaceRequestModeType1, WritableInterfaceRequestModeType2Type1,
            WritableInterfaceRequestModeType3Type1]): IEEE 802.1Q tagging strategy

            * `access` - Access
            * `tagged` - Tagged
            * `tagged-all` - Tagged (All)
            * `q-in-q` - Q-in-Q (802.1ad)
        rf_role (Union[None, Unset, WritableInterfaceRequestWirelessRole]): * `ap` - Access point
            * `station` - Station
        rf_channel (Union[None, Unset, WritableInterfaceRequestWirelessChannel]): * `2.4g-1-2412-22` - 1 (2412 MHz)
        ...
        poe_mode (Union[None, Unset, WritableInterfaceRequestPoeModeType1, WritableInterfaceRequestPoeModeType2Type1,
            WritableInterfaceRequestPoeModeType3Type1]): * `pd` - PD
            * `pse` - PSE
        poe_type (Union[None, Unset, WritableInterfaceRequestPoeTypeType1, WritableInterfaceRequestPoeTypeType2Type1,
            WritableInterfaceRequestPoeTypeType3Type1]): * `type1-ieee802.3af` - 802.3af (Type 1)
        ...
        custom_fields (Union[Unset, WritableInterfaceRequestCustomFields]):
    """

    device: Union["BriefDeviceRequest", int]
    name: str
    type_: WritableInterfaceRequestType
    ...
    rf_role: Union[None, Unset, WritableInterfaceRequestWirelessRole] = UNSET
    rf_channel: Union[None, Unset, WritableInterfaceRequestWirelessChannel] = UNSET
    poe_mode: Union[
        None,
        Unset,
        WritableInterfaceRequestPoeModeType1,
    ...
    vlan_translation_policy: Union[
        "BriefVLANTranslationPolicyRequest", None, Unset, int
    ] = UNSET
    ...
    custom_fields: Union[Unset, "WritableInterfaceRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.duplex, Unset):
            duplex = UNSET
        elif isinstance(self.duplex, WritableInterfaceRequestDuplexType1):
            duplex = self.duplex.value
        elif isinstance(self.duplex, WritableInterfaceRequestDuplexType2Type1):
            duplex = self.duplex.value
        elif isinstance(self.duplex, WritableInterfaceRequestDuplexType3Type1):
            duplex = self.duplex.value
        else:
            duplex = self.duplex
        ...
        if isinstance(self.mode, Unset):
            mode = UNSET
        elif isinstance(self.mode, WritableInterfaceRequestModeType1):
            mode = self.mode.value
        elif isinstance(self.mode, WritableInterfaceRequestModeType2Type1):
            mode = self.mode.value
        elif isinstance(self.mode, WritableInterfaceRequestModeType3Type1):
            mode = self.mode.value
        else:
            mode = self.mode
        ...
        if isinstance(self.rf_role, Unset):
            rf_role = UNSET
        elif isinstance(self.rf_role, WritableInterfaceRequestWirelessRole):
        ...
        if isinstance(self.rf_channel, Unset):
            rf_channel = UNSET
        elif isinstance(self.rf_channel, WritableInterfaceRequestWirelessChannel):
        ...
        if isinstance(self.poe_mode, Unset):
            poe_mode = UNSET
        elif isinstance(self.poe_mode, WritableInterfaceRequestPoeModeType1):
            poe_mode = self.poe_mode.value
        elif isinstance(self.poe_mode, WritableInterfaceRequestPoeModeType2Type1):
            poe_mode = self.poe_mode.value
        elif isinstance(self.poe_mode, WritableInterfaceRequestPoeModeType3Type1):
            poe_mode = self.poe_mode.value
        else:
        ...
        if isinstance(self.poe_type, Unset):
            poe_type = UNSET
        elif isinstance(self.poe_type, WritableInterfaceRequestPoeTypeType1):
            poe_type = self.poe_type.value
        elif isinstance(self.poe_type, WritableInterfaceRequestPoeTypeType2Type1):
            poe_type = self.poe_type.value
        elif isinstance(self.poe_type, WritableInterfaceRequestPoeTypeType3Type1):
            poe_type = self.poe_type.value
        else:
        ...
        if isinstance(self.vlan_translation_policy, Unset):
            ...
            self.vlan_translation_policy, BriefVLANTranslationPolicyRequest
        ):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.primary_mac_address, Unset):
            ...
            primary_mac_address = (
                None,
                str(self.primary_mac_address).encode(),
                "text/plain",
            )
            ...
            primary_mac_address = (
                None,
                json.dumps(self.primary_mac_address.to_dict()).encode(),
                "application/json",
            )
        else:
            primary_mac_address = (
        ...
        if isinstance(self.rf_channel_frequency, Unset):
            ...
            rf_channel_frequency = (
                None,
                str(self.rf_channel_frequency).encode(),
                "text/plain",
            )
        else:
            rf_channel_frequency = (
        ...
        if isinstance(self.untagged_vlan, Unset):
            ...
            untagged_vlan = (
                None,
                json.dumps(self.untagged_vlan.to_dict()).encode(),
                "application/json",
            )
        else:
            untagged_vlan = (None, str(self.untagged_vlan).encode(), "text/plain")
        ...
        if isinstance(self.qinq_svlan, Unset):
            ...
            qinq_svlan = (
                None,
                json.dumps(self.qinq_svlan.to_dict()).encode(),
                "application/json",
            )
        else:
            qinq_svlan = (None, str(self.qinq_svlan).encode(), "text/plain")
        ...
        if isinstance(self.vlan_translation_policy, Unset):
            ...
            vlan_translation_policy = (
                None,
                str(self.vlan_translation_policy).encode(),
                "text/plain",
            )
        ...
        if not isinstance(self.wireless_lans, Unset):
            ...
            wireless_lans = (
                None,
                json.dumps(_temp_wireless_lans).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = WritableInterfaceRequestType(d.pop("type"))
        ...
        def _parse_primary_mac_address(
            data: object,
        ) -> Union["BriefMACAddressRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                primary_mac_address_type_1_type_1 = BriefMACAddressRequest.from_dict(
                    data
                )
        ...
        def _parse_duplex(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_1 = WritableInterfaceRequestDuplexType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_2_type_1 = WritableInterfaceRequestDuplexType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                duplex_type_3_type_1 = WritableInterfaceRequestDuplexType3Type1(data)
        ...
        def _parse_mode(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_1 = WritableInterfaceRequestModeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_2_type_1 = WritableInterfaceRequestModeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_3_type_1 = WritableInterfaceRequestModeType3Type1(data)
        ...
        def _parse_rf_role(
            data: object,
        ) -> Union[None, Unset, WritableInterfaceRequestWirelessRole]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_1 = WritableInterfaceRequestWirelessRole(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_2_type_1 = WritableInterfaceRequestWirelessRole(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_role_type_3_type_1 = WritableInterfaceRequestWirelessRole(data)

                return rf_role_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, WritableInterfaceRequestWirelessRole], data)

        rf_role = _parse_rf_role(d.pop("rf_role", UNSET))

        def _parse_rf_channel(
            data: object,
        ) -> Union[None, Unset, WritableInterfaceRequestWirelessChannel]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_channel_type_1 = WritableInterfaceRequestWirelessChannel(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_channel_type_2_type_1 = WritableInterfaceRequestWirelessChannel(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                rf_channel_type_3_type_1 = WritableInterfaceRequestWirelessChannel(data)

                return rf_channel_type_3_type_1
            except:  # noqa: E722
                pass
            return cast(
                Union[None, Unset, WritableInterfaceRequestWirelessChannel], data
            )
        ...
        def _parse_poe_mode(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_mode_type_1 = WritableInterfaceRequestPoeModeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_mode_type_2_type_1 = WritableInterfaceRequestPoeModeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_mode_type_3_type_1 = WritableInterfaceRequestPoeModeType3Type1(data)
        ...
        def _parse_poe_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_type_type_1 = WritableInterfaceRequestPoeTypeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_type_type_2_type_1 = WritableInterfaceRequestPoeTypeType2Type1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                poe_type_type_3_type_1 = WritableInterfaceRequestPoeTypeType3Type1(data)
        ...
        def _parse_untagged_vlan(
            data: object,
        ) -> Union["BriefVLANRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_vlan_translation_policy(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                vlan_translation_policy_type_1_type_1 = (
                    BriefVLANTranslationPolicyRequest.from_dict(data)
                )
                ...
                pass
            return cast(
                Union["BriefVLANTranslationPolicyRequest", None, Unset, int], data
            )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableInterfaceRequestCustomFields.from_dict(
                _custom_fields
            )

        writable_interface_request = cls(
            device=device,
            name=name,
            type_=type_,
            vdcs=vdcs,
        ...
        writable_interface_request.additional_properties = d
        return writable_interface_request
