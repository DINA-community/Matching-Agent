...
class PatchedWritableConsoleServerPortRequest:
    ...
    custom_fields: Union[
        Unset, "PatchedWritableConsoleServerPortRequestCustomFields"
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            ...
            self.type_, PatchedWritableConsoleServerPortRequestTypeType2Type1
        ):
            type_ = self.type_.value
        elif isinstance(
            self.type_, PatchedWritableConsoleServerPortRequestTypeType3Type1
        ):
            type_ = self.type_.value
        else:
            type_ = self.type_
        ...
        if isinstance(self.speed, Unset):
            ...
            self.speed, PatchedWritableConsoleServerPortRequestSpeedType2Type1
        ):
            speed = self.speed.value
        elif isinstance(
            self.speed, PatchedWritableConsoleServerPortRequestSpeedType3Type1
        ):
            speed = self.speed.value
        else:
            speed = self.speed
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = (
                    PatchedWritableConsoleServerPortRequestTypeType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = (
                    PatchedWritableConsoleServerPortRequestTypeType3Type1(data)
                )
        ...
        def _parse_speed(
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                speed_type_2_type_1 = (
                    PatchedWritableConsoleServerPortRequestSpeedType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, int):
                    raise TypeError()
                speed_type_3_type_1 = (
                    PatchedWritableConsoleServerPortRequestSpeedType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = (
                PatchedWritableConsoleServerPortRequestCustomFields.from_dict(
                    _custom_fields
                )
            )
