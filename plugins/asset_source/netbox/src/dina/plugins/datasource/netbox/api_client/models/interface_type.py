...
from ..models.interface_type_label import InterfaceTypeLabel
from ..models.interface_type_value import InterfaceTypeValue
from ..types import UNSET, Unset

T = TypeVar("T", bound="InterfaceType")
...
class InterfaceType:
    """
    Attributes:
        value (Union[Unset, InterfaceTypeValue]): * `virtual` - Virtual
            * `bridge` - Bridge
            ...
            * `other` - Other
        label (Union[Unset, InterfaceTypeLabel]):
    """

    value: Union[Unset, InterfaceTypeValue] = UNSET
    label: Union[Unset, InterfaceTypeLabel] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: Union[Unset, InterfaceTypeValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = InterfaceTypeValue(_value)
        ...
        if isinstance(_label, Unset):
            ...
            label = InterfaceTypeLabel(_label)
        ...
        interface_type.additional_properties = d
