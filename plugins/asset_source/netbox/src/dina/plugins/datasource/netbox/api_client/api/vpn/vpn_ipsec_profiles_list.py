...
from ...models.paginated_ip_sec_profile_list import PaginatedIPSecProfileList
...
def _get_kwargs(
    *,
    ...
    mode_ic: Union[Unset, list[str]] = UNSET,
    mode_ie: Union[Unset, list[str]] = UNSET,
    mode_iew: Union[Unset, list[str]] = UNSET,
    mode_isw: Union[Unset, list[str]] = UNSET,
    mode_n: Union[Unset, list[str]] = UNSET,
    mode_nic: Union[Unset, list[str]] = UNSET,
    mode_nie: Union[Unset, list[str]] = UNSET,
    mode_niew: Union[Unset, list[str]] = UNSET,
    mode_nisw: Union[Unset, list[str]] = UNSET,
    ...
    json_mode_ic: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_ic, Unset):
        json_mode_ic = mode_ic

    params["mode__ic"] = json_mode_ic

    json_mode_ie: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_ie, Unset):
        json_mode_ie = mode_ie

    params["mode__ie"] = json_mode_ie

    json_mode_iew: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_iew, Unset):
        json_mode_iew = mode_iew

    params["mode__iew"] = json_mode_iew

    json_mode_isw: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_isw, Unset):
        json_mode_isw = mode_isw

    params["mode__isw"] = json_mode_isw

    json_mode_n: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_n, Unset):
        json_mode_n = mode_n

    params["mode__n"] = json_mode_n

    json_mode_nic: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_nic, Unset):
        json_mode_nic = mode_nic

    params["mode__nic"] = json_mode_nic

    json_mode_nie: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_nie, Unset):
        json_mode_nie = mode_nie

    params["mode__nie"] = json_mode_nie

    json_mode_niew: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_niew, Unset):
        json_mode_niew = mode_niew

    params["mode__niew"] = json_mode_niew

    json_mode_nisw: Union[Unset, list[str]] = UNSET
    if not isinstance(mode_nisw, Unset):
        json_mode_nisw = mode_nisw
...
) -> Optional[PaginatedIPSecProfileList]:
    if response.status_code == 200:
        response_200 = PaginatedIPSecProfileList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedIPSecProfileList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        mode_ic (Union[Unset, list[str]]):
        mode_ie (Union[Unset, list[str]]):
        mode_iew (Union[Unset, list[str]]):
        mode_isw (Union[Unset, list[str]]):
        mode_n (Union[Unset, list[str]]):
        mode_nic (Union[Unset, list[str]]):
        mode_nie (Union[Unset, list[str]]):
        mode_niew (Union[Unset, list[str]]):
        mode_nisw (Union[Unset, list[str]]):
