...
T = TypeVar("T", bound="DeviceBayTemplateRequest")
...
class DeviceBayTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        device_bay_template_request = cls(
            device_type=device_type,
            name=name,
            label=label,
        ...
        device_bay_template_request.additional_properties = d
        return device_bay_template_request
