...
from ..models.console_port_template_request_type import ConsolePortTemplateRequestType
...
T = TypeVar("T", bound="ConsolePortTemplateRequest")
...
class ConsolePortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (Union[Unset, ConsolePortTemplateRequestType]): * `de-9` - DE-9
                * `db-25` - DB-25
                * `rj-11` - RJ-11
                * `rj-12` - RJ-12
                * `rj-45` - RJ-45
    ...
    type_: Union[Unset, ConsolePortTemplateRequestType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, ConsolePortTemplateRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ConsolePortTemplateRequestType(_type_)

        description = d.pop("description", UNSET)

        console_port_template_request = cls(
            name=name,
        ...
        console_port_template_request.additional_properties = d
        return console_port_template_request
