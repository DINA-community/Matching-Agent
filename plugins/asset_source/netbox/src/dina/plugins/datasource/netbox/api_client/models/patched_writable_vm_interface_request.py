...
from ..models.patched_writable_vm_interface_request_mode_type_1 import (
    PatchedWritableVMInterfaceRequestModeType1,
)
from ..models.patched_writable_vm_interface_request_mode_type_2_type_1 import (
    PatchedWritableVMInterfaceRequestModeType2Type1,
)
from ..models.patched_writable_vm_interface_request_mode_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_vm_interface_request_custom_fields import (
        PatchedWritableVMInterfaceRequestCustomFields,
    )


T = TypeVar("T", bound="PatchedWritableVMInterfaceRequest")
...
class PatchedWritableVMInterfaceRequest:
    ...
    Attributes:
        ...
        mode (Union[None, PatchedWritableVMInterfaceRequestModeType1, PatchedWritableVMInterfaceRequestModeType2Type1,
            PatchedWritableVMInterfaceRequestModeType3Type1, Unset]): IEEE 802.1Q tagging strategy
        ...
        custom_fields (Union[Unset, PatchedWritableVMInterfaceRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PatchedWritableVMInterfaceRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.mode, Unset):
            mode = UNSET
        elif isinstance(self.mode, PatchedWritableVMInterfaceRequestModeType1):
            mode = self.mode.value
        elif isinstance(self.mode, PatchedWritableVMInterfaceRequestModeType2Type1):
            mode = self.mode.value
        elif isinstance(self.mode, PatchedWritableVMInterfaceRequestModeType3Type1):
            mode = self.mode.value
        else:
            mode = self.mode
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_mode(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_1 = PatchedWritableVMInterfaceRequestModeType1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_2_type_1 = PatchedWritableVMInterfaceRequestModeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                mode_type_3_type_1 = PatchedWritableVMInterfaceRequestModeType3Type1(
                    data
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVMInterfaceRequestCustomFields.from_dict(
                _custom_fields
            )

        patched_writable_vm_interface_request = cls(
        ...
        patched_writable_vm_interface_request.additional_properties = d
        return patched_writable_vm_interface_request
