...
T = TypeVar("T", bound="PaginatedFrontPortList")
...
class PaginatedFrontPortList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = FrontPort.from_dict(results_item_data)
        ...
        paginated_front_port_list.additional_properties = d
        return paginated_front_port_list
