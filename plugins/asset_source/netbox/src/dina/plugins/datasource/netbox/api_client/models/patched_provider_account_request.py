...
if TYPE_CHECKING:
    ...
    from ..models.patched_provider_account_request_custom_fields import (
        PatchedProviderAccountRequestCustomFields,
    )


T = TypeVar("T", bound="PatchedProviderAccountRequest")
...
class PatchedProviderAccountRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PatchedProviderAccountRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "PatchedProviderAccountRequestCustomFields"] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        account = (
            ...
            else (None, str(self.account).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedProviderAccountRequestCustomFields.from_dict(
                _custom_fields
            )

        patched_provider_account_request = cls(
            provider=provider,
            name=name,
            account=account,
        ...
        patched_provider_account_request.additional_properties = d
        return patched_provider_account_request
