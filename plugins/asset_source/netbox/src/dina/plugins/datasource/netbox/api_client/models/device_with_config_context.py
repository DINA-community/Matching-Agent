...
if TYPE_CHECKING:
    ...
    from ..models.device_with_config_context_airflow import (
        DeviceWithConfigContextAirflow,
    )
    from ..models.device_with_config_context_custom_fields import (
...
class DeviceWithConfigContext:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.device_with_config_context_face import DeviceWithConfigContextFace
        from ..models.device_with_config_context_status import (
        ...
        def _parse_virtual_chassis(
            data: object,
        ) -> Union["BriefVirtualChassis", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = DeviceWithConfigContextCustomFields.from_dict(
                _custom_fields
            )
