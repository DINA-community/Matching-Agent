...
if TYPE_CHECKING:
    ...
    from ..models.platform_custom_fields import PlatformCustomFields
...
class Platform:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, PlatformCustomFields]):
    ...
    custom_fields: Union[Unset, "PlatformCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_manufacturer(
            data: object,
        ) -> Union["BriefManufacturer", None, Unset]:
            if data is None:
                return data
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PlatformCustomFields.from_dict(_custom_fields)
