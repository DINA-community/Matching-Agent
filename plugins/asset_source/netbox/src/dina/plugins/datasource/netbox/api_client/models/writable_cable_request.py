...
from ..models.writable_cable_request_length_unit_type_1 import (
    WritableCableRequestLengthUnitType1,
)
from ..models.writable_cable_request_length_unit_type_2_type_1 import (
    WritableCableRequestLengthUnitType2Type1,
)
from ..models.writable_cable_request_length_unit_type_3_type_1 import (
...
from ..models.writable_cable_request_type_type_2_type_1 import (
    WritableCableRequestTypeType2Type1,
)
from ..models.writable_cable_request_type_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_cable_request_custom_fields import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_length_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_2_type_1 = WritableCableRequestLengthUnitType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                length_unit_type_3_type_1 = WritableCableRequestLengthUnitType3Type1(
                    data
                )
