...
from ..models.patched_writable_module_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_module_request_custom_fields import (
...
class PatchedWritableModuleRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_module_type(
            data: object,
        ) -> Union["BriefModuleTypeRequest", Unset, int]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableModuleRequestCustomFields.from_dict(
                _custom_fields
            )
