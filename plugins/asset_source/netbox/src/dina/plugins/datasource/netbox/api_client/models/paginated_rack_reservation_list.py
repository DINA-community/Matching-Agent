...
T = TypeVar("T", bound="PaginatedRackReservationList")
...
class PaginatedRackReservationList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RackReservation.from_dict(results_item_data)
        ...
        paginated_rack_reservation_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_rack_reservation_list.additional_properties = d
        return paginated_rack_reservation_list
