...
from ...models.journal_entry_request import JournalEntryRequest
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, list["JournalEntryRequest"]):
        _json_body = []
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = JournalEntry.from_dict(response_200_item_data)
