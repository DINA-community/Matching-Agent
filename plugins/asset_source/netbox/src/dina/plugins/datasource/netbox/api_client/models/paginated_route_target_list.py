...
T = TypeVar("T", bound="PaginatedRouteTargetList")
...
class PaginatedRouteTargetList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RouteTarget.from_dict(results_item_data)
        ...
        paginated_route_target_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_route_target_list.additional_properties = d
        return paginated_route_target_list
