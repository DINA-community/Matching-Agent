...
class WritableDeviceWithConfigContextRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.airflow, Unset):
            ...
            self.airflow, WritableDeviceWithConfigContextRequestAirflowType1
        ):
            airflow = self.airflow.value
        elif isinstance(
            self.airflow, WritableDeviceWithConfigContextRequestAirflowType2Type1
        ):
            airflow = self.airflow.value
        elif isinstance(
            self.airflow, WritableDeviceWithConfigContextRequestAirflowType3Type1
        ):
            airflow = self.airflow.value
        else:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.platform, Unset):
            ...
            platform = (
                None,
                json.dumps(self.platform.to_dict()).encode(),
                "application/json",
            )
        else:
            platform = (None, str(self.platform).encode(), "text/plain")
        ...
        if isinstance(self.primary_ip4, Unset):
            ...
            primary_ip4 = (
                None,
                json.dumps(self.primary_ip4.to_dict()).encode(),
                "application/json",
            )
        else:
            primary_ip4 = (None, str(self.primary_ip4).encode(), "text/plain")
        ...
        if isinstance(self.primary_ip6, Unset):
            ...
            primary_ip6 = (
                None,
                json.dumps(self.primary_ip6.to_dict()).encode(),
                "application/json",
            )
        else:
            primary_ip6 = (None, str(self.primary_ip6).encode(), "text/plain")
        ...
        if isinstance(self.oob_ip, Unset):
            ...
            oob_ip = (
                None,
                json.dumps(self.oob_ip.to_dict()).encode(),
                "application/json",
            )
        else:
            oob_ip = (None, str(self.oob_ip).encode(), "text/plain")
        ...
        if isinstance(self.cluster, Unset):
            ...
            cluster = (
                None,
                json.dumps(self.cluster.to_dict()).encode(),
                "application/json",
            )
        else:
            cluster = (None, str(self.cluster).encode(), "text/plain")
        ...
        if isinstance(self.virtual_chassis, Unset):
            ...
            virtual_chassis = (
                None,
                json.dumps(self.virtual_chassis.to_dict()).encode(),
                "application/json",
            )
        else:
            virtual_chassis = (None, str(self.virtual_chassis).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_face(
            data: object,
        ) -> Union[None, Unset, WritableDeviceWithConfigContextRequestRackFace]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_2_type_1 = WritableDeviceWithConfigContextRequestRackFace(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_3_type_1 = WritableDeviceWithConfigContextRequestRackFace(
                    data
                )
                ...
                pass
            return cast(
                Union[None, Unset, WritableDeviceWithConfigContextRequestRackFace], data
            )
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_1 = WritableDeviceWithConfigContextRequestAirflowType1(
                    data
                )
            ...
            try:
                ...
                airflow_type_2_type_1 = (
                    WritableDeviceWithConfigContextRequestAirflowType2Type1(data)
                )
            ...
            try:
                ...
                airflow_type_3_type_1 = (
                    WritableDeviceWithConfigContextRequestAirflowType3Type1(data)
                )
        ...
        def _parse_virtual_chassis(
            data: object,
        ) -> Union["BriefVirtualChassisRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                virtual_chassis_type_1_type_1 = BriefVirtualChassisRequest.from_dict(
                    data
                )
