...
T = TypeVar("T", bound="PatchedExportTemplateRequest")
...
class PatchedExportTemplateRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        file_name = (
            ...
            else (None, str(self.file_name).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_export_template_request = cls(
        ...
        patched_export_template_request.additional_properties = d
        return patched_export_template_request
