...
if TYPE_CHECKING:
    ...
    from ..models.virtual_circuit_termination_custom_fields import (
...
class VirtualCircuitTermination:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.virtual_circuit_termination_role import (
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VirtualCircuitTerminationCustomFields.from_dict(
                _custom_fields
            )
