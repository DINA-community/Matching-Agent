...
if TYPE_CHECKING:
    ...
    from ..models.patched_asn_request_custom_fields import PatchedASNRequestCustomFields


T = TypeVar("T", bound="PatchedASNRequest")
...
class PatchedASNRequest:
    ...
    Attributes:
        asn (Union[Unset, int]): 16- or 32-bit autonomous system number
        rir (Union['BriefRIRRequest', None, Unset, int]):
        tenant (Union['BriefTenantRequest', None, Unset, int]):
        description (Union[Unset, str]):
        comments (Union[Unset, str]):
        tags (Union[Unset, list['NestedTagRequest']]):
        custom_fields (Union[Unset, PatchedASNRequestCustomFields]):
    """

    asn: Union[Unset, int] = UNSET
    rir: Union["BriefRIRRequest", None, Unset, int] = UNSET
    tenant: Union["BriefTenantRequest", None, Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    comments: Union[Unset, str] = UNSET
    tags: Union[Unset, list["NestedTagRequest"]] = UNSET
    custom_fields: Union[Unset, "PatchedASNRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        rir: Union[None, Unset, dict[str, Any], int]
    ...
    def to_multipart(self) -> dict[str, Any]:
        asn = (
            ...
            else (None, str(self.asn).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.brief_tenant_request import BriefTenantRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.patched_asn_request_custom_fields import (
        ...
        def _parse_rir(data: object) -> Union["BriefRIRRequest", None, Unset, int]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                rir_type_1_type_1 = BriefRIRRequest.from_dict(data)

                return rir_type_1_type_1
            except:  # noqa: E722
                pass
            return cast(Union["BriefRIRRequest", None, Unset, int], data)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedASNRequestCustomFields.from_dict(_custom_fields)

        patched_asn_request = cls(
            asn=asn,
            rir=rir,
            tenant=tenant,
        ...
        patched_asn_request.additional_properties = d
        return patched_asn_request
