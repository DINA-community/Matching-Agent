...
def _get_kwargs(
    *,
    ...
    if isinstance(body, list["ConfigTemplateRequest"]):
        _json_body = []
...
) -> Optional[list["ConfigTemplate"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ConfigTemplate.from_dict(response_200_item_data)
