...
T = TypeVar("T", bound="NestedInterfaceTemplate")
...
class NestedInterfaceTemplate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nested_interface_template.additional_properties = d
        return nested_interface_template
