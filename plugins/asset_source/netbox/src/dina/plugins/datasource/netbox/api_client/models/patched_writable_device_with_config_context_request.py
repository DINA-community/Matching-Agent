...
class PatchedWritableDeviceWithConfigContextRequest:
    ...
    face: Union[None, PatchedWritableDeviceWithConfigContextRequestRackFace, Unset] = (
        UNSET
    )
    ...
    custom_fields: Union[
        Unset, "PatchedWritableDeviceWithConfigContextRequestCustomFields"
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.face, Unset):
            ...
            self.face, PatchedWritableDeviceWithConfigContextRequestRackFace
        ):
        ...
        if isinstance(self.airflow, Unset):
            ...
            self.airflow, PatchedWritableDeviceWithConfigContextRequestAirflowType1
        ):
            airflow = self.airflow.value
        elif isinstance(
            self.airflow, PatchedWritableDeviceWithConfigContextRequestAirflowType2Type1
        ):
            airflow = self.airflow.value
        elif isinstance(
            self.airflow, PatchedWritableDeviceWithConfigContextRequestAirflowType3Type1
        ):
            airflow = self.airflow.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_device_type(
            data: object,
        ) -> Union["BriefDeviceTypeRequest", Unset, int]:
            if isinstance(data, Unset):
                return data
            try:
        ...
        def _parse_face(
            data: object,
        ) -> Union[None, PatchedWritableDeviceWithConfigContextRequestRackFace, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_1 = PatchedWritableDeviceWithConfigContextRequestRackFace(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                face_type_2_type_1 = (
                    PatchedWritableDeviceWithConfigContextRequestRackFace(data)
                )
            ...
            return cast(
                Union[
                    None, PatchedWritableDeviceWithConfigContextRequestRackFace, Unset
                ],
                data,
            )
        ...
        def _parse_airflow(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                airflow_type_1 = (
                    PatchedWritableDeviceWithConfigContextRequestAirflowType1(data)
                )
            ...
            try:
                ...
                airflow_type_2_type_1 = (
                    PatchedWritableDeviceWithConfigContextRequestAirflowType2Type1(data)
                )
            ...
            try:
                ...
                airflow_type_3_type_1 = (
                    PatchedWritableDeviceWithConfigContextRequestAirflowType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = (
                PatchedWritableDeviceWithConfigContextRequestCustomFields.from_dict(
                    _custom_fields
                )
            )
