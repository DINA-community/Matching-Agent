...
from ..models.writable_rack_request_airflow_type_1 import (
    WritableRackRequestAirflowType1,
)
from ..models.writable_rack_request_airflow_type_2_type_1 import (
    WritableRackRequestAirflowType2Type1,
)
from ..models.writable_rack_request_airflow_type_3_type_1 import (
    WritableRackRequestAirflowType3Type1,
)
from ..models.writable_rack_request_form_factor_type_1 import (
    WritableRackRequestFormFactorType1,
)
from ..models.writable_rack_request_form_factor_type_2_type_1 import (
    WritableRackRequestFormFactorType2Type1,
)
from ..models.writable_rack_request_form_factor_type_3_type_1 import (
    WritableRackRequestFormFactorType3Type1,
)
from ..models.writable_rack_request_outer_unit_type_1 import (
    WritableRackRequestOuterUnitType1,
)
from ..models.writable_rack_request_outer_unit_type_2_type_1 import (
    WritableRackRequestOuterUnitType2Type1,
)
from ..models.writable_rack_request_outer_unit_type_3_type_1 import (
    WritableRackRequestOuterUnitType3Type1,
)
from ..models.writable_rack_request_status import WritableRackRequestStatus
from ..models.writable_rack_request_weight_unit_type_1 import (
    WritableRackRequestWeightUnitType1,
)
from ..models.writable_rack_request_weight_unit_type_2_type_1 import (
    WritableRackRequestWeightUnitType2Type1,
)
from ..models.writable_rack_request_weight_unit_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_rack_request_custom_fields import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_form_factor(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_2_type_1 = WritableRackRequestFormFactorType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                form_factor_type_3_type_1 = WritableRackRequestFormFactorType3Type1(
                    data
                )
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_2_type_1 = WritableRackRequestWeightUnitType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_3_type_1 = WritableRackRequestWeightUnitType3Type1(
                    data
                )
