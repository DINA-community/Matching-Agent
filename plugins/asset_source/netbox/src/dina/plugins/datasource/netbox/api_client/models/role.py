...
if TYPE_CHECKING:
    ...
    from ..models.role_custom_fields import RoleCustomFields
...
class Role:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, RoleCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "RoleCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = RoleCustomFields.from_dict(_custom_fields)
