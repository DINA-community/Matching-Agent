...
class WritableCircuitGroupAssignmentRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.priority, Unset):
            ...
            self.priority, WritableCircuitGroupAssignmentRequestPriorityType1
        ):
            priority = self.priority.value
        elif isinstance(
            self.priority, WritableCircuitGroupAssignmentRequestPriorityType2Type1
        ):
            priority = self.priority.value
        elif isinstance(
            self.priority, WritableCircuitGroupAssignmentRequestPriorityType3Type1
        ):
            priority = self.priority.value
        else:
        ...
        def _parse_priority(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                priority_type_1 = WritableCircuitGroupAssignmentRequestPriorityType1(
                    data
                )
            ...
            try:
                ...
                priority_type_2_type_1 = (
                    WritableCircuitGroupAssignmentRequestPriorityType2Type1(data)
                )
            ...
            try:
                ...
                priority_type_3_type_1 = (
                    WritableCircuitGroupAssignmentRequestPriorityType3Type1(data)
                )
