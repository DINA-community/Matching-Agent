...
from ...models.paginated_cluster_type_list import PaginatedClusterTypeList
...
) -> Optional[PaginatedClusterTypeList]:
    if response.status_code == 200:
        response_200 = PaginatedClusterTypeList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedClusterTypeList]:
    return Response(
