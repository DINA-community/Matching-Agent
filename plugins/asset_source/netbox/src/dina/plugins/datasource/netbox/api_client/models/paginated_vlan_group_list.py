...
T = TypeVar("T", bound="PaginatedVLANGroupList")
...
class PaginatedVLANGroupList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VLANGroup.from_dict(results_item_data)
        ...
        paginated_vlan_group_list.additional_properties = d
        return paginated_vlan_group_list
