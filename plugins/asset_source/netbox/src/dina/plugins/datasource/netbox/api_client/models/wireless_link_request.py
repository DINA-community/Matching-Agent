...
from ..models.wireless_link_request_distance_unit_type_1 import (
    WirelessLinkRequestDistanceUnitType1,
)
from ..models.wireless_link_request_distance_unit_type_2_type_1 import (
    WirelessLinkRequestDistanceUnitType2Type1,
)
from ..models.wireless_link_request_distance_unit_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.wireless_link_request_custom_fields import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_distance_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_2_type_1 = WirelessLinkRequestDistanceUnitType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                distance_unit_type_3_type_1 = WirelessLinkRequestDistanceUnitType3Type1(
                    data
                )
