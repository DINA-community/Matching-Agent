...
from ...models.dcim_power_port_templates_list_type import DcimPowerPortTemplatesListType
from ...models.paginated_power_port_template_list import PaginatedPowerPortTemplateList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    allocated_draw: Union[Unset, list[int]] = UNSET,
    allocated_draw_empty: Union[Unset, bool] = UNSET,
    allocated_draw_gt: Union[Unset, list[int]] = UNSET,
    allocated_draw_gte: Union[Unset, list[int]] = UNSET,
    allocated_draw_lt: Union[Unset, list[int]] = UNSET,
    allocated_draw_lte: Union[Unset, list[int]] = UNSET,
    allocated_draw_n: Union[Unset, list[int]] = UNSET,
    ...
    maximum_draw: Union[Unset, list[int]] = UNSET,
    maximum_draw_empty: Union[Unset, bool] = UNSET,
    maximum_draw_gt: Union[Unset, list[int]] = UNSET,
    maximum_draw_gte: Union[Unset, list[int]] = UNSET,
    maximum_draw_lt: Union[Unset, list[int]] = UNSET,
    maximum_draw_lte: Union[Unset, list[int]] = UNSET,
    maximum_draw_n: Union[Unset, list[int]] = UNSET,
    ...
    type_: Union[Unset, DcimPowerPortTemplatesListType] = UNSET,
    updated_by_request: Union[Unset, UUID] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    json_allocated_draw: Union[Unset, list[int]] = UNSET
    if not isinstance(allocated_draw, Unset):
        json_allocated_draw = allocated_draw

    params["allocated_draw"] = json_allocated_draw

    params["allocated_draw__empty"] = allocated_draw_empty

    json_allocated_draw_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(allocated_draw_gt, Unset):
        json_allocated_draw_gt = allocated_draw_gt

    params["allocated_draw__gt"] = json_allocated_draw_gt

    json_allocated_draw_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(allocated_draw_gte, Unset):
        json_allocated_draw_gte = allocated_draw_gte

    params["allocated_draw__gte"] = json_allocated_draw_gte

    json_allocated_draw_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(allocated_draw_lt, Unset):
        json_allocated_draw_lt = allocated_draw_lt

    params["allocated_draw__lt"] = json_allocated_draw_lt

    json_allocated_draw_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(allocated_draw_lte, Unset):
        json_allocated_draw_lte = allocated_draw_lte

    params["allocated_draw__lte"] = json_allocated_draw_lte

    json_allocated_draw_n: Union[Unset, list[int]] = UNSET
    if not isinstance(allocated_draw_n, Unset):
        json_allocated_draw_n = allocated_draw_n

    params["allocated_draw__n"] = json_allocated_draw_n
    ...
    json_maximum_draw: Union[Unset, list[int]] = UNSET
    if not isinstance(maximum_draw, Unset):
        json_maximum_draw = maximum_draw

    params["maximum_draw"] = json_maximum_draw

    params["maximum_draw__empty"] = maximum_draw_empty

    json_maximum_draw_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(maximum_draw_gt, Unset):
        json_maximum_draw_gt = maximum_draw_gt

    params["maximum_draw__gt"] = json_maximum_draw_gt

    json_maximum_draw_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(maximum_draw_gte, Unset):
        json_maximum_draw_gte = maximum_draw_gte

    params["maximum_draw__gte"] = json_maximum_draw_gte

    json_maximum_draw_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(maximum_draw_lt, Unset):
        json_maximum_draw_lt = maximum_draw_lt

    params["maximum_draw__lt"] = json_maximum_draw_lt

    json_maximum_draw_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(maximum_draw_lte, Unset):
        json_maximum_draw_lte = maximum_draw_lte

    params["maximum_draw__lte"] = json_maximum_draw_lte

    json_maximum_draw_n: Union[Unset, list[int]] = UNSET
    if not isinstance(maximum_draw_n, Unset):
        json_maximum_draw_n = maximum_draw_n

    params["maximum_draw__n"] = json_maximum_draw_n
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/dcim/power-port-templates/",
        "params": params,
    }
...
) -> Optional[PaginatedPowerPortTemplateList]:
    if response.status_code == 200:
        response_200 = PaginatedPowerPortTemplateList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedPowerPortTemplateList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        allocated_draw (Union[Unset, list[int]]):
        allocated_draw_empty (Union[Unset, bool]):
        allocated_draw_gt (Union[Unset, list[int]]):
        allocated_draw_gte (Union[Unset, list[int]]):
        allocated_draw_lt (Union[Unset, list[int]]):
        allocated_draw_lte (Union[Unset, list[int]]):
        allocated_draw_n (Union[Unset, list[int]]):
        ...
        maximum_draw (Union[Unset, list[int]]):
        maximum_draw_empty (Union[Unset, bool]):
        maximum_draw_gt (Union[Unset, list[int]]):
        maximum_draw_gte (Union[Unset, list[int]]):
        maximum_draw_lt (Union[Unset, list[int]]):
        maximum_draw_lte (Union[Unset, list[int]]):
        maximum_draw_n (Union[Unset, list[int]]):
        ...
        q (Union[Unset, str]):
        type_ (Union[Unset, DcimPowerPortTemplatesListType]):
    ...
    kwargs = _get_kwargs(
        ...
        allocated_draw_empty=allocated_draw_empty,
        allocated_draw_gt=allocated_draw_gt,
        allocated_draw_gte=allocated_draw_gte,
        allocated_draw_lt=allocated_draw_lt,
        allocated_draw_lte=allocated_draw_lte,
        allocated_draw_n=allocated_draw_n,
        created=created,
        ...
        maximum_draw_empty=maximum_draw_empty,
        maximum_draw_gt=maximum_draw_gt,
        maximum_draw_gte=maximum_draw_gte,
        maximum_draw_lt=maximum_draw_lt,
        maximum_draw_lte=maximum_draw_lte,
        maximum_draw_n=maximum_draw_n,
