...
from ..models.patched_writable_l2vpn_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_l2vpn_request_custom_fields import (
...
class PatchedWritableL2VPNRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableL2VPNRequestCustomFields.from_dict(
                _custom_fields
            )
