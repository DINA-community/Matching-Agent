...
from ...models.paginated_platform_list import PaginatedPlatformList
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    available_for_device_type: Union[Unset, str] = UNSET,
    ...
    params["available_for_device_type"] = available_for_device_type
...
) -> Optional[PaginatedPlatformList]:
    if response.status_code == 200:
        response_200 = PaginatedPlatformList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedPlatformList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        available_for_device_type (Union[Unset, str]):
