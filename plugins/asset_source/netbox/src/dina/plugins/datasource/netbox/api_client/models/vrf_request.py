...
if TYPE_CHECKING:
    ...
    from ..models.vrf_request_custom_fields import VRFRequestCustomFields


T = TypeVar("T", bound="VRFRequest")
...
class VRFRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, VRFRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "VRFRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VRFRequestCustomFields.from_dict(_custom_fields)
        ...
        vrf_request.additional_properties = d
        return vrf_request
