...
T = TypeVar("T", bound="PaginatedFileHashList")


@_attrs_define
class PaginatedFileHashList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = FileHash.from_dict(results_item_data)
        ...
        paginated_file_hash_list.additional_properties = d
        return paginated_file_hash_list
