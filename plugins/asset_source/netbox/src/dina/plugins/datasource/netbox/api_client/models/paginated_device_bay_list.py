...
T = TypeVar("T", bound="PaginatedDeviceBayList")
...
class PaginatedDeviceBayList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DeviceBay.from_dict(results_item_data)
        ...
        paginated_device_bay_list.additional_properties = d
        return paginated_device_bay_list
