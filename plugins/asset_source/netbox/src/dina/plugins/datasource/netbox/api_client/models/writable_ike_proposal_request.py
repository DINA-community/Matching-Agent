...
from ..models.writable_ike_proposal_request_authentication_method import (
    WritableIKEProposalRequestAuthenticationMethod,
)
from ..models.writable_ike_proposal_request_encryption_algorithm import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ike_proposal_request_custom_fields import (
...
class WritableIKEProposalRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_authentication_algorithm(
            ...
            try:
                ...
                authentication_algorithm_type_1 = (
                    WritableIKEProposalRequestAuthenticationAlgorithmType1(data)
                )
            ...
            try:
                ...
                authentication_algorithm_type_2_type_1 = (
                    WritableIKEProposalRequestAuthenticationAlgorithmType2Type1(data)
                )
            ...
            try:
                ...
                authentication_algorithm_type_3_type_1 = (
                    WritableIKEProposalRequestAuthenticationAlgorithmType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIKEProposalRequestCustomFields.from_dict(
                _custom_fields
            )
