...
class PatchedWritableVirtualCircuitTerminationRequest:
    ...
    custom_fields: Union[
        Unset, "PatchedWritableVirtualCircuitTerminationRequestCustomFields"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_virtual_circuit(
            data: object,
        ) -> Union["BriefVirtualCircuitRequest", Unset, int]:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = (
                PatchedWritableVirtualCircuitTerminationRequestCustomFields.from_dict(
                    _custom_fields
                )
            )
