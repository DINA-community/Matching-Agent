...
from ..models.writable_console_port_template_request_type_type_1 import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritableConsolePortTemplateRequestTypeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritableConsolePortTemplateRequestTypeType3Type1(
                    data
                )
