...
T = TypeVar("T", bound="PaginatedDeviceRoleList")
...
class PaginatedDeviceRoleList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DeviceRole.from_dict(results_item_data)
        ...
        paginated_device_role_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_device_role_list.additional_properties = d
        return paginated_device_role_list
