...
from ..models.interface_template_poe_mode_type_0_label import (
    InterfaceTemplatePoeModeType0Label,
)
from ..models.interface_template_poe_mode_type_0_value_type_1 import (
...
class InterfaceTemplatePoeModeType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(
            data: object,
        ) -> Union[InterfaceTemplatePoeModeType0ValueType1, None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(
                Union[InterfaceTemplatePoeModeType0ValueType1, None, Unset], data
            )
