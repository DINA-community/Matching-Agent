...
from ..models.patched_writable_front_port_template_request_type import (
...
class PatchedWritableFrontPortTemplateRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.brief_device_type_request import BriefDeviceTypeRequest
        from ..models.brief_module_type_request import BriefModuleTypeRequest
        from ..models.brief_rear_port_template_request import (
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.rear_port, Unset):
            ...
            rear_port = (
                None,
                json.dumps(self.rear_port.to_dict()).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_rear_port(
            data: object,
        ) -> Union["BriefRearPortTemplateRequest", Unset, int]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
