...
from ..models.writable_power_outlet_request_feed_leg_type_1 import (
    WritablePowerOutletRequestFeedLegType1,
)
from ..models.writable_power_outlet_request_feed_leg_type_2_type_1 import (
    WritablePowerOutletRequestFeedLegType2Type1,
)
from ..models.writable_power_outlet_request_feed_leg_type_3_type_1 import (
    WritablePowerOutletRequestFeedLegType3Type1,
)
from ..models.writable_power_outlet_request_status import (
    WritablePowerOutletRequestStatus,
)
from ..models.writable_power_outlet_request_type_type_1 import (
    WritablePowerOutletRequestTypeType1,
)
from ..models.writable_power_outlet_request_type_type_2_type_1 import (
    WritablePowerOutletRequestTypeType2Type1,
)
from ..models.writable_power_outlet_request_type_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_power_outlet_request_custom_fields import (
...
class WritablePowerOutletRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_power_port(
            data: object,
        ) -> Union["BriefPowerPortRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_feed_leg(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_2_type_1 = WritablePowerOutletRequestFeedLegType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feed_leg_type_3_type_1 = WritablePowerOutletRequestFeedLegType3Type1(
                    data
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritablePowerOutletRequestCustomFields.from_dict(
                _custom_fields
            )
