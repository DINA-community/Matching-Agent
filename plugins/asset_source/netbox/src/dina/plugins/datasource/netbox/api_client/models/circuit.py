...
if TYPE_CHECKING:
    from ..models.brief_circuit_group_assignment_serializer import (
...
class Circuit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_distance_unit(
            data: object,
        ) -> Union["CircuitDistanceUnitType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        for assignments_item_data in _assignments or []:
            assignments_item = BriefCircuitGroupAssignmentSerializer.from_dict(
