...
from ..models.writable_power_port_template_request_type_type_1 import (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = WritablePowerPortTemplateRequestTypeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = WritablePowerPortTemplateRequestTypeType3Type1(
                    data
                )
