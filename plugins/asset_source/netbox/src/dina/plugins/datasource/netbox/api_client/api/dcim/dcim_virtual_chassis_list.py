...
from ...models.paginated_virtual_chassis_list import PaginatedVirtualChassisList
...
def _get_kwargs(
    *,
    ...
    domain_empty: Union[Unset, bool] = UNSET,
    domain_ic: Union[Unset, list[str]] = UNSET,
    domain_ie: Union[Unset, list[str]] = UNSET,
    domain_iew: Union[Unset, list[str]] = UNSET,
    domain_isw: Union[Unset, list[str]] = UNSET,
    domain_n: Union[Unset, list[str]] = UNSET,
    domain_nic: Union[Unset, list[str]] = UNSET,
    domain_nie: Union[Unset, list[str]] = UNSET,
    domain_niew: Union[Unset, list[str]] = UNSET,
    domain_nisw: Union[Unset, list[str]] = UNSET,
    ...
    master: Union[Unset, list[Union[None, str]]] = UNSET,
    master_n: Union[Unset, list[Union[None, str]]] = UNSET,
    master_id: Union[Unset, list[Union[None, int]]] = UNSET,
    master_id_n: Union[Unset, list[Union[None, int]]] = UNSET,
    member_count: Union[Unset, list[int]] = UNSET,
    member_count_empty: Union[Unset, bool] = UNSET,
    member_count_gt: Union[Unset, list[int]] = UNSET,
    member_count_gte: Union[Unset, list[int]] = UNSET,
    member_count_lt: Union[Unset, list[int]] = UNSET,
    member_count_lte: Union[Unset, list[int]] = UNSET,
    member_count_n: Union[Unset, list[int]] = UNSET,
    ...
    json_domain: Union[Unset, list[str]] = UNSET
    if not isinstance(domain, Unset):
        json_domain = domain

    params["domain"] = json_domain

    params["domain__empty"] = domain_empty

    json_domain_ic: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_ic, Unset):
        json_domain_ic = domain_ic

    params["domain__ic"] = json_domain_ic

    json_domain_ie: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_ie, Unset):
        json_domain_ie = domain_ie

    params["domain__ie"] = json_domain_ie

    json_domain_iew: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_iew, Unset):
        json_domain_iew = domain_iew

    params["domain__iew"] = json_domain_iew

    json_domain_isw: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_isw, Unset):
        json_domain_isw = domain_isw

    params["domain__isw"] = json_domain_isw

    json_domain_n: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_n, Unset):
        json_domain_n = domain_n

    params["domain__n"] = json_domain_n

    json_domain_nic: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_nic, Unset):
        json_domain_nic = domain_nic

    params["domain__nic"] = json_domain_nic

    json_domain_nie: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_nie, Unset):
        json_domain_nie = domain_nie

    params["domain__nie"] = json_domain_nie

    json_domain_niew: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_niew, Unset):
        json_domain_niew = domain_niew

    params["domain__niew"] = json_domain_niew

    json_domain_nisw: Union[Unset, list[str]] = UNSET
    if not isinstance(domain_nisw, Unset):
        json_domain_nisw = domain_nisw

    params["domain__nisw"] = json_domain_nisw
    ...
    json_master: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(master, Unset):
        json_master = []
        for master_item_data in master:
            master_item: Union[None, str]
            master_item = master_item_data
            json_master.append(master_item)

    params["master"] = json_master

    json_master_n: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(master_n, Unset):
        json_master_n = []
        for master_n_item_data in master_n:
            master_n_item: Union[None, str]
            master_n_item = master_n_item_data
            json_master_n.append(master_n_item)

    params["master__n"] = json_master_n

    json_master_id: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(master_id, Unset):
        json_master_id = []
        for master_id_item_data in master_id:
            master_id_item: Union[None, int]
            master_id_item = master_id_item_data
            json_master_id.append(master_id_item)

    params["master_id"] = json_master_id

    json_master_id_n: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(master_id_n, Unset):
        json_master_id_n = []
        for master_id_n_item_data in master_id_n:
            master_id_n_item: Union[None, int]
            master_id_n_item = master_id_n_item_data
            json_master_id_n.append(master_id_n_item)

    params["master_id__n"] = json_master_id_n

    json_member_count: Union[Unset, list[int]] = UNSET
    if not isinstance(member_count, Unset):
        json_member_count = member_count

    params["member_count"] = json_member_count

    params["member_count__empty"] = member_count_empty

    json_member_count_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(member_count_gt, Unset):
        json_member_count_gt = member_count_gt

    params["member_count__gt"] = json_member_count_gt

    json_member_count_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(member_count_gte, Unset):
        json_member_count_gte = member_count_gte

    params["member_count__gte"] = json_member_count_gte

    json_member_count_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(member_count_lt, Unset):
        json_member_count_lt = member_count_lt

    params["member_count__lt"] = json_member_count_lt

    json_member_count_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(member_count_lte, Unset):
        json_member_count_lte = member_count_lte

    params["member_count__lte"] = json_member_count_lte

    json_member_count_n: Union[Unset, list[int]] = UNSET
    if not isinstance(member_count_n, Unset):
        json_member_count_n = member_count_n

    params["member_count__n"] = json_member_count_n
...
) -> Optional[PaginatedVirtualChassisList]:
    if response.status_code == 200:
        response_200 = PaginatedVirtualChassisList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedVirtualChassisList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        domain (Union[Unset, list[str]]):
        domain_empty (Union[Unset, bool]):
        domain_ic (Union[Unset, list[str]]):
        domain_ie (Union[Unset, list[str]]):
        domain_iew (Union[Unset, list[str]]):
        domain_isw (Union[Unset, list[str]]):
        domain_n (Union[Unset, list[str]]):
        domain_nic (Union[Unset, list[str]]):
        domain_nie (Union[Unset, list[str]]):
        domain_niew (Union[Unset, list[str]]):
        domain_nisw (Union[Unset, list[str]]):
        ...
        master (Union[Unset, list[Union[None, str]]]):
        master_n (Union[Unset, list[Union[None, str]]]):
        master_id (Union[Unset, list[Union[None, int]]]):
        master_id_n (Union[Unset, list[Union[None, int]]]):
        member_count (Union[Unset, list[int]]):
        member_count_empty (Union[Unset, bool]):
        member_count_gt (Union[Unset, list[int]]):
        member_count_gte (Union[Unset, list[int]]):
        member_count_lt (Union[Unset, list[int]]):
        member_count_lte (Union[Unset, list[int]]):
        member_count_n (Union[Unset, list[int]]):
    ...
    kwargs = _get_kwargs(
        ...
        domain_ic=domain_ic,
        domain_ie=domain_ie,
        domain_iew=domain_iew,
        domain_isw=domain_isw,
        domain_n=domain_n,
        domain_nic=domain_nic,
        domain_nie=domain_nie,
        domain_niew=domain_niew,
        domain_nisw=domain_nisw,
        id=id,
        id_empty=id_empty,
        id_gt=id_gt,
        id_gte=id_gte,
        ...
        master_n=master_n,
        master_id=master_id,
        master_id_n=master_id_n,
        member_count=member_count,
        member_count_empty=member_count_empty,
        member_count_gt=member_count_gt,
        member_count_gte=member_count_gte,
        member_count_lt=member_count_lt,
        member_count_lte=member_count_lte,
        member_count_n=member_count_n,
