...
from ...models.paginated_module_bay_list import PaginatedModuleBayList
...
def _get_kwargs(
    *,
    ...
    installed_module_id: Union[Unset, list[int]] = UNSET,
    installed_module_id_n: Union[Unset, list[int]] = UNSET,
    ...
    json_installed_module_id: Union[Unset, list[int]] = UNSET
    if not isinstance(installed_module_id, Unset):
        json_installed_module_id = installed_module_id

    params["installed_module_id"] = json_installed_module_id

    json_installed_module_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(installed_module_id_n, Unset):
        json_installed_module_id_n = installed_module_id_n

    params["installed_module_id__n"] = json_installed_module_id_n
...
) -> Optional[PaginatedModuleBayList]:
    if response.status_code == 200:
        response_200 = PaginatedModuleBayList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedModuleBayList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        installed_module_id (Union[Unset, list[int]]):
        installed_module_id_n (Union[Unset, list[int]]):
    ...
    kwargs = _get_kwargs(
        ...
        installed_module_id_n=installed_module_id_n,
        label=label,
