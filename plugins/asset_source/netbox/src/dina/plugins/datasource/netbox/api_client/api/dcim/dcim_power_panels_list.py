...
from ...models.paginated_power_panel_list import PaginatedPowerPanelList
...
) -> Optional[PaginatedPowerPanelList]:
    if response.status_code == 200:
        response_200 = PaginatedPowerPanelList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedPowerPanelList]:
    return Response(
