...
from ..models.patched_writable_device_type_request_airflow_type_1 import (
...
class PatchedWritableDeviceTypeRequest:
    ...
    subdevice_role: Union[
        None, PatchedWritableDeviceTypeRequestParentchildStatus, Unset
    ] = UNSET
    airflow: Union[
        None,
        PatchedWritableDeviceTypeRequestAirflowType1,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.subdevice_role, Unset):
            ...
            self.subdevice_role, PatchedWritableDeviceTypeRequestParentchildStatus
        ):
        ...
        if isinstance(self.airflow, Unset):
            ...
            self.airflow, PatchedWritableDeviceTypeRequestAirflowType2Type1
        ):
            airflow = self.airflow.value
        elif isinstance(
            self.airflow, PatchedWritableDeviceTypeRequestAirflowType3Type1
        ):
            airflow = self.airflow.value
        else:
        ...
        if isinstance(self.weight_unit, Unset):
            ...
            self.weight_unit, PatchedWritableDeviceTypeRequestWeightUnitType1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableDeviceTypeRequestWeightUnitType2Type1
        ):
            weight_unit = self.weight_unit.value
        elif isinstance(
            self.weight_unit, PatchedWritableDeviceTypeRequestWeightUnitType3Type1
        ):
            weight_unit = self.weight_unit.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subdevice_role(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                subdevice_role_type_1 = (
                    PatchedWritableDeviceTypeRequestParentchildStatus(data)
                )
        ...
        def _parse_airflow(
            ...
            try:
                ...
                airflow_type_2_type_1 = (
                    PatchedWritableDeviceTypeRequestAirflowType2Type1(data)
                )
            ...
            try:
                ...
                airflow_type_3_type_1 = (
                    PatchedWritableDeviceTypeRequestAirflowType3Type1(data)
                )
        ...
        def _parse_weight_unit(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                weight_unit_type_1 = PatchedWritableDeviceTypeRequestWeightUnitType1(
                    data
                )
            ...
            try:
                ...
                weight_unit_type_2_type_1 = (
                    PatchedWritableDeviceTypeRequestWeightUnitType2Type1(data)
                )
            ...
            try:
                ...
                weight_unit_type_3_type_1 = (
                    PatchedWritableDeviceTypeRequestWeightUnitType3Type1(data)
                )
