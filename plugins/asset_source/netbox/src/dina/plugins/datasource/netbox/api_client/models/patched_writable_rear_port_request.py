...
from ..models.patched_writable_rear_port_request_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_rear_port_request_custom_fields import (
...
class PatchedWritableRearPortRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        positions = (
            ...
            else (None, str(self.positions).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableRearPortRequestCustomFields.from_dict(
                _custom_fields
            )
