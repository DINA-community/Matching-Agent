...
from ...models.paginated_contact_role_list import PaginatedContactRoleList
...
) -> Optional[PaginatedContactRoleList]:
    if response.status_code == 200:
        response_200 = PaginatedContactRoleList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedContactRoleList]:
    return Response(
