...
T = TypeVar("T", bound="PaginatedImageAttachmentList")
...
class PaginatedImageAttachmentList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ImageAttachment.from_dict(results_item_data)
        ...
        paginated_image_attachment_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_image_attachment_list.additional_properties = d
        return paginated_image_attachment_list
