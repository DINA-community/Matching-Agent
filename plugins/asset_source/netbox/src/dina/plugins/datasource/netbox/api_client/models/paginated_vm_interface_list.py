...
T = TypeVar("T", bound="PaginatedVMInterfaceList")
...
class PaginatedVMInterfaceList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VMInterface.from_dict(results_item_data)
        ...
        paginated_vm_interface_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vm_interface_list.additional_properties = d
        return paginated_vm_interface_list
