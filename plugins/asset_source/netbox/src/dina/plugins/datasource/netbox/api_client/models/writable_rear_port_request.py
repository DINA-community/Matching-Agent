...
from ..models.writable_rear_port_request_type import WritableRearPortRequestType
...
if TYPE_CHECKING:
    ...
    from ..models.writable_rear_port_request_custom_fields import (
        WritableRearPortRequestCustomFields,
    )


T = TypeVar("T", bound="WritableRearPortRequest")
...
class WritableRearPortRequest:
    ...
    Attributes:
        ...
        name (str):
        type_ (WritableRearPortRequestType): * `8p8c` - 8P8C
            * `8p6c` - 8P6C
            * `8p4c` - 8P4C
            * `8p2c` - 8P2C
            * `6p6c` - 6P6C
        ...
        custom_fields (Union[Unset, WritableRearPortRequestCustomFields]):
    """

    device: Union["BriefDeviceRequest", int]
    name: str
    type_: WritableRearPortRequestType
    ...
    custom_fields: Union[Unset, "WritableRearPortRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = WritableRearPortRequestType(d.pop("type"))
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableRearPortRequestCustomFields.from_dict(
                _custom_fields
            )

        writable_rear_port_request = cls(
            device=device,
            name=name,
            type_=type_,
            module=module,
        ...
        writable_rear_port_request.additional_properties = d
        return writable_rear_port_request
