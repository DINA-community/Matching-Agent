...
T = TypeVar("T", bound="PaginatedCustomFieldChoiceSetList")
...
class PaginatedCustomFieldChoiceSetList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CustomFieldChoiceSet.from_dict(results_item_data)
        ...
        paginated_custom_field_choice_set_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_custom_field_choice_set_list.additional_properties = d
        return paginated_custom_field_choice_set_list
