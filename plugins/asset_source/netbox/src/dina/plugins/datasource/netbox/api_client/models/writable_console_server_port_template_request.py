...
class WritableConsoleServerPortTemplateRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            ...
            self.type_, WritableConsoleServerPortTemplateRequestTypeType2Type1
        ):
            type_ = self.type_.value
        elif isinstance(
            self.type_, WritableConsoleServerPortTemplateRequestTypeType3Type1
        ):
            type_ = self.type_.value
        else:
            type_ = self.type_
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = (
                    WritableConsoleServerPortTemplateRequestTypeType2Type1(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = (
                    WritableConsoleServerPortTemplateRequestTypeType3Type1(data)
                )
