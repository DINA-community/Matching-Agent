...
from ..models.tunnel_termination_request_role import TunnelTerminationRequestRole
...
if TYPE_CHECKING:
    ...
    from ..models.tunnel_termination_request_custom_fields import (
        TunnelTerminationRequestCustomFields,
    )


T = TypeVar("T", bound="TunnelTerminationRequest")
...
class TunnelTerminationRequest:
    ...
    Attributes:
        ...
        role (TunnelTerminationRequestRole): * `peer` - Peer
            * `hub` - Hub
            * `spoke` - Spoke
        ...
        custom_fields (Union[Unset, TunnelTerminationRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "TunnelTerminationRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role = TunnelTerminationRequestRole(d.pop("role"))
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = TunnelTerminationRequestCustomFields.from_dict(
                _custom_fields
            )

        tunnel_termination_request = cls(
            tunnel=tunnel,
            role=role,
            termination_type=termination_type,
        ...
        tunnel_termination_request.additional_properties = d
        return tunnel_termination_request
