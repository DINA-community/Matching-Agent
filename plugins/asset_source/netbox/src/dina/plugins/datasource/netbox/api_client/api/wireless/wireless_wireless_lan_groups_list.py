...
from ...models.paginated_wireless_lan_group_list import PaginatedWirelessLANGroupList
...
) -> Optional[PaginatedWirelessLANGroupList]:
    if response.status_code == 200:
        response_200 = PaginatedWirelessLANGroupList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedWirelessLANGroupList]:
    return Response(
