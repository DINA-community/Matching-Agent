...
from ..models.patched_writable_location_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_location_request_custom_fields import (
...
class PatchedWritableLocationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableLocationRequestCustomFields.from_dict(
                _custom_fields
            )
