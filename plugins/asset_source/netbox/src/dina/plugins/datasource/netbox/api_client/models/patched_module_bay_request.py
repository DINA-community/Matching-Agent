...
if TYPE_CHECKING:
    ...
    from ..models.patched_module_bay_request_custom_fields import (
...
class PatchedModuleBayRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.installed_module, Unset):
            ...
            installed_module = (
                None,
                json.dumps(self.installed_module.to_dict()).encode(),
                "application/json",
            )
        else:
            installed_module = (None, str(self.installed_module).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedModuleBayRequestCustomFields.from_dict(
                _custom_fields
            )
