...
from ...models.paginated_inventory_item_role_list import PaginatedInventoryItemRoleList
...
) -> Optional[PaginatedInventoryItemRoleList]:
    if response.status_code == 200:
        response_200 = PaginatedInventoryItemRoleList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedInventoryItemRoleList]:
    return Response(
