...
from ...models.paginated_asn_range_list import PaginatedASNRangeList
...
def _get_kwargs(
    *,
    ...
    end: Union[Unset, list[int]] = UNSET,
    end_empty: Union[Unset, bool] = UNSET,
    end_gt: Union[Unset, list[int]] = UNSET,
    end_gte: Union[Unset, list[int]] = UNSET,
    end_lt: Union[Unset, list[int]] = UNSET,
    end_lte: Union[Unset, list[int]] = UNSET,
    end_n: Union[Unset, list[int]] = UNSET,
    ...
    start_empty: Union[Unset, bool] = UNSET,
    start_gt: Union[Unset, list[int]] = UNSET,
    start_gte: Union[Unset, list[int]] = UNSET,
    start_lt: Union[Unset, list[int]] = UNSET,
    start_lte: Union[Unset, list[int]] = UNSET,
    start_n: Union[Unset, list[int]] = UNSET,
    ...
    json_end: Union[Unset, list[int]] = UNSET
    if not isinstance(end, Unset):
        json_end = end

    params["end"] = json_end

    params["end__empty"] = end_empty

    json_end_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(end_gt, Unset):
        json_end_gt = end_gt

    params["end__gt"] = json_end_gt

    json_end_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(end_gte, Unset):
        json_end_gte = end_gte

    params["end__gte"] = json_end_gte

    json_end_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(end_lt, Unset):
        json_end_lt = end_lt

    params["end__lt"] = json_end_lt

    json_end_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(end_lte, Unset):
        json_end_lte = end_lte

    params["end__lte"] = json_end_lte

    json_end_n: Union[Unset, list[int]] = UNSET
    if not isinstance(end_n, Unset):
        json_end_n = end_n

    params["end__n"] = json_end_n
    ...
    json_start: Union[Unset, list[int]] = UNSET
    if not isinstance(start, Unset):
        json_start = start

    params["start"] = json_start

    params["start__empty"] = start_empty

    json_start_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(start_gt, Unset):
        json_start_gt = start_gt

    params["start__gt"] = json_start_gt

    json_start_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(start_gte, Unset):
        json_start_gte = start_gte

    params["start__gte"] = json_start_gte

    json_start_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(start_lt, Unset):
        json_start_lt = start_lt

    params["start__lt"] = json_start_lt

    json_start_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(start_lte, Unset):
        json_start_lte = start_lte

    params["start__lte"] = json_start_lte

    json_start_n: Union[Unset, list[int]] = UNSET
    if not isinstance(start_n, Unset):
        json_start_n = start_n

    params["start__n"] = json_start_n
...
) -> Optional[PaginatedASNRangeList]:
    if response.status_code == 200:
        response_200 = PaginatedASNRangeList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedASNRangeList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end (Union[Unset, list[int]]):
        end_empty (Union[Unset, bool]):
        end_gt (Union[Unset, list[int]]):
        end_gte (Union[Unset, list[int]]):
        end_lt (Union[Unset, list[int]]):
        end_lte (Union[Unset, list[int]]):
        end_n (Union[Unset, list[int]]):
        ...
        start (Union[Unset, list[int]]):
        start_empty (Union[Unset, bool]):
        start_gt (Union[Unset, list[int]]):
        start_gte (Union[Unset, list[int]]):
        start_lt (Union[Unset, list[int]]):
        start_lte (Union[Unset, list[int]]):
        start_n (Union[Unset, list[int]]):
