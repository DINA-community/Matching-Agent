...
T = TypeVar("T", bound="PaginatedSiteGroupList")
...
class PaginatedSiteGroupList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SiteGroup.from_dict(results_item_data)
        ...
        paginated_site_group_list.additional_properties = d
        return paginated_site_group_list
