...
from ..models.patched_writable_ip_sec_profile_request_mode import (
...
class PatchedWritableIPSecProfileRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_ike_policy(
            data: object,
        ) -> Union["BriefIKEPolicyRequest", Unset, int]:
        ...
        def _parse_ipsec_policy(
            data: object,
        ) -> Union["BriefIPSecPolicyRequest", Unset, int]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableIPSecProfileRequestCustomFields.from_dict(
                _custom_fields
            )
