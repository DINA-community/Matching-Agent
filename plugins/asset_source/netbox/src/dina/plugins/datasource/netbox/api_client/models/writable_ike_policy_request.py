...
from ..models.writable_ike_policy_request_mode_type_1 import (
    WritableIKEPolicyRequestModeType1,
)
from ..models.writable_ike_policy_request_mode_type_2_type_1 import (
    WritableIKEPolicyRequestModeType2Type1,
)
from ..models.writable_ike_policy_request_mode_type_3_type_1 import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ike_policy_request_custom_fields import (
...
class WritableIKEPolicyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIKEPolicyRequestCustomFields.from_dict(
                _custom_fields
            )
