...
from ..models.writable_virtual_circuit_termination_request_role import (
...
class WritableVirtualCircuitTerminationRequest:
    ...
    custom_fields: Union[
        Unset, "WritableVirtualCircuitTerminationRequestCustomFields"
    ] = UNSET
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.virtual_circuit, int):
            ...
            virtual_circuit = (
                None,
                json.dumps(self.virtual_circuit.to_dict()).encode(),
                "application/json",
            )
        ...
        if isinstance(self.interface, int):
            ...
            interface = (
                None,
                json.dumps(self.interface.to_dict()).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = (
                WritableVirtualCircuitTerminationRequestCustomFields.from_dict(
                    _custom_fields
                )
            )
