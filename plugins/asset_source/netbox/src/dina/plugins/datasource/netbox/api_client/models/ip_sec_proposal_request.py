...
from ..models.ip_sec_proposal_request_authentication_algorithm import (
    IPSecProposalRequestAuthenticationAlgorithm,
)
from ..models.ip_sec_proposal_request_encryption_algorithm import (
    IPSecProposalRequestEncryptionAlgorithm,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ip_sec_proposal_request_custom_fields import (
...
class IPSecProposalRequest:
    ...
    authentication_algorithm: Union[
        Unset, IPSecProposalRequestAuthenticationAlgorithm
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_encryption_algorithm, Unset):
            ...
            encryption_algorithm = IPSecProposalRequestEncryptionAlgorithm(
        ...
        if isinstance(_authentication_algorithm, Unset):
            ...
            authentication_algorithm = IPSecProposalRequestAuthenticationAlgorithm(
