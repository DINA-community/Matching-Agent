...
T = TypeVar("T", bound="PaginatedBookmarkList")
...
class PaginatedBookmarkList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Bookmark.from_dict(results_item_data)
        ...
        paginated_bookmark_list.additional_properties = d
        return paginated_bookmark_list
