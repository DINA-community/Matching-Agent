...
from ...models.paginated_provider_network_list import PaginatedProviderNetworkList
...
def _get_kwargs(
    *,
    ...
    service_id_empty: Union[Unset, bool] = UNSET,
    service_id_ic: Union[Unset, list[str]] = UNSET,
    service_id_ie: Union[Unset, list[str]] = UNSET,
    service_id_iew: Union[Unset, list[str]] = UNSET,
    service_id_isw: Union[Unset, list[str]] = UNSET,
    service_id_n: Union[Unset, list[str]] = UNSET,
    service_id_nic: Union[Unset, list[str]] = UNSET,
    service_id_nie: Union[Unset, list[str]] = UNSET,
    service_id_niew: Union[Unset, list[str]] = UNSET,
    service_id_nisw: Union[Unset, list[str]] = UNSET,
    ...
    params["service_id__empty"] = service_id_empty

    json_service_id_ic: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_ic, Unset):
        json_service_id_ic = service_id_ic

    params["service_id__ic"] = json_service_id_ic

    json_service_id_ie: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_ie, Unset):
        json_service_id_ie = service_id_ie

    params["service_id__ie"] = json_service_id_ie

    json_service_id_iew: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_iew, Unset):
        json_service_id_iew = service_id_iew

    params["service_id__iew"] = json_service_id_iew

    json_service_id_isw: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_isw, Unset):
        json_service_id_isw = service_id_isw

    params["service_id__isw"] = json_service_id_isw

    json_service_id_n: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_n, Unset):
        json_service_id_n = service_id_n

    params["service_id__n"] = json_service_id_n

    json_service_id_nic: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_nic, Unset):
        json_service_id_nic = service_id_nic

    params["service_id__nic"] = json_service_id_nic

    json_service_id_nie: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_nie, Unset):
        json_service_id_nie = service_id_nie

    params["service_id__nie"] = json_service_id_nie

    json_service_id_niew: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_niew, Unset):
        json_service_id_niew = service_id_niew

    params["service_id__niew"] = json_service_id_niew

    json_service_id_nisw: Union[Unset, list[str]] = UNSET
    if not isinstance(service_id_nisw, Unset):
        json_service_id_nisw = service_id_nisw

    params["service_id__nisw"] = json_service_id_nisw
...
) -> Optional[PaginatedProviderNetworkList]:
    if response.status_code == 200:
        response_200 = PaginatedProviderNetworkList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedProviderNetworkList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        service_id_empty (Union[Unset, bool]):
        service_id_ic (Union[Unset, list[str]]):
        service_id_ie (Union[Unset, list[str]]):
        service_id_iew (Union[Unset, list[str]]):
        service_id_isw (Union[Unset, list[str]]):
        service_id_n (Union[Unset, list[str]]):
        service_id_nic (Union[Unset, list[str]]):
        service_id_nie (Union[Unset, list[str]]):
        service_id_niew (Union[Unset, list[str]]):
        service_id_nisw (Union[Unset, list[str]]):
