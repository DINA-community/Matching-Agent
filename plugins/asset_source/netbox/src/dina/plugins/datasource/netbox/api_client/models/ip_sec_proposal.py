...
if TYPE_CHECKING:
    from ..models.ip_sec_proposal_authentication_algorithm import (
        IPSecProposalAuthenticationAlgorithm,
    )
    from ..models.ip_sec_proposal_custom_fields import IPSecProposalCustomFields
    from ..models.ip_sec_proposal_encryption_algorithm import (
...
class IPSecProposal:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_encryption_algorithm, Unset):
            ...
            encryption_algorithm = IPSecProposalEncryptionAlgorithm.from_dict(
        ...
        if isinstance(_authentication_algorithm, Unset):
            ...
            authentication_algorithm = IPSecProposalAuthenticationAlgorithm.from_dict(
