...
from ...models.paginated_wireless_lan_list import PaginatedWirelessLANList
...
) -> Optional[PaginatedWirelessLANList]:
    if response.status_code == 200:
        response_200 = PaginatedWirelessLANList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedWirelessLANList]:
    return Response(
