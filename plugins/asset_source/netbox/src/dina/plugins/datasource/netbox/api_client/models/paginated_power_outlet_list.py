...
T = TypeVar("T", bound="PaginatedPowerOutletList")
...
class PaginatedPowerOutletList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PowerOutlet.from_dict(results_item_data)
        ...
        paginated_power_outlet_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_power_outlet_list.additional_properties = d
        return paginated_power_outlet_list
