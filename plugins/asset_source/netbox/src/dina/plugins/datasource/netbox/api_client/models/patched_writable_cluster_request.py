...
from ..models.patched_writable_cluster_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.patched_writable_cluster_request_custom_fields import (
        PatchedWritableClusterRequestCustomFields,
    )


T = TypeVar("T", bound="PatchedWritableClusterRequest")
...
class PatchedWritableClusterRequest:
    ...
    Attributes:
        ...
        type_ (Union['BriefClusterTypeRequest', Unset, int]):
        group (Union['BriefClusterGroupRequest', None, Unset, int]):
        status (Union[Unset, PatchedWritableClusterRequestStatus]): * `planned` - Planned
            * `staging` - Staging
            * `active` - Active
        ...
        custom_fields (Union[Unset, PatchedWritableClusterRequestCustomFields]):
    """

    name: Union[Unset, str] = UNSET
    type_: Union["BriefClusterTypeRequest", Unset, int] = UNSET
    group: Union["BriefClusterGroupRequest", None, Unset, int] = UNSET
    status: Union[Unset, PatchedWritableClusterRequestStatus] = UNSET
    ...
    custom_fields: Union[Unset, "PatchedWritableClusterRequestCustomFields"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, BriefClusterTypeRequest):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(data: object) -> Union["BriefClusterTypeRequest", Unset, int]:
            ...
            try:
                ...
                pass
            return cast(Union["BriefClusterTypeRequest", Unset, int], data)

        type_ = _parse_type_(d.pop("type", UNSET))

        def _parse_group(
            data: object,
        ) -> Union["BriefClusterGroupRequest", None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        status: Union[Unset, PatchedWritableClusterRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = PatchedWritableClusterRequestStatus(_status)
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableClusterRequestCustomFields.from_dict(
                _custom_fields
            )

        patched_writable_cluster_request = cls(
            name=name,
            type_=type_,
            group=group,
            status=status,
        ...
        patched_writable_cluster_request.additional_properties = d
        return patched_writable_cluster_request
