...
from ..models.writable_ip_sec_proposal_request_authentication import (
    WritableIPSecProposalRequestAuthentication,
)
from ..models.writable_ip_sec_proposal_request_encryption import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_ip_sec_proposal_request_custom_fields import (
...
class WritableIPSecProposalRequest:
    ...
    encryption_algorithm: Union[None, Unset, WritableIPSecProposalRequestEncryption] = (
        UNSET
    )
    authentication_algorithm: Union[
        None, Unset, WritableIPSecProposalRequestAuthentication
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.encryption_algorithm, Unset):
            ...
            self.encryption_algorithm, WritableIPSecProposalRequestEncryption
        ):
        ...
        if isinstance(self.authentication_algorithm, Unset):
            ...
            self.authentication_algorithm, WritableIPSecProposalRequestAuthentication
        ):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.encryption_algorithm, Unset):
            ...
            encryption_algorithm = (
                None,
                str(self.encryption_algorithm).encode(),
                "text/plain",
            )
        elif isinstance(
            self.encryption_algorithm, WritableIPSecProposalRequestEncryption
        ...
        if isinstance(self.sa_lifetime_seconds, Unset):
            ...
            sa_lifetime_seconds = (
                None,
                str(self.sa_lifetime_seconds).encode(),
                "text/plain",
            )
        else:
            sa_lifetime_seconds = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_encryption_algorithm(
            data: object,
        ) -> Union[None, Unset, WritableIPSecProposalRequestEncryption]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_1 = WritableIPSecProposalRequestEncryption(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_2_type_1 = (
                    WritableIPSecProposalRequestEncryption(data)
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                encryption_algorithm_type_3_type_1 = (
                    WritableIPSecProposalRequestEncryption(data)
                )
                ...
                pass
            return cast(
                Union[None, Unset, WritableIPSecProposalRequestEncryption], data
            )

        encryption_algorithm = _parse_encryption_algorithm(
            d.pop("encryption_algorithm", UNSET)
        )
        ...
        def _parse_authentication_algorithm(
            ...
            try:
                ...
                authentication_algorithm_type_1 = (
                    WritableIPSecProposalRequestAuthentication(data)
                )
            ...
            try:
                ...
                pass
            return cast(
                Union[None, Unset, WritableIPSecProposalRequestAuthentication], data
            )
        ...
        sa_lifetime_seconds = _parse_sa_lifetime_seconds(
            d.pop("sa_lifetime_seconds", UNSET)
        )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableIPSecProposalRequestCustomFields.from_dict(
                _custom_fields
            )
