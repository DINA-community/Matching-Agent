...
from ...models.paginated_route_target_list import PaginatedRouteTargetList
...
def _get_kwargs(
    *,
    ...
    exporting_l2vpn: Union[Unset, list[Union[None, int]]] = UNSET,
    exporting_l2vpn_n: Union[Unset, list[Union[None, int]]] = UNSET,
    exporting_l2vpn_id: Union[Unset, list[int]] = UNSET,
    exporting_l2vpn_id_n: Union[Unset, list[int]] = UNSET,
    exporting_vrf: Union[Unset, list[Union[None, str]]] = UNSET,
    exporting_vrf_n: Union[Unset, list[Union[None, str]]] = UNSET,
    exporting_vrf_id: Union[Unset, list[int]] = UNSET,
    exporting_vrf_id_n: Union[Unset, list[int]] = UNSET,
    ...
    importing_l2vpn: Union[Unset, list[Union[None, int]]] = UNSET,
    importing_l2vpn_n: Union[Unset, list[Union[None, int]]] = UNSET,
    importing_l2vpn_id: Union[Unset, list[int]] = UNSET,
    importing_l2vpn_id_n: Union[Unset, list[int]] = UNSET,
    importing_vrf: Union[Unset, list[Union[None, str]]] = UNSET,
    importing_vrf_n: Union[Unset, list[Union[None, str]]] = UNSET,
    importing_vrf_id: Union[Unset, list[int]] = UNSET,
    importing_vrf_id_n: Union[Unset, list[int]] = UNSET,
    ...
    json_exporting_l2vpn: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(exporting_l2vpn, Unset):
        json_exporting_l2vpn = []
        for exporting_l2vpn_item_data in exporting_l2vpn:
            exporting_l2vpn_item: Union[None, int]
            exporting_l2vpn_item = exporting_l2vpn_item_data
            json_exporting_l2vpn.append(exporting_l2vpn_item)

    params["exporting_l2vpn"] = json_exporting_l2vpn

    json_exporting_l2vpn_n: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(exporting_l2vpn_n, Unset):
        json_exporting_l2vpn_n = []
        for exporting_l2vpn_n_item_data in exporting_l2vpn_n:
            exporting_l2vpn_n_item: Union[None, int]
            exporting_l2vpn_n_item = exporting_l2vpn_n_item_data
            json_exporting_l2vpn_n.append(exporting_l2vpn_n_item)

    params["exporting_l2vpn__n"] = json_exporting_l2vpn_n

    json_exporting_l2vpn_id: Union[Unset, list[int]] = UNSET
    if not isinstance(exporting_l2vpn_id, Unset):
        json_exporting_l2vpn_id = exporting_l2vpn_id

    params["exporting_l2vpn_id"] = json_exporting_l2vpn_id

    json_exporting_l2vpn_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(exporting_l2vpn_id_n, Unset):
        json_exporting_l2vpn_id_n = exporting_l2vpn_id_n

    params["exporting_l2vpn_id__n"] = json_exporting_l2vpn_id_n

    json_exporting_vrf: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(exporting_vrf, Unset):
        json_exporting_vrf = []
        for exporting_vrf_item_data in exporting_vrf:
            exporting_vrf_item: Union[None, str]
            exporting_vrf_item = exporting_vrf_item_data
            json_exporting_vrf.append(exporting_vrf_item)

    params["exporting_vrf"] = json_exporting_vrf

    json_exporting_vrf_n: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(exporting_vrf_n, Unset):
        json_exporting_vrf_n = []
        for exporting_vrf_n_item_data in exporting_vrf_n:
            exporting_vrf_n_item: Union[None, str]
            exporting_vrf_n_item = exporting_vrf_n_item_data
            json_exporting_vrf_n.append(exporting_vrf_n_item)

    params["exporting_vrf__n"] = json_exporting_vrf_n

    json_exporting_vrf_id: Union[Unset, list[int]] = UNSET
    if not isinstance(exporting_vrf_id, Unset):
        json_exporting_vrf_id = exporting_vrf_id

    params["exporting_vrf_id"] = json_exporting_vrf_id

    json_exporting_vrf_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(exporting_vrf_id_n, Unset):
        json_exporting_vrf_id_n = exporting_vrf_id_n

    params["exporting_vrf_id__n"] = json_exporting_vrf_id_n
    ...
    json_importing_l2vpn: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(importing_l2vpn, Unset):
        json_importing_l2vpn = []
        for importing_l2vpn_item_data in importing_l2vpn:
            importing_l2vpn_item: Union[None, int]
            importing_l2vpn_item = importing_l2vpn_item_data
            json_importing_l2vpn.append(importing_l2vpn_item)

    params["importing_l2vpn"] = json_importing_l2vpn

    json_importing_l2vpn_n: Union[Unset, list[Union[None, int]]] = UNSET
    if not isinstance(importing_l2vpn_n, Unset):
        json_importing_l2vpn_n = []
        for importing_l2vpn_n_item_data in importing_l2vpn_n:
            importing_l2vpn_n_item: Union[None, int]
            importing_l2vpn_n_item = importing_l2vpn_n_item_data
            json_importing_l2vpn_n.append(importing_l2vpn_n_item)

    params["importing_l2vpn__n"] = json_importing_l2vpn_n

    json_importing_l2vpn_id: Union[Unset, list[int]] = UNSET
    if not isinstance(importing_l2vpn_id, Unset):
        json_importing_l2vpn_id = importing_l2vpn_id

    params["importing_l2vpn_id"] = json_importing_l2vpn_id

    json_importing_l2vpn_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(importing_l2vpn_id_n, Unset):
        json_importing_l2vpn_id_n = importing_l2vpn_id_n

    params["importing_l2vpn_id__n"] = json_importing_l2vpn_id_n

    json_importing_vrf: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(importing_vrf, Unset):
        json_importing_vrf = []
        for importing_vrf_item_data in importing_vrf:
            importing_vrf_item: Union[None, str]
            importing_vrf_item = importing_vrf_item_data
            json_importing_vrf.append(importing_vrf_item)

    params["importing_vrf"] = json_importing_vrf

    json_importing_vrf_n: Union[Unset, list[Union[None, str]]] = UNSET
    if not isinstance(importing_vrf_n, Unset):
        json_importing_vrf_n = []
        for importing_vrf_n_item_data in importing_vrf_n:
            importing_vrf_n_item: Union[None, str]
            importing_vrf_n_item = importing_vrf_n_item_data
            json_importing_vrf_n.append(importing_vrf_n_item)

    params["importing_vrf__n"] = json_importing_vrf_n

    json_importing_vrf_id: Union[Unset, list[int]] = UNSET
    if not isinstance(importing_vrf_id, Unset):
        json_importing_vrf_id = importing_vrf_id

    params["importing_vrf_id"] = json_importing_vrf_id

    json_importing_vrf_id_n: Union[Unset, list[int]] = UNSET
    if not isinstance(importing_vrf_id_n, Unset):
        json_importing_vrf_id_n = importing_vrf_id_n

    params["importing_vrf_id__n"] = json_importing_vrf_id_n
...
) -> Optional[PaginatedRouteTargetList]:
    if response.status_code == 200:
        response_200 = PaginatedRouteTargetList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedRouteTargetList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        exporting_l2vpn (Union[Unset, list[Union[None, int]]]):
        exporting_l2vpn_n (Union[Unset, list[Union[None, int]]]):
        exporting_l2vpn_id (Union[Unset, list[int]]):
        exporting_l2vpn_id_n (Union[Unset, list[int]]):
        exporting_vrf (Union[Unset, list[Union[None, str]]]):
        exporting_vrf_n (Union[Unset, list[Union[None, str]]]):
        exporting_vrf_id (Union[Unset, list[int]]):
        exporting_vrf_id_n (Union[Unset, list[int]]):
        ...
        importing_l2vpn (Union[Unset, list[Union[None, int]]]):
        importing_l2vpn_n (Union[Unset, list[Union[None, int]]]):
        importing_l2vpn_id (Union[Unset, list[int]]):
        importing_l2vpn_id_n (Union[Unset, list[int]]):
        importing_vrf (Union[Unset, list[Union[None, str]]]):
        importing_vrf_n (Union[Unset, list[Union[None, str]]]):
        importing_vrf_id (Union[Unset, list[int]]):
        importing_vrf_id_n (Union[Unset, list[int]]):
    ...
    kwargs = _get_kwargs(
        ...
        exporting_l2vpn_n=exporting_l2vpn_n,
        exporting_l2vpn_id=exporting_l2vpn_id,
        exporting_l2vpn_id_n=exporting_l2vpn_id_n,
        ...
        importing_l2vpn_n=importing_l2vpn_n,
        importing_l2vpn_id=importing_l2vpn_id,
        importing_l2vpn_id_n=importing_l2vpn_id_n,
