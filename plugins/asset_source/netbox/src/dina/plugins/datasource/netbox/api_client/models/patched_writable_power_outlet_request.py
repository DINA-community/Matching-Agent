...
from ..models.patched_writable_power_outlet_request_feed_leg_type_1 import (
...
from ..models.patched_writable_power_outlet_request_status import (
    PatchedWritablePowerOutletRequestStatus,
)
from ..models.patched_writable_power_outlet_request_type_type_1 import (
...
class PatchedWritablePowerOutletRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.feed_leg, Unset):
            ...
            self.feed_leg, PatchedWritablePowerOutletRequestFeedLegType2Type1
        ):
            feed_leg = self.feed_leg.value
        elif isinstance(
            self.feed_leg, PatchedWritablePowerOutletRequestFeedLegType3Type1
        ):
            feed_leg = self.feed_leg.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_2_type_1 = PatchedWritablePowerOutletRequestTypeType2Type1(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_3_type_1 = PatchedWritablePowerOutletRequestTypeType3Type1(
                    data
                )
        ...
        def _parse_feed_leg(
            ...
            try:
                ...
                feed_leg_type_2_type_1 = (
                    PatchedWritablePowerOutletRequestFeedLegType2Type1(data)
                )
            ...
            try:
                ...
                feed_leg_type_3_type_1 = (
                    PatchedWritablePowerOutletRequestFeedLegType3Type1(data)
                )
