...
T = TypeVar("T", bound="PaginatedASNList")
...
class PaginatedASNList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ASN.from_dict(results_item_data)
        ...
        paginated_asn_list.additional_properties = d
        return paginated_asn_list
