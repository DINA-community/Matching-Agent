...
if TYPE_CHECKING:
    ...
    from ..models.virtual_disk_custom_fields import VirtualDiskCustomFields
...
class VirtualDisk:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, VirtualDiskCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "VirtualDiskCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = VirtualDiskCustomFields.from_dict(_custom_fields)
