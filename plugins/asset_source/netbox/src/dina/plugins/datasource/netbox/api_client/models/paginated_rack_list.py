...
T = TypeVar("T", bound="PaginatedRackList")
...
class PaginatedRackList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Rack.from_dict(results_item_data)
        ...
        paginated_rack_list.additional_properties = d
        return paginated_rack_list
