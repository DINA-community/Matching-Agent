...
T = TypeVar("T", bound="PaginatedProviderAccountList")
...
class PaginatedProviderAccountList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProviderAccount.from_dict(results_item_data)
        ...
        paginated_provider_account_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_provider_account_list.additional_properties = d
        return paginated_provider_account_list
