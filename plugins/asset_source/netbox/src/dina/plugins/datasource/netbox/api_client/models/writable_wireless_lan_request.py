...
from ..models.writable_wireless_lan_request_authentication_cipher import (
    WritableWirelessLANRequestAuthenticationCipher,
)
from ..models.writable_wireless_lan_request_authentication_type import (
    WritableWirelessLANRequestAuthenticationType,
)
from ..models.writable_wireless_lan_request_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.writable_wireless_lan_request_custom_fields import (
...
class WritableWirelessLANRequest:
    ...
    auth_cipher: Union[None, Unset, WritableWirelessLANRequestAuthenticationCipher] = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.brief_tenant_request import BriefTenantRequest
        from ..models.brief_vlan_request import BriefVLANRequest
        from ..models.brief_wireless_lan_group_request import (
        ...
        if isinstance(self.auth_cipher, Unset):
            ...
            self.auth_cipher, WritableWirelessLANRequestAuthenticationCipher
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_group(
            data: object,
        ) -> Union["BriefWirelessLANGroupRequest", None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_auth_type(
            data: object,
        ) -> Union[None, Unset, WritableWirelessLANRequestAuthenticationType]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_2_type_1 = WritableWirelessLANRequestAuthenticationType(
                    data
                )
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_type_type_3_type_1 = WritableWirelessLANRequestAuthenticationType(
                    data
                )
                ...
                pass
            return cast(
                Union[None, Unset, WritableWirelessLANRequestAuthenticationType], data
            )
        ...
        def _parse_auth_cipher(
            data: object,
        ) -> Union[None, Unset, WritableWirelessLANRequestAuthenticationCipher]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                auth_cipher_type_1 = WritableWirelessLANRequestAuthenticationCipher(
                    data
                )
            ...
            try:
                ...
                auth_cipher_type_2_type_1 = (
                    WritableWirelessLANRequestAuthenticationCipher(data)
                )
            ...
            try:
                ...
                pass
            return cast(
                Union[None, Unset, WritableWirelessLANRequestAuthenticationCipher], data
            )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableWirelessLANRequestCustomFields.from_dict(
                _custom_fields
            )
