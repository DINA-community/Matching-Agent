...
if TYPE_CHECKING:
    ...
    from ..models.rear_port_template_type import RearPortTemplateType


T = TypeVar("T", bound="RearPortTemplate")
...
class RearPortTemplate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RearPortTemplateType.from_dict(d.pop("type"))
        ...
        rear_port_template.additional_properties = d
        return rear_port_template
