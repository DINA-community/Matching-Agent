...
T = TypeVar("T", bound="PaginatedIKEPolicyList")
...
class PaginatedIKEPolicyList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IKEPolicy.from_dict(results_item_data)
        ...
        paginated_ike_policy_list.additional_properties = d
        return paginated_ike_policy_list
