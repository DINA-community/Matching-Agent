...
from ...models.paginated_communication_list import PaginatedCommunicationList
...
def _get_kwargs(
    *,
    ...
    destination_device: Union[Unset, int] = UNSET,
    destination_device_n: Union[Unset, int] = UNSET,
    destination_ip_addr: Union[Unset, int] = UNSET,
    destination_ip_addr_n: Union[Unset, int] = UNSET,
    destination_port: Union[Unset, list[int]] = UNSET,
    destination_port_empty: Union[Unset, bool] = UNSET,
    destination_port_gt: Union[Unset, list[int]] = UNSET,
    destination_port_gte: Union[Unset, list[int]] = UNSET,
    destination_port_lt: Union[Unset, list[int]] = UNSET,
    destination_port_lte: Union[Unset, list[int]] = UNSET,
    destination_port_n: Union[Unset, list[int]] = UNSET,
    ...
    source_device: Union[Unset, int] = UNSET,
    source_device_n: Union[Unset, int] = UNSET,
    source_ip_addr: Union[Unset, int] = UNSET,
    source_ip_addr_n: Union[Unset, int] = UNSET,
    ...
    params["destination_device"] = destination_device

    params["destination_device__n"] = destination_device_n

    params["destination_ip_addr"] = destination_ip_addr

    params["destination_ip_addr__n"] = destination_ip_addr_n

    json_destination_port: Union[Unset, list[int]] = UNSET
    ...
    json_destination_port_gt: Union[Unset, list[int]] = UNSET
    if not isinstance(destination_port_gt, Unset):
        json_destination_port_gt = destination_port_gt

    params["destination_port__gt"] = json_destination_port_gt

    json_destination_port_gte: Union[Unset, list[int]] = UNSET
    if not isinstance(destination_port_gte, Unset):
        json_destination_port_gte = destination_port_gte

    params["destination_port__gte"] = json_destination_port_gte

    json_destination_port_lt: Union[Unset, list[int]] = UNSET
    if not isinstance(destination_port_lt, Unset):
        json_destination_port_lt = destination_port_lt

    params["destination_port__lt"] = json_destination_port_lt

    json_destination_port_lte: Union[Unset, list[int]] = UNSET
    if not isinstance(destination_port_lte, Unset):
        json_destination_port_lte = destination_port_lte

    params["destination_port__lte"] = json_destination_port_lte

    json_destination_port_n: Union[Unset, list[int]] = UNSET
    ...
    params["source_device"] = source_device

    params["source_device__n"] = source_device_n

    params["source_ip_addr"] = source_ip_addr

    params["source_ip_addr__n"] = source_ip_addr_n
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/plugins/d3c/communication-list/",
        "params": params,
    }
...
) -> Optional[PaginatedCommunicationList]:
    if response.status_code == 200:
        response_200 = PaginatedCommunicationList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedCommunicationList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        destination_device (Union[Unset, int]):
        destination_device_n (Union[Unset, int]):
        destination_ip_addr (Union[Unset, int]):
        destination_ip_addr_n (Union[Unset, int]):
        destination_port (Union[Unset, list[int]]):
        destination_port_empty (Union[Unset, bool]):
        destination_port_gt (Union[Unset, list[int]]):
        destination_port_gte (Union[Unset, list[int]]):
        destination_port_lt (Union[Unset, list[int]]):
        destination_port_lte (Union[Unset, list[int]]):
        destination_port_n (Union[Unset, list[int]]):
        ...
        q (Union[Unset, str]):
        source_device (Union[Unset, int]):
        source_device_n (Union[Unset, int]):
        source_ip_addr (Union[Unset, int]):
        source_ip_addr_n (Union[Unset, int]):
    ...
    kwargs = _get_kwargs(
        ...
        destination_device_n=destination_device_n,
        destination_ip_addr=destination_ip_addr,
        destination_ip_addr_n=destination_ip_addr_n,
        destination_port=destination_port,
        destination_port_empty=destination_port_empty,
        destination_port_gt=destination_port_gt,
        destination_port_gte=destination_port_gte,
        destination_port_lt=destination_port_lt,
        destination_port_lte=destination_port_lte,
        ...
        source_device_n=source_device_n,
        source_ip_addr=source_ip_addr,
        source_ip_addr_n=source_ip_addr_n,
        tag=tag,
        tag_n=tag_n,
        tag_id=tag_id,
        tag_id_n=tag_id_n,
