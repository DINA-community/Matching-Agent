...
if TYPE_CHECKING:
    ...
    from ..models.software_request_custom_fields import SoftwareRequestCustomFields


T = TypeVar("T", bound="SoftwareRequest")
...
class SoftwareRequest:
    ...
    Attributes:
        ...
        custom_fields (Union[Unset, SoftwareRequestCustomFields]):
    """
    ...
    custom_fields: Union[Unset, "SoftwareRequestCustomFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = SoftwareRequestCustomFields.from_dict(_custom_fields)

        software_request = cls(
            name=name,
            manufacturer=manufacturer,
        ...
        software_request.additional_properties = d
