...
T = TypeVar("T", bound="PaginatedPowerFeedList")
...
class PaginatedPowerFeedList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PowerFeed.from_dict(results_item_data)
        ...
        paginated_power_feed_list.additional_properties = d
        return paginated_power_feed_list
