...
from ..models.writable_rear_port_template_request_type import (
...
T = TypeVar("T", bound="WritableRearPortTemplateRequest")
...
class WritableRearPortTemplateRequest:
    ...
    validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
        ...
        Attributes:
            ...
            type_ (WritableRearPortTemplateRequestType): * `8p8c` - 8P8C
                * `8p6c` - 8P6C
                * `8p4c` - 8P4C
                * `8p2c` - 8P2C
                * `6p6c` - 6P6C
    ...
    name: str
    type_: WritableRearPortTemplateRequestType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = WritableRearPortTemplateRequestType(d.pop("type"))
        ...
        writable_rear_port_template_request = cls(
            name=name,
            type_=type_,
        ...
        writable_rear_port_template_request.additional_properties = d
        return writable_rear_port_template_request
