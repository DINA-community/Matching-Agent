...
T = TypeVar("T", bound="PaginatedModuleList")
...
class PaginatedModuleList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Module.from_dict(results_item_data)
        ...
        paginated_module_list.additional_properties = d
        return paginated_module_list
