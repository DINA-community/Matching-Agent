...
from ..models.patched_writable_virtual_circuit_request_status import (
...
class PatchedWritableVirtualCircuitRequest:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if isinstance(self.provider_network, Unset):
            ...
            provider_network = (
                None,
                json.dumps(self.provider_network.to_dict()).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_network(
            data: object,
        ) -> Union["BriefProviderNetworkRequest", Unset, int]:
        ...
        def _parse_type_(
            data: object,
        ) -> Union["BriefVirtualCircuitTypeRequest", Unset, int]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = PatchedWritableVirtualCircuitRequestCustomFields.from_dict(
                _custom_fields
            )
