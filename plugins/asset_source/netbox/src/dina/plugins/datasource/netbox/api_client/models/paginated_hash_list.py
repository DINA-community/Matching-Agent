...
T = TypeVar("T", bound="PaginatedHashList")


@_attrs_define
class PaginatedHashList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Hash.from_dict(results_item_data)
        ...
        paginated_hash_list.additional_properties = d
        return paginated_hash_list
