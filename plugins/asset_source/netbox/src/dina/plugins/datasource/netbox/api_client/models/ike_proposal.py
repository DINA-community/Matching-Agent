...
if TYPE_CHECKING:
    from ..models.ike_proposal_authentication_algorithm import (
        IKEProposalAuthenticationAlgorithm,
    )
    from ..models.ike_proposal_authentication_method import (
        IKEProposalAuthenticationMethod,
    )
    from ..models.ike_proposal_custom_fields import IKEProposalCustomFields
    from ..models.ike_proposal_encryption_algorithm import (
...
class IKEProposal:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication_method = IKEProposalAuthenticationMethod.from_dict(
            d.pop("authentication_method")
        )

        encryption_algorithm = IKEProposalEncryptionAlgorithm.from_dict(
        ...
        if isinstance(_authentication_algorithm, Unset):
            ...
            authentication_algorithm = IKEProposalAuthenticationAlgorithm.from_dict(
