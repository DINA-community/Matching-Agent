...
T = TypeVar("T", bound="PaginatedL2VPNList")
...
class PaginatedL2VPNList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = L2VPN.from_dict(results_item_data)
        ...
        paginated_l2vpn_list.additional_properties = d
        return paginated_l2vpn_list
