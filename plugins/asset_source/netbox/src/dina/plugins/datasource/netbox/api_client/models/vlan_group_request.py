...
class VLANGroupRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.vid_ranges, Unset):
            ...
            for vid_ranges_item_data in self.vid_ranges:
                vid_ranges_item = []
                for (
                    componentsschemas_integer_range_request_item_data
                ) in vid_ranges_item_data:
                    componentsschemas_integer_range_request_item = (
                        componentsschemas_integer_range_request_item_data
                    )
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if not isinstance(self.vid_ranges, Unset):
            ...
            vid_ranges = (
                None,
                json.dumps(_temp_vid_ranges).encode(),
                "application/json",
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.brief_tenant_request import BriefTenantRequest
        from ..models.nested_tag_request import NestedTagRequest
        from ..models.vlan_group_request_custom_fields import (
