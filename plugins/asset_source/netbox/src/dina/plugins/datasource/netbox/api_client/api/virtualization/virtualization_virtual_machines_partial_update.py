...
from ...models.patched_writable_virtual_machine_with_config_context_request import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/virtualization/virtual-machines/{id}/",
    }

    if isinstance(body, PatchedWritableVirtualMachineWithConfigContextRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedWritableVirtualMachineWithConfigContextRequest): Adds support for custom
            fields and tags.
        body (PatchedWritableVirtualMachineWithConfigContextRequest): Adds support for custom
            fields and tags.
