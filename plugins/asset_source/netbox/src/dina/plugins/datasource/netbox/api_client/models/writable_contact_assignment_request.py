...
from ..models.writable_contact_assignment_request_priority_type_1 import (
...
class WritableContactAssignmentRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.priority, Unset):
            ...
            self.priority, WritableContactAssignmentRequestPriorityType2Type1
        ):
            priority = self.priority.value
        elif isinstance(
            self.priority, WritableContactAssignmentRequestPriorityType3Type1
        ):
            priority = self.priority.value
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_priority(
            ...
            try:
                ...
                priority_type_2_type_1 = (
                    WritableContactAssignmentRequestPriorityType2Type1(data)
                )
            ...
            try:
                ...
                priority_type_3_type_1 = (
                    WritableContactAssignmentRequestPriorityType3Type1(data)
                )
        ...
        if isinstance(_custom_fields, Unset):
            ...
            custom_fields = WritableContactAssignmentRequestCustomFields.from_dict(
                _custom_fields
            )
