...
T = TypeVar("T", bound="NestedWirelessLinkRequest")
...
class NestedWirelessLinkRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nested_wireless_link_request = cls(
            ssid=ssid,
        )

        nested_wireless_link_request.additional_properties = d
        return nested_wireless_link_request
